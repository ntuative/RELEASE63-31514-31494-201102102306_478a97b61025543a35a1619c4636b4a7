package com.sulake.core.assets.loaders
{
   ...
   public class BitmapFileLoader extends AssetLoaderEventBroker implements IAssetLoader
   {
      ...
      public function BitmapFileLoader(param1:String, param2:URLRequest = null)
      {
         ...
         this.var_993 = new LoaderContext();
         this.var_993.checkPolicyFile = true;
         ...
         {
            this.var_40.load(param2,this.var_993);
         }
      }
      ...
      public function load(param1:URLRequest) : void
      {
         ...
         var_312 = 0;
         this.var_40.load(param1,this.var_993);
      }
      ...
      override protected function retry() : Boolean
      {
         if(!_disposed)
         {
            if(++var_312 < var_2732)
            {
               ...
               this.var_40.load(new URLRequest(this.var_990 + (this.var_990.indexOf("?") == -1 ? "?" : "&") + "retry=" + var_312),this.var_993);
               return true;
            }
         }
         return false;
