package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      public static const const_1059:String = "AssetLibraryReady";
      
      public static const const_657:String = "AssetLibraryLoaded";
      
      public static const const_1518:String = "AssetLibraryUnloaded";
      
      public static const const_1427:String = "AssetLibraryLoadError";
      
      private static var var_285:Dictionary;
      ...
      public function AssetLibrary(param1:String)
      {
         super();
         this._name = param1;
         this.var_729 = new XML();
         this.var_410 = 0;
         this.var_411 = new Array();
         if(var_285 == null)
         {
            var_285 = new Dictionary(false);
         ...
         this.var_486 = new Dictionary(false);
         this.var_906 = new Dictionary(false);
      ...
      {
         if(this._file == param1.url && this.var_905)
         {
            if(!this.var_904 && param2)
            {
               AssetLibrary.fetchLibraryContents(this,this.var_729,this.var_601);
            }
            this.var_904 = param2;
            dispatchEvent(new Event(AssetLibrary.const_1059));
         }
         else
         {
      ...
      public function unload() : void
      {
         var _loc1_:* = null;
         var _loc2_:* = null;
         for(_loc1_ in this.var_486)
         {
            _loc2_ = this.var_486[_loc1_];
            _loc2_.assetLoader.dispose();
            delete this.var_486[_loc1_];
         }
         for(_loc1_ in this.var_155)
         {
            delete this.var_155[_loc1_];
         }
         for(_loc1_ in this.var_906)
         {
            delete this.var_906[_loc1_];
         }
         if(this.var_40 != null)
         {
            this.var_40.dispose();
         ...
         this.var_905 = false;
         this._file = null;
         dispatchEvent(new Event(AssetLibrary.const_1518));
      }
      
      public function getClass(param1:String) : Class
      {
         var _loc2_:Class = this.var_906[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
      ...
      public function loadAssetFromFile(param1:String, param2:URLRequest, param3:String = null) : AssetLoaderStruct
      {
         ...
         var _loc4_:AssetLoaderStruct = this.var_486[param2.url];
         if(_loc4_ != null)
         {
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_1153,this.assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_1027,this.assetLoadEventHandler);
         ...
         this.var_486[param2.url] = _loc4_;
         return _loc4_;
      }
      ...
      private function assetLoadEventHandler(param1:AssetLoaderEvent) : void
      {
         ...
         var struct:AssetLoaderStruct = this.var_486[loader.url];
         if(struct == null)
         {
         ...
         if(remove)
         {
            if(!_disposed && loader)
            {
               delete this.var_486[loader.url];
            }
            if(struct)
            {
               struct.dispose();
      ...
      {
         return this.var_155[param1] != null || (this.var_601 != null ? this.var_601[param1] != null : false);
      }
      ...
      public function registerAssetTypeDeclaration(param1:AssetTypeDeclaration, param2:Boolean = true) : Boolean
      {
         if(param2)
         {
            if(var_285.hasOwnProperty(param1.mimeType))
            {
               throw new Error("Asset type " + param1.mimeType + " already registered!");
            }
            var_285[param1.mimeType] = param1;
         }
         else
         {
      ...
      public function getAssetTypeDeclarationByMimeType(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            _loc3_ = AssetTypeDeclaration(var_285[param1]);
            if(_loc3_ != null)
            {
               return _loc3_;
            }
      ...
      public function getAssetTypeDeclarationByClass(param1:Class, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            for(_loc4_ in var_285)
            {
               _loc3_ = AssetTypeDeclaration(var_285[_loc4_]);
               if(_loc3_ != null)
               {
      ...
      public function getAssetTypeDeclarationByFileName(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            for(_loc5_ in var_285)
            {
               _loc4_ = AssetTypeDeclaration(var_285[_loc5_]);
               if(_loc4_ != null)
               {
      ...
      private function libraryLoadedHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         this.var_729 = _loc2_.manifest.copy();
         this.var_601 = _loc2_.resource;
         ...
         this.var_905 = true;
         dispatchEvent(new Event(AssetLibrary.const_657));
         dispatchEvent(new Event(AssetLibrary.const_1059));
         if(this.var_904)
         {
      ...
      private function loadErrorHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         dispatchEvent(new Event(AssetLibrary.const_1427));
         this.var_40 = null;
      }
      ...
      private function fetchAssetFromResource(param1:String) : IAsset
      {
         ...
         var _loc2_:XMLList = this.var_729.child("library");
         if(_loc2_ == null)
         {
         ...
         if(_loc2_ != null)
         {
            ...
            while(_loc7_ < _loc6_)
            {
               ...
               if(_loc3_.attribute("name").toString() == param1)
               {
                  ...
                  _loc5_.setUnknownContent(this.var_601[param1]);
