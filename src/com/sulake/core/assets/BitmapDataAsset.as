   ...
   public class BitmapDataAsset implements ILazyAsset
   {
      ...
      public function prepareLazyContent() : void
      {
         ...
         if(this.var_114 is BitmapDataAsset)
         {
            ...
            this.var_1439 = BitmapDataAsset(this.var_114).var_1439;
            this.var_1438 = BitmapDataAsset(this.var_114).var_1438;
            if(this._bitmap != null)
            {
               this.var_114 = null;
               return;
         ...
         while(_loc2_ < param1.length())
         {
            ...
            switch(_loc3_)
            {
               case "offset":
                  ...
                  break;
               case "flipH":
                  this.var_1439 = _loc4_ == "1" || _loc4_ == "HabboFriendListCom_opened_to_web_popup_xml";
                  break;
               case "flipV":
                  this.var_1438 = _loc4_ == "1" || _loc4_ == "HabboFriendListCom_opened_to_web_popup_xml";
                  break;
            }
            _loc2_++;
         }
