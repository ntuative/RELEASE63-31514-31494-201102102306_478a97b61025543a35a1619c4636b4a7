package com.sulake.core.runtime
{
   ...
   public class Component implements IUnknown
   {
      ...
      public static const const_1790:uint = 1;
      
      public static const COMPONENT_FLAG_CONTEXT:uint = 2;
      
      public static const const_1156:uint = 4;
       
      
      protected var var_701:uint = 0;
      
      protected var var_1220:String = "";
      ...
      public function release(param1:IID) : uint
      {
         ...
         if(_loc2_ == null)
         {
            this.var_1220 = "Attempting to release unknown interface:" + param1 + "!";
            throw new Error(this.var_1220);
         }
         var _loc3_:uint = _loc2_.release();
         if(this.var_1477 & const_1156)
         {
            if(_loc3_ == 0)
            {
