package com.sulake.core.utils
{
   ...
   public class LibraryLoaderQueue extends EventDispatcher implements IDisposable
   {
      ...
      protected static const const_1631:int = 4;
      ...
      {
         return this.var_382.length + this.var_270.length;
      }
      ...
      private function next() : void
      {
         ...
         if(!disposed)
         {
            while(this.var_270.length < const_1631 && this.var_382.length > 0)
            {
               _loc1_ = this.var_382.shift();
      ...
      private function removeLoader(param1:LibraryLoader) : void
      {
         ...
         try
         {
            index = this.var_382.indexOf(loader);
            if(index > -1)
            {
               this.var_382.splice(index,1);
            }
