package com.sulake.core.utils
{
   ...
   public class FontEnum
   {
      ...
      private static const const_581:Map = new Map();
      
      private static const const_321:Map = new Map();
      
      private static var var_1035:Boolean = false;
      ...
      {
         return const_581.getValue(param1) != null;
      }
      ...
      private static function init() : void
      {
         ...
         if(!var_1035)
         {
            ...
            for each(_loc3_ in _loc1_)
            {
               ...
               {
                  const_581.add(_loc3_.fontName,_loc3_);
               }
            }
            var_1035 = true;
         }
