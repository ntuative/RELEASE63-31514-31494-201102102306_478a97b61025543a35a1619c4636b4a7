package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_1304:String = "_TITLE";
      
      private static const const_1305:String = "_HEADER";
      
      private static const const_1306:String = "_CONTENT";
      
      private static const const_1303:String = "_SCALER";
       
      
      private var _title:ILabelWindow;
      
      private var var_1382:IHeaderWindow;
      ...
      public function get title() : ILabelWindow
      {
         if(this._title == null)
         {
            this._title = findChildByTag(const_1304) as ILabelWindow;
            if(!this._title)
            {
      ...
      public function get header() : IHeaderWindow
      {
         ...
         {
            this.var_1382 = findChildByTag(const_1305) as IHeaderWindow;
            if(!this.var_1382)
            {
      ...
      public function get content() : IWindowContainer
      {
         ...
         {
            this.var_180 = findChildByTag(const_1306) as IWindowContainer;
            if(!this.var_180)
            {
      ...
      {
         return findChildByTag(const_1303) as IScalerWindow;
      }
      ...
      override public function set color(param1:uint) : void
      {
         ...
         groupChildrenWithTag(const_1205,_loc2_,false);
      ...
      {
         return this.content != null && this.var_991 ? this.content.iterator : new Iterator(this);
      }
      ...
      private function setupScaling() : void
      {
         ...
         var _loc2_:Boolean = testParamFlag(WindowParam.const_278);
      ...
      override public function get properties() : Array
      {
         ...
         if(_loc2_)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_237,_loc3_.left,PropertyStruct.const_38,_loc2_));
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_255,_loc3_.top,PropertyStruct.const_38,_loc2_));
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_214,0 - _loc3_.right,PropertyStruct.const_38,_loc2_));
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_217,0 - _loc3_.bottom,PropertyStruct.const_38,_loc2_));
         }
         else
         {
