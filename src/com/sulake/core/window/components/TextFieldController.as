package com.sulake.core.window.components
{
   ...
   public class TextFieldController extends TextController implements ITextFieldWindow
   {
      ...
      override public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         if(param1 && !var_21)
         {
            var_21 = new GraphicContext("GC {" + _name + "}",GraphicContext.const_1002,var_11);
         }
         return var_21;
      }
      ...
      private function onKeyDownEvent(param1:KeyboardEvent) : void
      {
         ...
         {
            var_16.handleError(WindowContext.const_371,e);
         }
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(true ? new PropertyStruct(PropertyDefaults.const_771,false,PropertyStruct.const_37,true) : PropertyDefaults.const_1525);
         _loc1_.push(this.var_1238 != PropertyDefaults.const_1013 ? new PropertyStruct(PropertyDefaults.const_881,this.var_1238,PropertyStruct.const_37,true) : PropertyDefaults.const_1549);
         _loc1_.push(_field.selectable != PropertyDefaults.const_1123 ? new PropertyStruct(PropertyDefaults.const_715,_field.selectable,PropertyStruct.const_37,true) : PropertyDefaults.const_1460);
         _loc1_.push(_field.displayAsPassword != PropertyDefaults.const_1086 ? new PropertyStruct("display_as_password",_field.displayAsPassword,PropertyStruct.const_37,true) : PropertyDefaults.const_1595);
         return _loc1_;
      }
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               ...
               case PropertyDefaults.const_771:
                  ...
                  break;
               case PropertyDefaults.const_1025:
