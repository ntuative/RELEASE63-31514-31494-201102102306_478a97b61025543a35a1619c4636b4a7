package com.sulake.core.window.components
{
   ...
   public class ScrollbarController extends InteractiveController implements IScrollbarWindow, ITouchAwareWindow
   {
      ...
      private static const const_1282:String = "increment";
      
      private static const const_1281:String = "decrement";
      
      private static const const_925:String = "slider_track";
      ...
      protected var var_647:Number = 0.1;
      ...
      public function ScrollbarController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0, param12:IScrollableWindow = null)
      {
         ...
         var_162 = false;
         this.var_20 = param12;
         this._horizontal = param2 == WindowType.const_500;
      ...
      public function set scrollable(param1:IScrollableWindow) : void
      {
         if(this.var_20 != null && !this.var_20.disposed)
         {
            ...
            this.var_20.removeEventListener(WindowEvent.const_437,this.onScrollableScrolled);
         }
         this.var_20 = param1;
         if(this.var_20 != null && !this.var_20.disposed)
         {
            this.var_20.addEventListener(WindowEvent.const_46,this.onScrollableResized);
            this.var_20.addEventListener(WindowEvent.const_437,this.onScrollableScrolled);
            this.updateLiftSizeAndPosition();
         }
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         while(_loc4_ < _loc2_)
         {
            ...
            {
               this.var_869 = _loc3_.value as String;
            }
            _loc4_++;
         }
      ...
      {
         return findChildByName(const_925) as WindowController;
      }
      ...
      override public function update(param1:WindowController, param2:Event) : Boolean
      {
         ...
         if(param2.type == WindowNotifyEvent.const_472)
         {
            if(this.var_20 == null)
            {
         ...
         if(param1 == this)
         {
            ...
            else if(param2.type == WindowMouseEvent.const_281)
            {
               if(WindowMouseEvent(param2).delta > 0)
               {
                  if(this._horizontal)
                  {
                     this.scrollH -= this.var_647;
                  }
                  else
                  {
                     this.scrollV -= this.var_647;
                  }
               }
      ...
      private function scrollButtonEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.const_41 || param1.type == WindowTouchEvent.const_467)
         {
            ...
            else if(param2.name == const_1281)
            {
               if(this.var_20)
               {
                  this.var_1089 = true;
         ...
         if(param1.type == WindowMouseEvent.const_281)
         {
      ...
      private function resolveScrollTarget() : Boolean
      {
         ...
         {
            _loc1_ = findParentByName(this.var_869) as IScrollableWindow;
            if(_loc1_ == null && _parent is IWindowContainer)
            {
               _loc1_ = IWindowContainer(_parent).findChildByName(this.var_869) as IScrollableWindow;
               if(_loc1_)
               {
