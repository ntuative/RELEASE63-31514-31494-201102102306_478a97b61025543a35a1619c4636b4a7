package com.sulake.core.window.components
{
   ...
   public class ItemListController extends WindowController implements IItemListWindow, IInputProcessorRoot
   {
      ...
      protected var var_435:Boolean = false;
      ...
      public function ItemListController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         var_162 = var_434 || !testParamFlag(WindowParam.const_32);
         this._container = var_16.create("_CONTAINER","",WindowType.const_391,WindowStyle.const_707,0 | 0 | 0,new Rectangle(0,0,width,height),null,this,0,null,[TAG_INTERNAL,TAG_EXCLUDE]) as IWindowContainer;
         ...
         this._container.addEventListener(WindowEvent.const_301,this.containerEventHandler);
      ...
      {
         return new Rectangle(this.var_646 * this.maxScrollH,this.var_645 * this.maxScrollV,width,height);
      }
      ...
      public function set scrollH(param1:Number) : void
      {
         ...
         if(param1 != this.var_646)
         {
            ...
            var_16.invalidate(this._container,this.visibleRegion,WindowRedrawFlag.const_68);
            dispatchEvent(new WindowEvent(WindowEvent.const_437,this,null));
         }
      }
      ...
      public function set resizeOnItemUpdate(param1:Boolean) : void
      {
         ...
         if(this._container)
         {
            if(this._horizontal)
            {
               this._container.setParamFlag(WindowParam.const_425,param1);
            }
            else
            {
               this._container.setParamFlag(WindowParam.const_442,param1);
            }
         }
      }
      ...
      override public function dispose() : void
      {
         if(!_disposed)
         {
            ...
            this._container.removeEventListener(WindowEvent.const_301,this.containerEventHandler);
      ...
      public function process(param1:WindowEvent) : Boolean
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.const_176:
               if(this.var_1225)
               {
                  this.var_1226 = this.var_1978 - _loc3_;
                  this.var_1224 = this.var_1976 - _loc4_;
                  if(this._horizontal)
                  {
                     if(this.var_1226 != 0 && this.var_101 != 0)
                     {
                        this.scrollH += this.var_1226 / this.var_101;
                     }
                  }
                  else if(this.var_1224 != 0 && this.var_91 != 0)
                  {
                     this.scrollV += this.var_1224 / this.var_91;
                  }
                  this.var_1978 = _loc3_;
                  this.var_1976 = _loc4_;
                  _loc2_ = true;
            ...
            case WindowMouseEvent.const_186:
               if(this.var_1225)
               {
                  if(this._horizontal)
                  {
                     var_16.getWindowServices().getGestureAgentService().begin(this,this.scrollAnimationCallback,0,-this.var_1226,0);
                  }
                  else
                  {
      ...
      protected function updateScrollAreaRegion() : void
      {
         ...
         var _loc3_:int = 0;
         var _loc4_:int = 0;
         if(this.var_988 && !this.var_528 && this._container)
         {
            this.var_528 = true;
      ...
      override public function get properties() : Array
      {
         ...
         if(this._spacing != PropertyDefaults.const_692)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_350,this._spacing,PropertyStruct.const_38,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1108);
         }
         if(this.var_988 != PropertyDefaults.const_1101)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_615,this.var_988,PropertyStruct.const_37,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1613);
         }
         if(this.var_435 != PropertyDefaults.const_1179)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_644,this.var_435,PropertyStruct.const_37,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1355);
         }
         if(this.var_1227 != PropertyDefaults.const_1046)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_720,this.var_1227,PropertyStruct.const_37,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1624);
         }
         return _loc1_;
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               case PropertyDefaults.const_350:
                  this.spacing = _loc2_.value as int;
                  break;
               case PropertyDefaults.const_644:
