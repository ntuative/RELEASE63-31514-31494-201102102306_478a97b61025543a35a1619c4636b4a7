package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_1044:IItemListWindow;
      ...
      override public function dispose() : void
      {
         if(this.var_386)
         {
            this.var_386.removeEventListener(WindowEvent.const_289,this.scrollBarEventProc);
            this.var_386.removeEventListener(WindowEvent.const_212,this.scrollBarEventProc);
            this.var_386 = null;
         }
         if(this.var_1044)
         {
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!this.var_1044)
         {
            this.var_1044 = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!this.var_386)
         {
            this.var_386 = findChildByTag("_SCROLLBAR") as IScrollbarWindow;
            if(this.var_386)
            {
               this.var_386.addEventListener(WindowEvent.const_289,this.scrollBarEventProc);
               this.var_386.addEventListener(WindowEvent.const_212,this.scrollBarEventProc);
            }
         }
         return this.var_386;
      }
