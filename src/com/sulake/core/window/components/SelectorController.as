package com.sulake.core.window.components
{
   ...
   public class SelectorController extends InteractiveController implements ISelectorWindow, IIterable
   {
      ...
      private var var_188:ISelectableWindow;
      ...
      {
         return this.var_188 as ISelectableWindow;
      }
         ...
         if(param1 != null)
         {
            if(param1 != this.var_188)
            {
               ...
               if(getChildIndex(param1) > -1)
               {
                  ...
                  notifyEventListeners(new WindowNotifyEvent(WindowNotifyEvent.const_398,this,this.var_188));
               }
            }
         }
      }
