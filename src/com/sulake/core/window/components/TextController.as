package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      public function TextController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         setTextFormatting(this._field,this.var_395,this._explicitStyle);
      ...
      private static function method_8(param1:TextController, param2:Boolean) : void
      {
      ...
      private static function setTextStyle(param1:TextController, param2:TextStyle) : void
      {
         ...
         if(_loc3_)
         {
            param1.var_395 = _loc3_.name;
            setTextFormatting(param1._field,param1.var_395,param1._explicitStyle);
            param1.refreshTextImage();
         }
      }
      ...
      protected static function setTextFormatting(param1:TextField, param2:String, param3:TextStyle) : void
      {
         ...
         {
            _loc5_.underline = _loc4_.textDecoration == TextStyle.const_802 ? true : null;
         }
      ...
      protected static function createPropertySetterTable() : Dictionary
      {
         ...
         _loc1_["always_show_selection"] = method_8;
      ...
      {
         this.var_794 = param1;
         this._field.scrollH = this.var_794 * Number(this._field.maxScrollH);
      ...
      {
         return new Rectangle(this.var_794 * this.maxScrollH,this.var_526 * this.maxScrollV,width,height);
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push((_loc2_.antiAliasType != null ? this._field.antiAliasType != _loc2_.antiAliasType : this._field.antiAliasType != PropertyDefaults.const_1118) ? new PropertyStruct(PropertyDefaults.const_774,this._field.antiAliasType,PropertyStruct.const_50,this._field.antiAliasType != AntiAliasType.NORMAL,PropertyDefaults.const_1033) : PropertyDefaults.const_1370);
         _loc1_.push(this._autoSize != PropertyDefaults.const_1142 ? new PropertyStruct(PropertyDefaults.const_747,this._autoSize,PropertyStruct.const_50,true,PropertyDefaults.const_1093) : PropertyDefaults.const_1575);
         _loc1_.push(new PropertyStruct("border",this._field.border,PropertyStruct.const_37,this._field.border == true));
         _loc1_.push(new PropertyStruct("border_color",this._field.borderColor,PropertyStruct.const_137,this._field.borderColor != 0));
         ...
         _loc1_.push(new PropertyStruct("font_size",this.defaultTextFormat.size,PropertyStruct.const_222,this.defaultTextFormat.size != _loc2_.fontSize));
         _loc1_.push(this._field.gridFitType != PropertyDefaults.const_1023 ? new PropertyStruct(PropertyDefaults.const_1135,this._field.gridFitType,PropertyStruct.const_50,true,PropertyDefaults.const_1144) : PropertyDefaults.const_1368);
         _loc1_.push((_loc2_.color != null ? this._field.textColor != _loc2_.color : this._field.textColor != PropertyDefaults.const_873) ? new PropertyStruct(PropertyDefaults.const_344,this._field.textColor,PropertyStruct.const_137,true) : PropertyDefaults.const_1005);
         ...
         _loc1_.push(this.var_39.left != PropertyDefaults.const_840 ? new PropertyStruct(PropertyDefaults.const_237,this.var_39.left,PropertyStruct.const_38,true) : PropertyDefaults.const_461);
         _loc1_.push(this.var_39.top != PropertyDefaults.const_664 ? new PropertyStruct(PropertyDefaults.const_255,this.var_39.top,PropertyStruct.const_38,true) : PropertyDefaults.const_563);
         _loc1_.push(this.var_39.right != PropertyDefaults.const_725 ? new PropertyStruct(PropertyDefaults.const_214,this.var_39.right,PropertyStruct.const_38,true) : PropertyDefaults.const_498);
         _loc1_.push(this.var_39.bottom != PropertyDefaults.const_818 ? new PropertyStruct(PropertyDefaults.const_217,this.var_39.bottom,PropertyStruct.const_38,true) : PropertyDefaults.const_542);
         _loc1_.push(this._field.mouseWheelEnabled != PropertyDefaults.const_1089 ? new PropertyStruct(PropertyDefaults.const_874,this._field.mouseWheelEnabled,PropertyStruct.const_37,true) : PropertyDefaults.const_1435);
         ...
         _loc1_.push(new PropertyStruct("sharpness",this._field.sharpness,PropertyStruct.const_221,this._field.sharpness != 0));
         _loc1_.push(new PropertyStruct("thickness",this._field.thickness,PropertyStruct.const_221,this._field.thickness != 0));
         ...
         _loc1_.push(new PropertyStruct("spacing",this._field.defaultTextFormat.letterSpacing,PropertyStruct.const_221,this._field.defaultTextFormat.letterSpacing != 0));
         return _loc1_;
      }
   }
}
