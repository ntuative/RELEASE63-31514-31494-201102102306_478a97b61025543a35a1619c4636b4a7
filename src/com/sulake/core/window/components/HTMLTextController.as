package com.sulake.core.window.components
{
   ...
   public class HTMLTextController extends TextFieldController implements IHTMLTextWindow
   {
      ...
      private static var var_823:String = PropertyDefaults.HTML_LINK_TARGET_VALUE;
       
      
      private var var_667:String;
      
      private var var_1034:String = null;
      
      private var var_1540:StyleSheet = null;
      ...
      private static function setHtmlStyleSheetString(param1:HTMLTextController, param2:String) : void
      {
         ...
         if(param1.var_1034 == param2)
         {
            return;
         }
         param1.var_1034 = param2;
         param1.var_1540 = null;
         if(param1.var_1034 != null)
         {
            _loc3_ = new StyleSheet();
            _loc3_.parseCSS(param1.var_1034);
            param1.var_1540 = _loc3_;
         }
      }
      ...
      {
         if(PropertyDefaults.const_721.indexOf(param1) > -1)
         {
            this.var_667 = param1;
         }
      }
      ...
      override public function set htmlText(param1:String) : void
      {
         ...
         {
            _field.htmlText = convertLinksToEvents(var_19);
            _field.styleSheet = this.var_1540;
            refreshTextImage();
         }
      }
      ...
      override public function get properties() : Array
      {
         ...
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_871,this.var_667,PropertyStruct.const_50,true,PropertyDefaults.const_721));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1406);
         }
         return _loc1_;
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         {
            if(_loc2_.key == PropertyDefaults.const_871)
            {
