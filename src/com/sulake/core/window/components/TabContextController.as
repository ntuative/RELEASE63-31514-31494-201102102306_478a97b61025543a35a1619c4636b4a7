package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      private static const const_1334:String = "_SELECTOR";
      ...
      public function get selector() : ITabSelectorWindow
      {
         ...
         {
            this.var_994 = findChildByTag(const_1334) as ITabSelectorWindow;
            if(this.var_994 != null)
            {
      ...
      public function get container() : IWindowContainer
      {
         ...
         {
            this.var_1985 = findChildByTag(const_1333) as IWindowContainer;
         }
      ...
      public function method_11(param1:uint) : ITabButtonWindow
      {
