package com.sulake.core.window.tools
{
   ...
   public class ProfilerOutput implements IDevTool
   {
      ...
      private static var var_1282:Class = ProfilerOutput_profiler_dialog_xml;
      
      private static var var_1283:Class = ProfilerOutput_profiler_task_xml;
      ...
      public function ProfilerOutput(param1:IContext, param2:ICoreWindowManager, param3:IWindowRenderer)
      {
         ...
         this.var_867 = param3;
         var _loc4_:ByteArray = new var_1282() as ByteArray;
      ...
      public function refresh(param1:Event) : void
      {
         ...
         if(this.var_1557)
         {
            this._window.findChildByName("footer").caption = "Assets - Libraries: " + this.var_144.numAssetLibraryInstances + " " + "Bitmaps: " + this.var_144.numBitmapAssetInstances + " / " + this.var_144.numAllocatedBitmapDataBytes + " bytes \n" + "Windows - Allocated bitmap data: " + (this.var_867.allocatedByteCount + GraphicContext.allocatedByteCount) + " bytes \n" + "Tracked bitmap data: " + this.var_144.numTrackedBitmapDataInstances + " / " + this.var_144.numTrackedBitmapDataBytes + " bytes";
         }
      }
      ...
      {
         var _loc2_:ByteArray = new var_1283() as ByteArray;
