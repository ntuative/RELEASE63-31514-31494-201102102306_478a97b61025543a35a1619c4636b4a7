package com.sulake.core.window
{
   ...
   public class WindowController extends WindowModel implements IWindow, IGraphicContextHost
   {
      ...
      private static var var_1210:uint = 0;
      
      protected static const TAG_EXCLUDE:String = "_EXCLUDE";
      
      protected static const TAG_INTERNAL:String = "_INTERNAL";
      
      protected static const const_1205:String = "_COLORIZE";
      
      protected static const const_1656:String = "_IGNORE_INHERITED_STYLE";
      
      private static var var_1465:Point = new Point();
      ...
      public function WindowController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         if(_loc13_)
         {
            var_754 = _loc13_.blend;
            var_433 = _loc13_.var_2720;
            if(var_434 != _loc13_.background)
            {
      ...
      {
         var_434 = param1;
         var_227 = !!var_434 ? uint(var_227 | var_524) : uint(var_227 & 16777215);
      ...
      public function set color(param1:uint) : void
      {
         ...
         var_227 = !!var_434 ? uint(param1) : uint(param1 & 16777215);
         var_16.invalidate(this,var_11,WindowRedrawFlag.const_68);
      }
      ...
      {
         var_524 = param1 << 24;
         var_227 = !!var_434 ? uint(var_524 | var_227) : uint(16777215 & var_227);
         var_16.invalidate(this,var_11,WindowRedrawFlag.const_68);
      }
      
      public function set blend(param1:Number) : void
      {
         var_754 = param1 > 1 ? 1 : (param1 < 0 ? 0 : Number(param1));
         var_16.invalidate(this,var_11,WindowRedrawFlag.const_1127);
      }
      ...
      public function set state(param1:uint) : void
      {
         ...
         {
            _state = param1;
            this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_478,this,null));
         }
      }
      ...
      public function set style(param1:uint) : void
      {
         ...
         {
            var_79 = param1;
            this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_501,this,null));
         }
      }
      ...
      {
         var_433 = param1 > 255 ? 255 : uint(param1);
      }
      ...
      public function set parent(param1:IWindow) : void
      {
         ...
         if(this._parent != param1)
         {
            ...
            if(this._parent != null)
            {
               this.var_369 = this._parent.rectangle.clone();
               var_59.x = var_11.x;
               var_59.y = var_11.y;
               var_59.width = var_11.width;
               var_59.height = var_11.height;
               this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_472,this,this._parent));
            }
            else
            {
               this.var_369.x = 0;
               this.var_369.y = 0;
               this.var_369.width = 0;
               this.var_369.height = 0;
               this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_992,this,_loc2_));
            }
         }
      }
      ...
      public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         ...
         {
            this.var_21 = new GraphicContext("GC {" + _name + "}",GraphicContext.const_728,var_11);
            this.var_21.visible = var_372;
         }
         return this.var_21;
      }
      ...
      public function clone() : IWindow
      {
         ...
         var _loc2_:WindowController = new _loc1_(_name,_type,var_79,var_18,var_16,var_11,null,this.var_649,this.properties,var_792.concat(),_id) as WindowController;
         _loc2_.var_433 = var_433;
         _loc2_.var_162 = this.var_162;
         _loc2_._debug = this._debug;
         _loc2_.var_369 = this.var_369.clone();
      ...
      {
         return "[Window " + getQualifiedClassName(this) + " " + this.var_2702 + "]";
      }
      ...
      override public function invalidate(param1:Rectangle = null) : void
      {
         ...
         var_16.invalidate(this,param1,WindowRedrawFlag.const_68);
      }
      ...
      public function setRectangle(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         if(_loc6_ && !_loc5_)
         {
            ...
            if(_loc7_ == WindowParam.const_562)
            {
               param1 -= (param3 - 0) / 2;
               _loc5_ = true;
            }
            else if(_loc7_ == WindowParam.const_523)
            {
               param1 -= param3 - 0;
               _loc5_ = true;
            }
            _loc7_ = uint(var_18 & 0);
            if(_loc7_ == WindowParam.const_484)
            {
               param2 -= (param4 - 0) / 2;
               _loc5_ = true;
            }
         ...
         if(_loc5_ || _loc6_)
         {
            if(_loc5_)
            {
               _loc9_ = new WindowNotifyEvent(WindowNotifyEvent.const_969,this,null,true);
            ...
            if(_loc6_)
            {
               _loc9_ = new WindowNotifyEvent(WindowNotifyEvent.const_750,this,null,true);
               this.update(this,_loc9_);
               if(_loc9_.isWindowOperationPrevented())
               {
                  _loc6_ = false;
      ...
      public function getRegionProperties(param1:Rectangle = null, param2:Rectangle = null, param3:Rectangle = null, param4:Rectangle = null) : void
      {
         ...
         if(param3 != null && var_134 != null)
         {
            param3.x = var_134.x;
            param3.y = var_134.y;
            param3.width = var_134.width;
            param3.height = var_134.height;
         }
      ...
      public function setRegionProperties(param1:Rectangle = null, param2:Rectangle = null, param3:Rectangle = null) : void
      {
         ...
         if(param2 != null)
         {
            ...
            var_134.x = param2.x;
            var_134.y = param2.y;
            var_134.width = param2.width;
            var_134.height = param2.height;
         }
         ...
         if(param2 is WindowMouseEvent)
         {
            switch(param2.type)
            {
               case WindowMouseEvent.const_41:
                  ...
                  _loc4_.areaLimit = MouseListenerType.const_1152;
                  if(testParamFlag(WindowParam.const_342))
                  {
                     _loc3_ = {};
                     while(_loc3_ != null)
                     {
                        if(_loc3_.testParamFlag(WindowParam.const_251))
                        {
                  ...
                  if((var_18 & 0) > 0)
                  {
                     ...
                     while(_loc3_ != null)
                     {
                        if(_loc3_.testParamFlag(WindowParam.const_278))
                        {
         ...
         if(param2 is WindowNotifyEvent)
         {
            switch(param2.type)
            {
               case WindowNotifyEvent.const_190:
                  ...
                  if(param1 == this)
                  {
                     this.notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_429,this,null));
                     if(testParamFlag(WindowParam.const_167,WindowParam.const_161))
                     {
                        this.updateScaleRelativeToParent();
                     }
                     else if(testParamFlag(WindowParam.const_183,WindowParam.const_156))
                     {
                        this.updateScaleRelativeToParent();
                     }
                     if(this._parent != null)
                     {
                        ...
                        var_18 = _loc9_;
                        this._parent.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_312,this._parent,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_520:
                  var_16.invalidate(this,var_11.union(var_59),WindowRedrawFlag.const_427);
                  if(param1 == this)
                  {
                     this.notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_1042,this,null));
                     if(this._parent != null)
                     {
               ...
               case WindowNotifyEvent.const_351:
                  if(param1 == this)
                  {
                     this.notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_817,this,null));
                     if(this._parent != null)
                     {
                        this._parent.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_219,this._parent,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_478:
                  var_16.invalidate(this,var_11,WindowRedrawFlag.const_1095);
                  break;
               case WindowNotifyEvent.const_501:
                  ...
                  while(--_loc7_ > -1)
                  {
                     ...
                     if(_loc8_.tags.indexOf(const_1656) == -1)
                     {
                        _loc8_.style = var_79;
                     }
                  }
               ...
               case WindowNotifyEvent.const_480:
                  if(!(var_18 & 0))
                  {
                     if(!this.var_21)
                     {
                        ...
                        var_16.invalidate(this,var_11,WindowRedrawFlag.const_427);
                     }
                  }
                  else if(var_18 & 0)
                  {
               ...
               case WindowNotifyEvent.const_429:
                  this._parent.getRegionProperties(null,this.var_369);
                  this.updateScaleRelativeToParent();
                  break;
               ...
               case WindowNotifyEvent.const_296:
                  ...
                  break;
               case WindowNotifyEvent.const_737:
                  break;
      ...
      protected function forwardNotifyEvent(param1:WindowNotifyEvent) : WindowEvent
      {
         ...
         switch(param1.type)
         {
            case WindowNotifyEvent.const_750:
               _loc2_ = "null";
               _loc4_ = true;
               break;
            case WindowNotifyEvent.const_190:
            ...
            case WindowNotifyEvent.const_1021:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_1606:
               _loc2_ = "null";
               _loc4_ = true;
               break;
            case WindowNotifyEvent.const_1626:
               _loc2_ = "null";
               break;
            ...
            case WindowNotifyEvent.const_398:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_739:
               _loc2_ = "null";
               _loc4_ = true;
               break;
            case WindowNotifyEvent.const_701:
               _loc2_ = "null";
               break;
            ...
            case WindowNotifyEvent.const_740:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_1165:
               _loc2_ = "null";
               _loc4_ = true;
               break;
      ...
      {
         return this.testLocalPointHitAgainstAlpha(param1,param2,var_433);
      }
      ...
      public function validateGlobalPointIntersection(param1:Point, param2:BitmapData) : Boolean
      {
         ...
         return this.testLocalPointHitAgainstAlpha(_loc3_,param2,var_433);
      }
         ...
         if(this.var_162 && var_433 > 0)
         {
            if(!testParamFlag(WindowParam.const_32))
            {
               if(param1.x <= var_11.width && param1.y <= var_11.height)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     _loc4_ = _loc5_.hitTest(var_1465,param3,param1);
                  }
               }
            }
            else
            {
               _loc4_ = param2 != null ? Boolean(param2.hitTest(var_1465,param3,param1)) : false;
            }
         }
      ...
      protected function updateScaleRelativeToParent() : void
      {
         ...
         var _loc1_:* = !testParamFlag(WindowParam.const_144,WindowParam.const_161);
         var _loc2_:* = !testParamFlag(WindowParam.const_126,WindowParam.const_156);
         if(_loc1_ || _loc2_)
         {
            _loc3_ = var_11.clone();
            if(_loc1_)
            {
               _loc4_ = this._parent.width - this.var_369.width;
            ...
            if(_loc2_)
            {
               _loc4_ = this._parent.height - this.var_369.height;
               _loc5_ = uint(var_18 & 0);
               if(_loc5_ == WindowParam.const_388)
               {
                  _loc3_.height += _loc4_;
               }
               else if(_loc5_ == WindowParam.const_396)
               {
                  _loc3_.y += _loc4_;
               }
      ...
      {
         if(_state == WindowState.const_475)
         {
            return true;
         }
         _state = WindowState.const_475;
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_1145,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
         }
         _loc1_.type = WindowNotifyEvent.const_1139;
         this.update(this,_loc1_);
         this.dispose();
         return true;
      }
      ...
      {
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_1104,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
      ...
      public function focus() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_1190,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
         ...
         _loc1_.type = WindowNotifyEvent.const_1154;
         this.update(this,_loc1_);
         return true;
      }
      ...
      public function unfocus() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_1109;
         this.update(this,_loc1_);
         return true;
      }
      ...
      public function addChild(param1:IWindow) : IWindow
      {
         ...
         _loc2_.parent = this;
         if(this.var_1211 || _loc2_.hasGraphicsContext())
         {
            this.setupGraphicsContext();
         ...
         this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_329,this,param1));
         return param1;
      }
      ...
      public function addChildAt(param1:IWindow, param2:int) : IWindow
      {
         ...
         _loc3_.parent = this;
         if(this.var_1211 || _loc3_.hasGraphicsContext())
         {
            this.setupGraphicsContext();
      ...
      public function removeChild(param1:IWindow) : IWindow
      {
         ...
         this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_737,this,param1));
         return param1;
      }
