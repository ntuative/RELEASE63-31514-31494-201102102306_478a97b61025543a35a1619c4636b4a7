package com.sulake.core.window.graphics
{
   ...
   public class GraphicContext extends Sprite implements IGraphicContext
   {
      ...
      public static const const_1548:uint = 0;
      
      public static const const_728:uint = 1;
      
      public static const const_1002:uint = 2;
      
      public static const const_658:uint = 4;
      
      public static const const_1555:uint = 8;
      
      public static const const_1456:uint = 16;
      
      public static const const_1809:uint = 64;
      
      public static const const_1772:uint = 128;
      
      public static const const_1198:uint = 256;
      
      protected static var var_532:uint = 0;
      
      protected static var var_313:uint = 0;
         ...
         if(this.var_799)
         {
            ...
            if(displayObject is Bitmap)
            {
               ...
               if(bitmap != null)
               {
                  ...
                  {
                     var_313 -= bitmap.width * bitmap.height * 4;
                     bitmap.dispose();
                     bitmap = null;
                  }
               }
      ...
      protected function releaseDrawBuffer() : void
      {
         ...
         if(this.var_799)
         {
            ...
            if(_loc1_ is Bitmap)
            {
               ...
               if(_loc2_ != null)
               {
                  var_313 -= _loc2_.width * _loc2_.height * 4;
                  _loc2_.dispose();
               }
            }
         }
