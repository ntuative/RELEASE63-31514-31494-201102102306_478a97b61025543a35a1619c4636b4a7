package com.sulake.core.window.graphics
{
   ...
   public class SkinContainer implements ISkinContainer
   {
      ...
      private static const const_1347:String = "skin";
      
      private static const const_1345:String = "bitmap";
      
      private static const const_1346:String = "fill";
      
      private static const const_1348:String = "text";
      
      private static const const_1343:String = "label";
      
      private static const const_1344:String = "shape";
      ...
      private var var_1916:Dictionary;
      
      private var var_2696:Dictionary;
      
      private var var_2694:Dictionary;
      
      private var var_2695:Dictionary;
      ...
      public function SkinContainer(param1:XML, param2:IAssetLibrary)
      {
         ...
         this.var_1916 = new Dictionary();
         this.var_2696 = new Dictionary();
         TypeCodeTable.fillTables(this.var_1916,this.var_2696);
         this.var_2694 = new Dictionary();
         this.var_2695 = new Dictionary();
         StateCodeTable.fillTables(this.var_2694,this.var_2695);
         this.var_432 = new Dictionary();
         this.var_432[const_1347] = BitmapSkinRenderer;
         this.var_432[const_1345] = BitmapDataRenderer;
         this.var_432[const_1346] = FillSkinRenderer;
         this.var_432[const_1348] = TextSkinRenderer;
         this.var_432[const_1343] = LabelRenderer;
         this.var_432[const_1344] = ShapeSkinRenderer;
         this.var_432[RENDERER_TYPE_UNKNOWN] = SkinRenderer;
         this.var_432[RENDERER_TYPE_NULL] = NullSkinRenderer;
         if(var_314 == null)
         {
            var_314 = new Array();
            var_314.push(WindowState.const_67);
            var_314.push(WindowState.const_74);
            var_314.push(WindowState.const_84);
            var_314.push(WindowState.const_49);
            var_314.push(WindowState.const_88);
            var_314.push(WindowState.const_80);
            var_314.push(WindowState.const_103);
            var_314.push(WindowState.const_96);
         }
         if(param1 != null)
         {
            ...
            if(_loc4_ > 0)
            {
               ...
               while(_loc18_ < _loc4_)
               {
                  ...
                  _loc17_.background = !!_loc5_.@background[0] ? _loc5_.@background[0] == "HabboFriendListCom_opened_to_web_popup_xml" : false;
                  ...
                  this.addSkinRenderer(this.var_1916[_loc7_],uint(_loc8_),_loc14_,_loc17_);
                  _loc18_++;
               }
            }
         }
      ...
      {
         if(this.var_972[param1] == null)
         {
            this.var_972[param1] = new Array(const_956);
         }
         this.var_972[param1][param2] = param3;
         if(this.var_973[param1] == null)
         {
            this.var_973[param1] = new Array(const_956);
         }
         this.var_973[param1][param2] = param4;
      }
      
      public function getSkinRendererByTypeAndStyle(param1:uint, param2:uint) : ISkinRenderer
      {
         var _loc4_:* = null;
         var _loc3_:Array = this.var_972[param1];
         if(_loc3_)
         {
            _loc4_ = _loc3_[param2];
            if(!_loc4_ && param2 != WindowStyle.const_171)
            {
               _loc4_ = _loc3_["null"];
            }
         }
      ...
      {
         var _loc4_:* = null;
         var _loc3_:Array = this.var_973[param1];
         if(_loc3_)
         {
            _loc4_ = _loc3_[param2];
            if(!_loc4_ && param2 != WindowStyle.const_171)
