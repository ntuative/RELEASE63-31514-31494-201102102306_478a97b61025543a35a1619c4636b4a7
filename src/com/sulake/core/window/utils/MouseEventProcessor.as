package com.sulake.core.window.utils
{
   ...
   public class MouseEventProcessor implements IEventProcessor, IDisposable
   {
      ...
      protected var var_140:IWindowRenderer;
      
      protected var var_136:IDesktopWindow;
      
      protected var var_793:IWindowContextStateListener;
      ...
      public function process(param1:EventProcessorState, param2:IEventQueue) : void
      {
         ...
         this.var_80 = param1.var_1217 as WindowController;
         this._lastClickTarget = param1.var_1216 as WindowController;
         this.var_140 = param1.renderer;
         this.var_793 = param1.var_1218;
         param2.begin();
         ...
         while(true)
         {
            ...
            if(_loc3_.stageX != this.var_644.x || _loc3_.stageY != this.var_644.y)
            {
               this.var_644.x = _loc3_.stageX;
               this.var_644.y = _loc3_.stageY;
               _loc6_ = new Array();
               this.var_136.groupParameterFilteredChildrenUnderPoint(this.var_644,_loc6_,WindowParam.const_30);
            }
               ...
               if(_loc5_ != null && _loc5_.visible)
               {
                  ...
                  else if(_loc3_.type == MouseEvent.MOUSE_UP || _loc3_.type == MouseEvent.CLICK)
                  {
                     if(this.var_80 && !this.var_80.disposed)
                     {
                        ...
                        {
                           this.var_793.mouseEventReceived(_loc3_.type,this.var_80);
                        }
                     }
                  }
         ...
         param1.var_1217 = this.var_80;
         param1.var_1216 = this._lastClickTarget;
         param1.renderer = this.var_140;
         param1.var_1218 = this.var_793;
      }
      ...
      private function passMouseEvent(param1:WindowController, param2:MouseEvent, param3:Boolean = false) : WindowController
      {
         ...
         var _loc5_:BitmapData = this.var_140.getDrawBufferForRenderable(param1);
