package com.sulake.core.window.utils
{
   ...
   public class WindowRectLimits implements IRectLimiter
   {
      ...
      private var var_292:int = 2.147483647E9;
      ...
      {
         this.var_293 = param1;
         if(this.var_293 > int.MIN_VALUE && !this._target.disposed && this._target.width < this.var_293)
         {
      ...
      {
         this.var_292 = param1;
         if(this.var_292 < int.MAX_VALUE && !this._target.disposed && this._target.width > this.var_292)
         {
      ...
      {
         this.var_291 = param1;
         if(this.var_291 > int.MIN_VALUE && !this._target.disposed && this._target.height < this.var_291)
         {
      ...
      {
         return this.var_293 == int.MIN_VALUE && this.var_292 == int.MAX_VALUE && this.var_291 == int.MIN_VALUE && this.var_294 == int.MAX_VALUE;
      }
      
      public function setEmpty() : void
      {
         this.var_293 = int.MIN_VALUE;
         this.var_292 = int.MAX_VALUE;
      ...
      public function limit() : void
      {
         ...
         {
            if(this._target.width < this.var_293)
            {
               this._target.width = this.var_293;
            }
            else if(this._target.width > this.var_292)
            {
               this._target.width = this.var_292;
            }
            if(this._target.height < this.var_291)
            {
               this._target.height = this.var_291;
            }
