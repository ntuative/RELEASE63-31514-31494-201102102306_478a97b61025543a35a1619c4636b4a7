package com.sulake.core.window.utils
{
   ...
   public class PropertyStruct
   {
      ...
      public function PropertyStruct(param1:String, param2:Object, param3:String, param4:Boolean, param5:Array = null)
      {
         ...
         this.var_2779 = param3 == const_207 || param3 == const_141 || param3 == const_220 || param3 == const_268;
      ...
      public function toString() : String
      {
         switch(this._type)
         {
            ...
            case const_37:
               return Boolean(this.var_182) == true ? "HabboFriendListCom_opened_to_web_popup_xml" : "false";
            case const_220:
      ...
      public function toXMLString() : String
      {
         ...
         switch(this._type)
         {
            case const_207:
               ...
               _loc1_ = "<var key=\"" + this.var_642 + "\">\r<value>\r<" + this._type + ">\r";
               _loc2_ = 0;
            ...
            case const_268:
               ...
               break;
            case const_137:
               _loc1_ = "<var key=\"" + this.var_642 + "\" value=\"" + "0x" + uint(this.var_182).toString(16) + "\" type=\"" + this._type + "\" />";
               break;
            default:
               _loc1_ = "<var key=\"" + this.var_642 + "\" value=\"" + this.var_182 + "\" type=\"" + this._type + "\" />";
         }
         return _loc1_;
      }
   }
