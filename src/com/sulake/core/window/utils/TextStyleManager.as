package com.sulake.core.window.utils
{
   ...
   public class TextStyleManager
   {
      ...
      private static var var_444:Array;
      
      private static var _eventDispatcher:IEventDispatcher;
      
      private static const const_578:String = "{";
      
      private static const const_577:String = "}";
      
      private static const const_1212:String = "/*";
      
      private static const const_1213:String = "*/";
      ...
      public static function setStyles(param1:Array, param2:Boolean = false) : void
      {
         ...
         if(param2)
         {
            _loc5_ = [var_81[const_166],var_81[ITALIC],var_81[BOLD]];
            var_81.reset();
            var_81[const_166] = _loc5_[0];
         ...
         for each(_loc4_ in param1)
         {
            ...
            if(var_444.indexOf(_loc4_.name) == -1)
            {
               var_444.push(_loc4_.name);
            }
         }
         _eventDispatcher.dispatchEvent(new Event(Event.CHANGE));
      ...
      public static function parseCSS(param1:String) : Array
      {
         ...
         for each(_loc7_ in _loc3_)
         {
            ...
            _loc6_.kerning = !!_loc5_.kerning ? _loc5_.kerning == "HabboFriendListCom_opened_to_web_popup_xml" : null;
      ...
      private static function parseStyleNamesFromCSS(param1:String) : Array
      {
         ...
         var _loc4_:Array = _loc3_.split(const_577);
         if(countSubStrings(param1,const_578) != countSubStrings(param1,const_577))
         {
            throw new Error("Mismatching amount of \"" + const_578 + "\" versus \"" + const_577 + "\", please check the CSS!");
         }
         for each(_loc5_ in _loc4_)
         {
            while(_loc5_.indexOf(const_1212) == 0)
            {
               _loc5_ = _loc5_.substring(_loc5_.indexOf(const_1213) + 2,_loc5_.length);
            }
            _loc5_ = _loc5_.slice(0,_loc5_.indexOf(const_578)).split(" ").join("");
            if(_loc5_.length)
            {
               _loc2_.push(_loc5_);
            }
