package com.sulake.habbo.roomevents.userdefinedroomevents
{
   ...
   public class UserDefinedRoomEventsCtrl
   {
      ...
      private var var_1492:TriggerConfs;
      
      private var var_1494:ActionTypes;
      
      private var var_1493:ConditionTypes;
      
      private var var_229:Dictionary;
      
      private var var_60:Triggerable;
      
      private var var_653:RoomObjectHightLighter;
      
      private var var_164:UserDefinedRoomEventsHelp;
      
      private var var_1003:SliderWindowController;
      
      public function UserDefinedRoomEventsCtrl(param1:HabboUserDefinedRoomEvents)
      {
         this.var_1492 = new TriggerConfs();
         this.var_1494 = new ActionTypes();
         this.var_1493 = new ConditionTypes();
         this.var_229 = new Dictionary();
         super();
         this.var_87 = param1;
         this.var_653 = new RoomObjectHightLighter(param1);
         this.var_164 = new UserDefinedRoomEventsHelp(param1);
      }
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_1003 = new SliderWindowController(this.var_87,IWindowContainer(this.find(this.var_86,"delay_slider_container")),this.var_87.assets,0,20,1);
         this.var_1003.addEventListener(Event.CHANGE,this.onDelaySliderChange);
         this.var_1003.setValue(0);
      ...
      public function close() : void
      {
         if(this._window)
         {
            ...
            this.var_653.hideAll(this.var_229);
         }
      }
      ...
      public function prepareForUpdate(param1:Triggerable) : void
      {
         ...
         this.var_653.showAll(this.var_229);
         if(this.var_60 as ActionDefinition != null)
         {
            _loc5_ = ActionDefinition(this.var_60);
            _loc6_ = _loc5_.delayInPulses;
            this.var_1003.setValue(_loc6_);
         }
         this.refresh();
      }
      ...
      public function getActionDelay() : int
      {
         ...
         return !!_loc1_.allowDelaying ? int(this.var_1003.getValue()) : 0;
      }
      ...
      private function onHelp(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_164.open(this._window.x + this._window.width + 5,this._window.y);
      }
      ...
      private function refresh() : void
      {
         ...
         this.refreshConfigureElement(this.var_1492);
         this.refreshConfigureElement(this.var_1494);
         this.refreshConfigureElement(this.var_1493);
