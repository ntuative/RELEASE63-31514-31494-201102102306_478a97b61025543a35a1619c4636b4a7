package com.sulake.habbo.roomevents.userdefinedroomevents.help
{
   ...
   public class UserDefinedRoomEventsHelp
   {
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_1702 = IWindowContainer(this.find(this._window,"help_container"));
         this.var_1105 = this.var_1702.findChildByName("button_previous") as IContainerButtonWindow;
         if(this.var_1105)
         {
            this.var_1105.procedure = this.onButtonClick;
         }
         this.var_1106 = this.var_1702.findChildByName("button_next") as IContainerButtonWindow;
         if(this.var_1106)
         {
      ...
      {
         if(this.var_246 >= this._localizations.length - 1)
         {
      ...
      {
         ++this.var_246;
         this.var_246 = Math.min(this.var_246,this._localizations.length - 1);
         this.openPage();
      }
      ...
      private function localize() : void
      {
         ...
         if(_loc1_)
         {
            _loc1_.text = ILocalization(this._localizations[this.var_246][0]).value;
         }
         if(_loc2_)
         {
            _loc2_.text = ILocalization(this._localizations[this.var_246][2]).value;
         }
         if(_loc3_)
         {
            _loc4_ = ILocalization(this._localizations[this.var_246][1]).value;
