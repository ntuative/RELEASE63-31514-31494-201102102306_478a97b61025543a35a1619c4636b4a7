package com.sulake.habbo.roomevents.userdefinedroomevents.actiontypes
{
   ...
   public class GiveScore implements ActionType
   {
      ...
      private var var_1004:SliderWindowController;
      ...
      public function readIntParamsFromForm(param1:IWindowContainer) : Array
      {
         ...
         _loc2_.push(this.var_1004.getValue());
      ...
      {
         this.var_87 = param2;
         this.var_1004 = new SliderWindowController(param2,this.getInput(param1),param2.assets,1,100,1);
         this.var_1004.addEventListener(Event.CHANGE,this.onSliderChange);
         this.var_1004.setValue(1);
         this.var_1037 = new SliderWindowController(param2,this.getCounterInput(param1),param2.assets,1,10,1);
         this.var_1037.addEventListener(Event.CHANGE,this.onCounterSliderChange);
         this.var_1037.setValue(1);
      }
