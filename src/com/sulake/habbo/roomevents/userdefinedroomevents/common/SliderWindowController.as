package com.sulake.habbo.roomevents.userdefinedroomevents.common
{
   ...
   public class SliderWindowController extends EventDispatcher
   {
      ...
      public function setValue(param1:Number, param2:Boolean = true) : void
      {
         ...
         param1 = Math.min(this.var_1108,param1);
         this.var_888 = param1;
         if(param2)
         {
      ...
      private function updateSliderPosition() : void
      {
         ...
         if(_loc1_ != null)
         {
            _loc1_.x = this.getSliderPosition(this.var_888);
         }
      ...
      {
         return int(this.var_1663 * (Number(param1 - this._minValue) / (this.var_1108 - this._minValue)));
      }
      
      private function getValueAtPosition(param1:Number) : Number
      {
         return param1 / this.var_1663 * (this.var_1108 - this._minValue) + this._minValue;
      }
      ...
      private function sliderProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_889)
         {
            if(param1.type == WindowMouseEvent.const_56 || param1.type == WindowMouseEvent.const_186)
            {
               this.var_889 = false;
            }
         }
         if(!this.var_889 || param1.type != WindowEvent.const_377)
         {
            return;
         }
         if(this.var_595 != 0)
      ...
      private function sliderButtonRightProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            if(this.var_595 != 0)
            {
               _loc3_ = this.var_888 + this.var_595;
      ...
      private function displaySlider() : void
      {
         ...
         if(_loc2_ != null && this.var_702 != null)
         {
            _loc2_.bitmap = new BitmapData(this.var_702.width,this.var_702.height,true,16777215);
            _loc2_.bitmap.copyPixels(this.var_702,this.var_702.rect,new Point(0,0),null,null,true);
         }
         _loc1_ = this._sliderContainer.findChildByName("slider_movement_area") as IWindowContainer;
         if(_loc1_ != null)
         {
            _loc2_ = _loc1_.findChildByName("slider_button") as IBitmapWrapperWindow;
            if(_loc2_ != null && this.var_703 != null)
            {
               _loc2_.bitmap = new BitmapData(this.var_703.width,this.var_703.height,true,16777215);
               _loc2_.bitmap.copyPixels(this.var_703,this.var_703.rect,new Point(0,0),null,null,true);
               _loc2_.procedure = this.sliderProcedure;
               this.var_1663 = _loc1_.width - _loc2_.width;
            }
         }
      ...
      private function storeAssets(param1:IAssetLibrary) : void
      {
         ...
         this.var_702 = BitmapData(_loc2_.content);
         _loc2_ = BitmapDataAsset(param1.getAssetByName("slider_obj_png"));
         this.var_703 = BitmapData(_loc2_.content);
      }
   }
}
