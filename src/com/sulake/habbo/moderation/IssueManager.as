package com.sulake.habbo.moderation
{
   ...
   public class IssueManager
   {
      ...
      public static const const_1200:String = "issue_bundle_open";
      
      public static const const_652:String = "issue_bundle_my";
      
      public static const const_988:String = "issue_bundle_picked";
      
      public static const const_1552:int = 15000;
      ...
      public function IssueManager(param1:ModerationManager)
      {
         ...
         this.var_591 = new IssueBrowser(this,this.var_61.windowManager,this.var_61.assets);
         this.var_1101 = [];
         this.var_1100 = [];
         this.var_880 = new Map();
         this.var_2422 = parseInt(this.var_61.configuration.getKey("chf.score.updatefactor","60"));
         this.var_1691 = new Timer(const_1552,0);
         this.var_1691.addEventListener(TimerEvent.TIMER,this.updatePriorities);
         this.var_1691.start();
      }
      ...
      public function pickBundle(param1:int, param2:Boolean = false, param3:int = 0) : void
      {
         ...
         this.var_1101 = this.var_1101.concat(_loc4_.getIssueIds());
      }
      ...
      public function releaseAll() : void
      {
         ...
         {
            if(_loc3_.state == IssueMessageData.const_373 && _loc3_.pickerUserId == _loc1_)
            {
      ...
      private function sendRelease(param1:Array) : void
      {
         ...
         this.var_1100 = this.var_1100.concat(param1);
      }
      ...
      public function playSound(param1:IssueMessageData) : void
      {
         ...
         {
            this.var_61.soundManager.playSound(HabboSoundTypesEnum.const_1197);
         }
      }
      ...
      public function updateIssue(param1:IssueMessageData) : void
      {
         ...
         var _loc2_:int = int(this.var_881.getValue(param1.issueId));
         if(_loc2_ != 0)
         {
            ...
            if(_loc3_ != null)
            {
               ...
               else
               {
                  ...
                  this.var_881.remove(param1.issueId);
                  _loc3_ = null;
               }
            }
         }
         if(param1.state == IssueMessageData.const_1459)
         {
            this._issues.remove(param1.issueId);
            return;
         }
         if(_loc3_ == null)
         {
            for each(_loc4_ in this.var_98)
            {
               if(this.validateBundle(_loc4_,param1))
               {
                  _loc3_ = _loc4_;
                  _loc3_.updateIssue(param1);
                  this.var_881.add(param1.issueId,_loc3_.id);
                  break;
               }
            }
         }
         if(_loc3_ == null)
         {
            _loc2_ = this.var_2421++;
            _loc3_ = new IssueBundle(_loc2_,param1);
            this.var_881.add(param1.issueId,_loc2_);
         ...
         {
            _loc6_ = this.getBundles(const_652);
            _loc7_ = false;
            ...
            _loc9_ = this.var_1100.indexOf(param1.issueId);
            if(_loc9_ == -1 && _loc7_)
            {
      ...
      {
         var _loc2_:IssueHandler = this.var_880.getValue(param1) as IssueHandler;
         if(_loc2_ != null)
         {
            _loc2_.update();
         }
      ...
      {
         var _loc2_:* = this.var_880.remove(param1) as IssueHandler;
         if(_loc2_ != null)
         {
            _loc2_.dispose();
            _loc2_ = null;
      ...
      public function removeIssue(param1:int) : void
      {
         ...
         var _loc2_:int = this.var_881.getValue(param1);
         if(_loc2_ != 0)
         {
            _loc3_ = this.var_98.getValue(_loc2_) as IssueBundle;
            if(_loc3_ != null)
         ...
         for each(_loc4_ in this.var_98)
         {
            switch(param1)
            {
               case const_1200:
                  ...
                  break;
               case const_652:
                  if(_loc4_.state == IssueMessageData.const_373 && _loc4_.pickerUserId == _loc3_)
                  {
                     _loc2_.push(_loc4_);
                  }
                  break;
      ...
      public function handleBundle(param1:int) : void
      {
         ...
         this.var_880.add(param1,_loc3_);
      ...
      public function unhandleBundle(param1:int) : void
      {
         ...
         var _loc3_:IssueHandler = this.var_880.remove(param1);
         if(_loc3_ != null)
         {
            _loc3_.dispose();
         }
      ...
      public function autoHandle(param1:int) : void
      {
         ...
         {
            if(_loc5_.state == IssueMessageData.const_373 && _loc5_.pickerUserId == _loc4_ && _loc5_.id != param1 && (_loc3_ == null || _loc5_.prioritySum > _loc3_.prioritySum))
            {
               _loc3_ = _loc5_;
            }
         }
      ...
      public function issuePickFailed(param1:Array) : Boolean
      {
         ...
         for each(_loc4_ in param1)
         {
            ...
            {
               _loc12_ = _loc8_.id;
               _loc13_ = this.var_880.getValue(_loc12_) as IssueHandler;
               if(_loc13_ != null)
               {
                  _loc13_.dispose();
               }
