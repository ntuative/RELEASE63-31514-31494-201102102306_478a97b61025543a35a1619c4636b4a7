package com.sulake.habbo.moderation
{
   ...
   public class IssueBundle
   {
      ...
      private var var_731:IssueMessageData = null;
      ...
      public function IssueBundle(param1:int, param2:IssueMessageData)
      {
         ...
         this.var_2206 = param2.pickerUserId;
         this.var_2507 = param2.pickerUserName;
      ...
      private function addIssue(param1:IssueMessageData) : void
      {
         ...
         this.var_1121 += param1.priority;
         if(param1.message != null && param1.message != "")
         {
            ++this.var_1120;
         }
         if(this.var_731 == null || param1.timeStamp < this.var_731.timeStamp)
         {
            this.var_731 = param1;
         }
      ...
      {
         var _loc3_:* = null;
         var _loc2_:IssueMessageData = this.var_731;
         if(_loc2_ == null)
         {
