package com.sulake.habbo.moderation
{
   ...
   public class ChatlogCtrl implements IDisposable, TrackedWindow
   {
      ...
      private static var var_804:Array = [];
      
      private static var var_1491:int = 1000;
      
      private static var var_803:Array = [];
      
      private static var var_1488:int = 200;
      ...
      private var var_1489:IMessageComposer;
      ...
      {
         this.var_651 = IWindowContainer(this.var_33.getXmlWindow("chatlog_roomheader"));
         this.var_652 = IWindowContainer(this.var_33.getXmlWindow("chatlog_chatline"));
         this.var_452 = new Timer(1000,1);
         ...
         this.var_33.connection.send(this.var_1489);
      ...
      private function getChatLineWindow() : IWindowContainer
      {
         if(false)
         {
            return var_804.pop() as IWindowContainer;
         }
      ...
      private function populateChatline(param1:IItemListWindow, param2:ChatlineData, param3:Boolean) : void
      {
         ...
         _loc4_.color = this.var_1490[param2.chatterId] != null ? (!!param3 ? 4294623571 : uint(4294959680)) : (!!param3 ? 4288861930 : uint(4294967295));
         ...
         if(param2.chatterId > 0)
         {
            ...
            if(!this.var_1244.getValue(param2.chatterName))
            {
               this.var_1244.add(param2.chatterName,param2.chatterId);
            }
         }
      ...
      private function onChatLogUserClick(param1:WindowMouseEvent) : void
      {
         ...
         var _loc3_:int = this.var_1244.getValue(_loc2_);
