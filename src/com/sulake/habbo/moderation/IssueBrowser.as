package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private const const_1978:String = "my_issues";
      
      private const const_1977:String = "open_issues";
      
      private const const_1979:String = "picked_issues";
      
      private const const_1989:String = "closed_issues";
      ...
      private var var_1752:IIssueBrowserView;
      
      private var var_1753:IIssueBrowserView;
      
      private var var_1754:PickedIssuesView;
      ...
      private function selectView(param1:String) : void
      {
         ...
         this.var_349.view.width = this.var_248.container.width;
         this.var_349.view.height = this.var_248.container.height;
         this.var_349.visible = true;
         this.var_349.update();
      }
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case this.const_1978:
               ...
               {
                  this.var_1752 = new MyIssuesView(this.issueManager,this,this.var_248.container);
               }
               return this.var_1752;
            case this.const_1977:
               if(this.var_1753 == null)
               {
                  this.var_1753 = new OpenIssuesView(this.issueManager,this,this.var_248.container);
               }
               return this.var_1753;
            case this.const_1979:
               if(this.var_1754 == null)
               {
                  this.var_1754 = new PickedIssuesView(this.issueManager,this,this.var_248.container);
               }
