package com.sulake.habbo.moderation
{
   ...
   public class RoomVisitsCtrl implements IDisposable, TrackedWindow
   {
      ...
      private static var var_859:Array = [];
      
      private static var var_1638:int = 200;
      ...
      {
         this.var_699 = IWindowContainer(this.var_33.getXmlWindow("roomvisits_row"));
      ...
      {
         return WindowTracker.const_1492;
      }
      ...
      private function getRoomRowWindow() : IWindowContainer
      {
         if(false)
         {
            return var_859.pop() as IWindowContainer;
         }
         return IWindowContainer(this.var_699.clone());
      }
      ...
      private function storeRoomRowWindow(param1:IWindowContainer) : void
      {
         ...
         if(var_859.length < var_1638)
         {
            ...
            param1.width = this.var_699.width;
            param1.height = this.var_699.height;
            var_859.push(param1);
         }
         else
         {
