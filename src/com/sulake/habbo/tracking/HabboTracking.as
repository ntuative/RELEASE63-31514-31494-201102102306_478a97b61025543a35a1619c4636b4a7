package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, IUpdateReceiver
   {
      ...
      private static const const_947:uint = 11;
      ...
      private var var_46:IRoomWidgetFactory;
      ...
      private var var_1169:IHabboWindowManager;
      ...
      private var var_624:FramerateTracker = null;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_256 = new PerformanceTracker();
         this.var_624 = new FramerateTracker();
         this.var_257 = new LatencyTracker();
         this.var_625 = new LagWarningLogger();
         this.var_623 = new ToolbarClickTracker(this);
         this.var_1430 = new Array(const_947);
         var _loc4_:int = 0;
         while(_loc4_ < const_947)
         {
            this.var_1430[_loc4_] = 0;
            _loc4_++;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1526,new Date().getTime().toString());
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1590,!true ? ExternalInterface.call("window.navigator.userAgent.toString") : "unknown");
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1359,Capabilities.serverString);
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_729,String(false));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1192,String(0));
         }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(this.var_1169)
            {
               this.var_1169.release(new IIDHabboWindowManager());
               this.var_1169 = null;
            }
            if(this.var_309)
            {
            ...
            if(this.var_46)
            {
               this.var_46.release(new IIDHabboRoomWidget());
               this.var_46 = null;
            }
            if(this._navigator)
            {
            ...
            if(this.var_198)
            {
               if(!this.var_198.disposed)
               {
                  ...
                  Component(this.var_198).events.removeEventListener(HabboFriendListTrackingEvent.const_361,this.onFriendlistTrackingEvent);
               }
            ...
            if(this.var_164)
            {
               if(!this.var_164.disposed)
               {
                  this.var_164.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,this.onHelpTrackingEvent);
                  this.var_164.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,this.onHelpTrackingEvent);
               }
               this.var_164.release(new IIDHabboHelp());
               this.var_164 = null;
            }
            if(this.var_178)
            {
               ...
               {
                  this.var_178.events.removeEventListener(HabboToolbarEvent.const_39,this.onToolbarClick);
               }
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(this.var_176)
         {
            if(this.var_257 != null)
            {
               this.var_257.configuration = this.var_176;
            }
            if(this.var_256 != null)
            {
               this.var_256.configuration = this.var_176;
            }
            ...
            if(this.var_176)
            {
               ...
               {
                  this.var_625.configure(this.var_176);
               }
               if(this.var_624 != null)
               {
                  this.var_624.configure(this.var_176);
               }
               if(this.var_623 != null)
               {
                  this.var_623.configure(this.var_176);
               }
            }
         }
      }
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboHotelViewEvent.const_647,this.onHotelViewEvent);
      ...
      private function onConnectionReady(param1:IConnection) : void
      {
         ...
         if(param1 != null)
         {
            ...
            if(this.var_256 != null)
            {
               this.var_256.connection = param1;
            }
            if(this.var_257 != null)
            {
               this.var_257.communication = this._communication;
               this.var_257.connection = param1;
            }
            if(this.var_625 != null)
            {
      ...
      private function onHotelViewEvent(param1:Event) : void
      {
         ...
         else if(param1.type == HabboHotelViewEvent.const_574)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1535);
         }
         else if(param1.type == HabboHotelViewEvent.const_69)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1574);
         }
      }
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            ...
            case HabboCommunicationEvent.const_878:
               this.trackLoginStep(HabboLoginTrackingStep.const_1629,String(this._communication.port));
               break;
      ...
      {
         this.var_1169 = IHabboWindowManager(param2);
         if(this.var_1169)
         {
         ...
         if(param1.critical && !this._crashed)
         {
            ...
            if(this.var_176)
            {
               if(this.var_176.keyExists("client.fatal.error.url"))
               {
                  ...
                  _loc8_ = "";
                  for each(_loc9_ in this.var_1430)
                  {
                  ...
                  if(this.var_256 != null)
                  {
                     _loc4_["null"] = this.var_256.flashVersion;
                     _loc4_["null"] = this.var_256.averageUpdateInterval;
                  }
      ...
      {
         this.trackLoginStep(HabboLoginTrackingStep.const_1171);
         if(context && false)
         {
            context.root.events.removeEventListener(HabboLoginTrackingStep.const_1171,this.onCoreRunning);
         }
      }
      ...
      private function onFriendlistReady(param1:IID, param2:IUnknown) : void
      {
         ...
         Component(this.var_198).events.addEventListener(HabboFriendListTrackingEvent.const_361,this.onFriendlistTrackingEvent);
      }
      ...
      {
         this.var_46 = param2 as IRoomWidgetFactory;
         Component(this.var_46).events.addEventListener(HabboMeMenuTrackingEvent.HABBO_MEMENU_TRACKING_EVENT_CLOSE,this.onWidgetTrackingEvent);
         Component(this.var_46).events.addEventListener(HabboMeMenuTrackingEvent.HABBO_MEMENU_TRACKING_EVENT_DEFAULT,this.onWidgetTrackingEvent);
         Component(this.var_46).events.addEventListener(HabboMeMenuTrackingEvent.HABBO_MEMENU_TRACKING_EVENT_DANCE,this.onWidgetTrackingEvent);
         Component(this.var_46).events.addEventListener(HabboMeMenuTrackingEvent.HABBO_MEMENU_TRACKING_EVENT_EFFECTS,this.onWidgetTrackingEvent);
      }
      ...
      {
         this.var_164 = param2 as IHabboHelp;
         this.var_164.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,this.onHelpTrackingEvent);
         this.var_164.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,this.onHelpTrackingEvent);
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         if(!this.var_2635)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1561);
            this.var_2635 = true;
         }
         var _loc2_:RoomEntryInfoMessageParser = RoomEntryInfoMessageEvent(param1).getParser();
         if(_loc2_.guestRoom)
         {
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1192,String(_loc2_.guestRoomId));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_729,String(true));
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_309.events.addEventListener(AdEvent.const_417,this.onRoomAdLoad);
      }
      
      private function onToolbarReady(param1:IID = null, param2:IUnknown = null) : void
      {
         this.var_178 = param2 as IHabboToolbar;
         this.var_178.events.addEventListener(HabboToolbarEvent.const_39,this.onToolbarClick);
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         if(this.var_511 > -1 && _loc2_ < this.var_511)
         {
            ++this.var_1854;
            ErrorReportStorage.addDebugData("Invalid time counter","Invalid times: " + this.var_1854);
         }
         if(this.var_511 > -1 && _loc2_ - this.var_511 > 15000)
         {
            ++this.var_1855;
            ErrorReportStorage.addDebugData("Time leap counter","Time leaps: " + this.var_1855);
         }
         this.var_511 = _loc2_;
         if(this.var_256 != null)
         {
            this.var_256.update(param1,this.var_511);
         }
         if(this.var_257 != null)
         {
            this.var_257.update(param1,this.var_511);
         }
         if(this.var_624 != null)
         {
            this.var_624.trackUpdate(param1,this,this.var_511);
         }
         if(this.var_625 != null)
         {
            this.var_625.update(this.var_511);
         }
      }
   }
}
