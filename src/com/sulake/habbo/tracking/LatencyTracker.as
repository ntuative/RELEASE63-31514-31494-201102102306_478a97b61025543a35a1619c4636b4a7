package com.sulake.habbo.tracking
{
   ...
   public class LatencyTracker
   {
      ...
      public function init() : void
      {
         ...
         this.var_1857 = int(this.var_176.getKey("latencytest.interval"));
         this.var_1858 = int(this.var_176.getKey("latencytest.report.index"));
         this.var_2636 = int(this.var_176.getKey("latencytest.report.delta"));
      ...
      public function update(param1:uint, param2:int) : void
      {
         ...
         if(param2 - this.var_1856 > this.var_1857)
         {
            this.testLatency();
         }
      }
      ...
      {
         this.var_1856 = getTimer();
         this.var_626.add(this.var_1431,this.var_1856);
      ...
      private function onPingResponse(param1:IMessageEvent) : void
      {
         ...
         var _loc10_:int = 0;
         var _loc11_:* = null;
         if(this.var_626 == null || this.var_223 == null)
         {
            return;
         }
         ...
         if(this.var_223.length == this.var_1858 && this.var_1858 > 0)
         {
            _loc5_ = 0;
            _loc6_ = 0;
            _loc7_ = 0;
            ...
            if(Math.abs(_loc9_ - this.var_1859) > this.var_2636 || this.var_1859 == 0)
            {
