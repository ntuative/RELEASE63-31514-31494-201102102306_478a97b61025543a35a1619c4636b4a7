package com.sulake.habbo.window
{
   ...
   public class HabboWindowManagerComponent extends Component implements IHabboWindowManager, ICoreWindowManager, IWindowFactory, IUpdateReceiver, IWindowContextStateListener
   {
      ...
      private static const const_1279:uint = 1;
      ...
      private var var_867:IWindowRenderer;
      
      private var var_866:ISkinContainer;
      
      private var var_338:Array;
      
      private var var_1339:IEventDispatcher;
      
      private var var_1088:Boolean = false;
      
      private var var_1672:ProfilerOutput;
      ...
      private function initialize(param1:IID, param2:IUnknown) : void
      {
         ...
         this.var_866 = new SkinContainer(_loc4_.content as XML,assets);
         this.var_867 = new WindowRenderer(this.var_866);
         ...
         {
            this.var_192[_loc6_] = new WindowContext("layer_" + _loc6_,this.var_867,this,this._localization,context.displayObjectContainer,_loc5_,this);
            _loc6_++;
         }
         this._windowContext = this.var_192[const_1279];
         ...
         this._windowContext.getMouseCursor().defineCustomCursorType(MouseCursorType.const_1352,_loc7_);
         unlock();
      ...
      private function receiveProfilerInterface(param1:IID, param2:IUnknown) : void
      {
         ...
         if(_loc3_ != null)
         {
            if(!this.var_1672)
            {
               this.var_1672 = new ProfilerOutput(context,this,this.var_867);
            }
            this.var_1672.profiler = _loc3_;
            this.var_1338 = new ProfilerAgentTask("Update","Event processing");
            _loc3_.getProfilerAgentForReceiver(this).addSubTask(this.var_1338);
            this.var_1337 = new ProfilerAgentTask("Redraw","Window rasterizer");
      ...
      {
         var _loc3_:Dictionary = this.var_338[param2] as Dictionary;
         if(_loc3_ == null)
         {
            return null;
         }
         var _loc4_:XML = _loc3_[param1] as XML;
         return _loc4_ == null ? this.var_338[0][param1] as XML : _loc4_;
      }
      
      public function getDefaultsByTypeAndStyle(param1:uint, param2:uint) : DefaultAttStruct
      {
         return this.var_866.getDefaultAttributesByTypeAndStyle(param1,param2);
      }
      ...
      public function method_2(param1:uint) : IDesktopWindow
      {
      ...
      public function update(param1:uint) : void
      {
         ...
         if(WindowContext.var_371.length > 0)
         {
            this.var_1339.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_INPUT));
            _loc2_ = const_409 - 1;
            while(_loc2_ >= 0)
            {
         ...
         this.var_1339.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_RENDER));
         _loc2_ = 0;
         ...
         if(WindowContext.var_371.length > 0)
         {
            WindowContext.var_371.flush();
         }
         this.var_1339.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_SLEEP));
      }
      ...
      public function mouseEventReceived(param1:String, param2:IWindow) : void
      {
         if(param2 != null)
         {
            ...
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1373,new Date().getTime().toString());
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1413,param2.name + ": " + param2.toString());
            }
            else if(param1 == MouseEvent.MOUSE_UP)
            {
               ...
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1598,param2.name + ": " + param2.toString());
            }
         }
      }
      ...
      private function performTestCases() : void
      {
         ...
         _loc1_.begin(this);
         _loc1_.test({
            "type":WindowType.const_440,
            "style":WindowStyle.const_171,
            "caption":"Testing",
            "count":800,
            "properties":[_loc2_]
         });
