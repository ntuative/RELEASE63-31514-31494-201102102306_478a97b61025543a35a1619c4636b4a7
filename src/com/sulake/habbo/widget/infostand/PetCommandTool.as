package com.sulake.habbo.widget.infostand
{
   ...
   public class PetCommandTool
   {
      ...
      private var var_429:IFrameWindow;
      ...
      private const const_1987:int = 1100;
      
      public function PetCommandTool(param1:InfostandWidget)
      {
         super();
         this._widget = param1;
         this.var_1186 = new Map();
         this.var_366 = new Timer(this.const_1987);
      ...
      public function showCommandToolForPet(param1:int, param2:String, param3:BitmapData = null) : void
      {
         ...
         var _loc6_:CommandConfiguration = this.var_1186.getValue(param1) as CommandConfiguration;
         if(_loc6_ == null)
         {
            this.disableAllButtons();
            this.requestEnabledCommands(this.var_519);
         }
         else
         {
      ...
      {
         var _loc2_:CommandConfiguration = this.var_1186.getValue(this.var_519) as CommandConfiguration;
      ...
      {
         this.var_1186.remove(param1);
         this.var_1186.add(param1,param2);
      ...
      {
         var _loc2_:RoomWidgetPetCommandMessage = new RoomWidgetPetCommandMessage(RoomWidgetPetCommandMessage.const_719,param1);
      ...
      private function createCommandWindow() : void
      {
         ...
         this.var_38.context.getDesktopWindow().addEventListener(WindowEvent.const_46,this.onWindowDesktopResized);
      ...
      private function openInfoWindow() : void
      {
         ...
         if(this.var_429 == null)
         {
            ...
            this.var_429 = (this._widget.windowManager as ICoreWindowManager).buildFromXML(_loc1_.content as XML) as IFrameWindow;
            if(this.var_429 == null)
            {
               throw new Error("Failed to construct command info window from XML!");
            }
            this.var_429.x = 200;
            this.var_429.procedure = this.onInfoWindowProcedure;
         }
         else
         {
            this.var_429.visible = true;
         }
      }
      ...
      private function onCommandWindowProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(_loc3_ != null && _loc3_.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            {
               this._widget.messageListener.processWidgetMessage(new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_383,this.var_519));
            }
            else if(param2.name.indexOf("btn_cmd_") > -1)
            {
               ...
               _loc7_ = new RoomWidgetPetCommandMessage(RoomWidgetPetCommandMessage.const_534,this.var_519,this.var_1884 + " " + _loc6_);
      ...
      private function onTrainButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc6_:RoomWidgetPetCommandMessage = new RoomWidgetPetCommandMessage(RoomWidgetPetCommandMessage.const_534,this.var_519,this.var_1884 + " " + _loc5_);
