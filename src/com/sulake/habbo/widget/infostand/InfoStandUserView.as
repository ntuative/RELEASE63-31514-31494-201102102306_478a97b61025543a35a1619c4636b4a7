package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandUserView
   {
      ...
      private var var_556:IWindow;
      
      private var var_203:IBorderWindow;
      
      private var var_1087:TagListRenderer;
      ...
      private const const_1663:int = 39;
      
      private const const_1661:int = 7829367;
      
      private const const_1662:int = 16777215;
      
      private const const_1944:int = 2000;
      ...
      public function InfoStandUserView(param1:InfostandWidget, param2:String)
      {
         ...
         this.var_1087 = new TagListRenderer(param1,this.onTagSelected);
      }
      ...
      public function setMotto(param1:String, param2:Boolean) : void
      {
         ...
         if(param2)
         {
            ...
            {
               _loc3_.textColor = this.const_1662;
            }
            _loc3_.enable();
         }
         else
         ...
         if(param2)
         {
            _loc3_.addEventListener(WindowKeyboardEvent.const_354,this.onMottoKeyboard);
            _loc3_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onMottoClicked);
         }
         else
         {
            _loc3_.removeEventListener(WindowKeyboardEvent.const_354,this.onMottoClicked);
         }
         this.updateWindow();
      }
      ...
      public function setTags(param1:Array, param2:Array = null) : void
      {
         ...
         if(param1.length != 0)
         {
            _loc3_.height = this.var_1087.renderTags(param1,_loc3_,param2);
            _loc4_.height = 1;
         }
         else
         {
      ...
      protected function updateInfo(param1:RoomWidgetUserInfoUpdateEvent) : void
      {
         ...
         this.setMotto(param1.motto,param1.type == RoomWidgetUserInfoUpdateEvent.const_168);
      ...
      private function updateRespectButton() : void
      {
         ...
         var _loc2_:int = this._widget.userData.method_1;
      ...
      protected function setTradeButtonTooltip(param1:int) : void
      {
         ...
         switch(param1)
         {
            case RoomWidgetUserInfoUpdateEvent.TRADE_REASON_NO_OWN_RIGHT:
               ...
               break;
            case RoomWidgetUserInfoUpdateEvent.const_974:
               _loc2_ = "${infostand.button.trade.tooltip.shutdown}";
               break;
            case RoomWidgetUserInfoUpdateEvent.const_1058:
      ...
      protected function onMottoKeyboard(param1:WindowKeyboardEvent) : void
      {
         ...
         {
            _loc5_ = getTimer();
            if(_loc5_ - this.var_2091 > this.const_1944 && _loc3_ != this._widget.localizations.getKey("infostand.motto.change"))
            {
               ...
               this.var_2091 = _loc5_;
            }
         }
         else
         {
            _loc2_.textColor = this.const_1661;
            if(_loc3_.length >= this.const_1663)
            {
               _loc2_.text = _loc3_.substring(0,this.const_1663 - 1);
            }
         }
      }
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            ...
            case "friend":
               ...
               break;
            case "respect":
               --this._widget.userData.method_1;
               this.updateRespectButton();
               _loc3_ = "null";
               break;
            case "ignore":
      ...
      private function badgesEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            if(param2.name == "button.give")
            {
               ...
               if(_loc4_)
               {
                  _loc3_ = _loc4_.getGridItemIndex(this.var_556);
               }
               if(_loc3_ <= -1)
               {
                  return;
