package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandPetData
   {
      ...
      public function setData(param1:RoomWidgetPetInfoUpdateEvent) : void
      {
         ...
         this.var_1688 = param1.id;
         this._type = param1.petType;
         this.var_2169 = param1.petRace;
         this.var_43 = param1.image;
         this.var_2172 = param1.isOwnPet;
         this.var_2175 = param1.ownerId;
         this._ownerName = param1.ownerName;
         this._canOwnerBeKicked = param1.canOwnerBeKicked;
         this.var_1285 = param1.level;
         this.var_2173 = param1.levelMax;
         this.var_2170 = param1.experience;
         this.var_2167 = param1.experienceMax;
         this._energy = param1.energy;
         this.var_2168 = param1.energyMax;
         this._nutrition = param1.nutrition;
         this.var_2171 = param1.nutritionMax;
         this._petRespect = param1.petRespect;
         this.var_2174 = param1.roomIndex;
         this.var_506 = param1.age;
      }
   }
}
