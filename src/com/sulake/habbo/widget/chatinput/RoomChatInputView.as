package com.sulake.habbo.widget.chatinput
{
   ...
   public class RoomChatInputView
   {
      ...
      private static const const_1273:int = 11;
      
      private static const const_589:int = 18;
      
      private static const const_923:int = 16;
      
      private static const const_1274:int = 20;
      ...
      private var var_292:Number = 600;
      ...
      public function RoomChatInputView(param1:RoomChatInputWidget, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager)
      {
         ...
         this.var_1081 = this._localization.getKey("widgets.chatinput.mode.whisper",":tell");
         this._chatModeIdShout = this._localization.getKey("widgets.chatinput.mode.shout",":shout");
         this.var_2330 = this._localization.getKey("widgets.chatinput.mode.speak",":speak");
         this.var_337 = new Timer(1000,1);
         this.var_337.addEventListener(TimerEvent.TIMER_COMPLETE,this.onTypingTimerComplete);
         this.var_398 = new Timer(10000,1);
         this.var_398.addEventListener(TimerEvent.TIMER_COMPLETE,this.onIdleTimerComplete);
         this.createWindow();
      }
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_398.reset();
            this.var_398.removeEventListener(TimerEvent.TIMER_COMPLETE,this.onIdleTimerComplete);
            this.var_398 = null;
         }
      }
      ...
      private function refreshView() : void
      {
         ...
         this._window.width = _loc1_.width + const_589 + const_923;
         _loc1_.x = const_589;
         _loc1_.y = const_1273;
      }
      ...
      {
         this.var_292 = param1 - (const_589 + const_923);
      ...
      private function windowKeyEventProcessor(param1:Event = null, param2:IWindow = null) : void
      {
         ...
         if(_loc4_ == Keyboard.BACKSPACE)
         {
            ...
            if(_loc8_ != null)
            {
               ...
               if(_loc10_[0] == this.var_1081 && _loc10_.length == 3 && _loc10_[2] == "")
               {
                  _loc8_.text = "";
                  this.var_478 = "";
               }
      ...
      private function onWindowMoved(param1:WindowEvent) : void
      {
         ...
         this.setMaxWidth(this._window.context.getDesktopWindow().width - this._window.x - const_1274);
      }
      ...
      private function onInputChanged(param1:WindowEvent) : void
      {
         ...
         {
            if(!this._widget.allowPaste && _loc2_.text.length > this.var_478.length + 1)
            {
               _loc2_.text = "";
            }
            this.var_478 = _loc2_.text;
            if(!this.var_586)
            {
               this.var_586 = true;
               this.var_337.reset();
      ...
      private function checkInputFieldLimits() : void
      {
         ...
         if(_loc1_.textWidth >= this.var_292)
         {
