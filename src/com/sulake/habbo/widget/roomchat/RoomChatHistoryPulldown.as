package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatHistoryPulldown
   {
      ...
      private var var_2648:BitmapData;
      ...
      public function RoomChatHistoryPulldown(param1:RoomChatWidget, param2:IHabboWindowManager, param3:IWindowContainer, param4:IAssetLibrary)
      {
         ...
         this.var_37 = param3;
         this.var_2652 = (this._assetLibrary.getAssetByName("chat_grapbar_bg") as BitmapDataAsset).content as BitmapData;
         this.var_1872 = (this._assetLibrary.getAssetByName("chat_grapbar_grip") as BitmapDataAsset).content as BitmapData;
         this.var_2648 = (this._assetLibrary.getAssetByName("chat_grapbar_handle") as BitmapDataAsset).content as BitmapData;
         ...
         this.var_2649 = (this._assetLibrary.getAssetByName("chat_grapbar_x_pr") as BitmapDataAsset).content as BitmapData;
         this.var_2653 = (this._assetLibrary.getAssetByName("chat_history_bg") as BitmapDataAsset).content as BitmapData;
         this.var_73 = this._windowManager.createWindow("chat_history_bg","",HabboWindowType.const_297,HabboWindowStyle.const_31,HabboWindowParam.const_61,new Rectangle(0,0,param3.width,param3.height - const_83),null,0,0) as IBitmapWrapperWindow;
         this.var_37.addChild(this.var_73);
         this._window = this._windowManager.createWindow("chat_pulldown","",HabboWindowType.const_57,HabboWindowStyle.const_31,0 | 0,new Rectangle(0,this.var_37.height - const_83,param3.width,const_83),null,0) as IWindowContainer;
         this.var_37.addChild(this._window);
         this._region = this._windowManager.createWindow("REGIONchat_pulldown","",WindowType.const_866,HabboWindowStyle.const_40,0 | 0 | 0 | 0,new Rectangle(0,0,param3.width,param3.height - const_83),null,0) as IRegionWindow;
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            case const_559:
               this.var_73.blend += param1 / const_950;
               ...
               break;
            case const_942:
               this.var_73.blend -= param1 / const_951;
      ...
      public function containerResized(param1:Rectangle) : void
      {
         ...
         {
            this._window.x = 0;
            this._window.y = this.var_37.height - const_83;
            this._window.width = this.var_37.width;
         }
         if(this._region != null)
         {
            this._region.x = 0;
            this._region.y = this.var_37.height - const_83;
            this._region.width = this.var_37.width - this.var_2651;
         }
         if(this.var_73 != null)
         {
            this.var_73.rectangle = this.var_37.rectangle;
            this.var_73.height -= const_83;
         }
         this.buildWindowGraphics();
      }
      ...
      private function buildWindowGraphics() : void
      {
         ...
         if(this.var_2650 == this._window.width)
         {
            return;
         }
         this.var_2650 = this._window.width;
         ...
         if(_loc1_ != null && _loc3_ != null && _loc4_ != null)
         {
            if(_loc1_.width > 0 && _loc1_.height > 0)
            {
               ...
               this.tileBitmapHorz(this.var_2652,_loc7_);
         ...
         this.var_73.bitmap = this.var_2653;
