package com.sulake.habbo.widget.poll
{
   ...
   public class VoteWidget extends RoomWidgetBase
   {
      ...
      private var var_1361:Array = null;
      
      private var var_1198:Array = null;
      
      private var var_1825:int = -1;
      
      private var var_1412:int = 30000;
      ...
      public function VoteWidget(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IHabboLocalizationManager, param4:IHabboConfigurationManager)
      {
         ...
         {
            this.var_1412 = int(this._config.getKey("vote.time.limit","30000"));
         }
      }
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetVoteUpdateEvent.const_131,this.showVoteQuestion);
         param1.addEventListener(RoomWidgetVoteUpdateEvent.const_124,this.showVoteResult);
         param1.addEventListener(RoomWidgetFrameUpdateEvent.const_370,this.update);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetVoteUpdateEvent.const_131,this.showVoteQuestion);
         param1.removeEventListener(RoomWidgetVoteUpdateEvent.const_124,this.showVoteResult);
         param1.removeEventListener(RoomWidgetFrameUpdateEvent.const_370,this.update);
      }
      ...
      private function updateTimer(param1:int) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc4_ = Number(param1) / this.var_1412;
         ...
         if(_loc3_ != null)
         {
            _loc6_ = Math.max((this.var_1412 - param1) / 1000,0);
      ...
      private function update(param1:RoomWidgetFrameUpdateEvent) : void
      {
         ...
         var _loc2_:int = getTimer() - this.var_2540;
         if(_loc2_ > this.var_1412)
         {
            this.vote();
            return;
         }
