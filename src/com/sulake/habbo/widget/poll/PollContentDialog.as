package com.sulake.habbo.widget.poll
{
   ...
   public class PollContentDialog implements IPollDialog
   {
      ...
      private function nextQuestion() : void
      {
         ...
         var _loc7_:int = 0;
         ++this.var_1188;
         if(this.var_1188 < this.var_956.length)
         {
            _loc1_ = this.var_956[this.var_1188] as Dictionary;
            if(!_loc1_)
            {
            ...
            if(this._window)
            {
               ...
               if(_loc2_)
               {
                  ...
                  _loc6_ = _loc6_.replace("%count%",this.var_956.length);
                  _loc2_.text = _loc6_;
               }
      ...
      private function showCancelConfirm() : void
      {
         ...
         if(!this.var_430)
         {
            ...
            this.var_430 = this._widget.windowManager.buildFromXML(_loc1_.content as XML,2);
            this.var_430.center();
            this.var_430.procedure = this.cancelConfirmEventProc;
         }
      }
      ...
      private function answerPollQuestion() : void
      {
         ...
         var question:Dictionary = this.var_956[this.var_1188] as Dictionary;
