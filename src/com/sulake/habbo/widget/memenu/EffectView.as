package com.sulake.habbo.widget.memenu
{
   ...
   public class EffectView
   {
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         if(this.var_895 != null)
         {
            if(this.var_171.isActive)
            {
               ...
               this.var_895.width = _loc2_ * this.var_292;
            }
            else
            {
               this.var_895.width = 0;
               this.var_187.stop();
            }
            this.setTimeLeft();
         }
      ...
      private function setTimeLeft() : void
      {
         ...
         {
            this.var_897.caption = "${widgets.memenu.effects.active.timeleft}";
            _loc1_ = this.var_897.text;
            if(this.var_171.isActive)
            {
               ...
               this.var_897.text = _loc1_;
            }
            else
            {
               this.var_897.caption = "${widgets.memenu.effects.activate}";
            }
         }
      }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         else
         {
            ...
            this.var_896 = this._window.findChildByName("effect_hilite");
            this.var_896.visible = false;
         }
         this.var_897 = this._window.findChildByName("time_left") as ITextWindow;
         this.setTimeLeft();
         this.var_895 = this._window.findChildByName("loader_bar");
         if(this.var_895 != null)
         {
            this.var_292 = this.var_895.width;
            this.var_187.start();
            this.onUpdate();
         }
