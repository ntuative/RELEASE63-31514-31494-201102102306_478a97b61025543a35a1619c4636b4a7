package com.sulake.habbo.widget.furniture.petpackage
{
   ...
   public class PetPackageFurniWidget extends RoomWidgetBase
   {
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetPetPackageUpdateEvent.const_353,this.onObjectUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetPetPackageUpdateEvent.const_353,this.onObjectUpdate);
      ...
      private function onObjectUpdate(param1:RoomWidgetPetPackageUpdateEvent) : void
      {
         ...
         switch(event.type)
         {
            ...
            case RoomWidgetPetPackageUpdateEvent.const_446:
               ...
               break;
            case RoomWidgetPetPackageUpdateEvent.const_353:
      ...
      private function showInterface() : void
      {
         ...
         this._window = windowManager.createWindow("petpackage_container","",HabboWindowType.const_57,HabboWindowStyle.const_31,0 | 0,new Rectangle(const_1231,const_1230,2,2),null,0) as IWindowContainer;
      ...
      {
         if(this.var_975 == null || this._window == null)
         {
            return;
         }
         ...
         if(_loc1_ != null)
         {
            ...
            _loc1_.bitmap.copyPixels(this.var_975,this.var_975.rect,new Point(0,0));
         }
      }
      ...
      private function sendOpenPetPackage() : void
      {
         ...
         if(this.var_1209 || this._objectId == -1)
         {
            return;
         }
         ...
         {
            this.var_1209 = true;
            message = new RoomWidgetOpenPetPackageMessage(RoomWidgetOpenPetPackageMessage.const_787,this._objectId,name);
