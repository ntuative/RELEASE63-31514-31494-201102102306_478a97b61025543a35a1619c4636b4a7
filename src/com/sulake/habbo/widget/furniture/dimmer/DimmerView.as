package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerView
   {
      ...
      private var var_400:DimmerViewAlphaSlider;
      ...
      private function createWindow() : void
      {
         ...
         this._window = this._widget.windowManager.createWindow("dimmerui_container","",HabboWindowType.const_57,HabboWindowStyle.const_31,0 | 0,new Rectangle(const_1231,const_1230,2,2),null,0) as IWindowContainer;
         ...
         if(_loc1_ != null)
         {
            this.var_400 = new DimmerViewAlphaSlider(this,_loc1_ as IWindowContainer,this._widget.assets);
         }
      ...
      private function selectPreset(param1:int) : void
      {
         ...
         this.var_1340 = _loc2_.light;
         if(this.var_400 != null)
         {
            this.var_400.setValue(this.var_1340);
         }
         this.var_515 = this.colors.indexOf(_loc2_.color);
         if(this.var_589 != null)
         {
            this.var_589.setSelectedColorIndex(this.var_515);
         }
      ...
      private function get windowXML() : XML
      {
         ...
         this.var_1341 = XML(_loc1_.content);
         return this.var_1341;
      }
      ...
      public function set selectedType(param1:int) : void
      {
         ...
         if(this.var_400 != null)
         {
            this.var_400.min = this._widget.minLights[param1 - 1];
         }
      }
