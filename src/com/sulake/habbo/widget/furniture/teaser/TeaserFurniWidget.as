package com.sulake.habbo.widget.furniture.teaser
{
   ...
   public class TeaserFurniWidget extends RoomWidgetBase
   {
      ...
      private const const_1688:int = 0;
      
      private const const_1686:int = 1;
      
      private const const_1685:int = 2;
      
      private const const_1683:int = 3;
      
      private const const_1687:int = 4;
      
      private const const_1967:int = 0;
      
      private const const_1975:int = 1;
      
      private const const_1974:int = 2;
      
      private const const_1972:int = 3;
      
      private const const_1970:int = 4;
      
      private const const_1971:int = 5;
      
      private const const_1684:String = "deco_img";
      
      private const const_1689:String = "dialog_bg";
      
      private const const_1973:String = "%campaign%_dialog_bg.png";
      
      private const const_325:String = "%campaign%_gift_package.png";
      
      private const const_1969:String = "%campaign%_gift_content.png";
      
      private const const_1968:String = "%campaign%_friend_gift_package.png";
      ...
      public function TeaserFurniWidget(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IHabboLocalizationManager, param4:IHabboConfigurationManager)
      {
         ...
         this._imageUrlPath = this.var_148.getKey("image.library.url","http://images.habbo.com/c_images/");
      ...
      override public function dispose() : void
      {
         ...
         this.hideInterface();
         var _loc1_:int = 0;
         while(_loc1_ < this.var_1366.length)
         {
            _loc2_ = this.var_1366.pop();
            _loc2_.dispose();
            _loc1_++;
         }
         this.var_148 = null;
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetTeaserDataUpdateEvent.const_566,this.onObjectUpdate);
         param1.addEventListener(RoomWidgetTeaserDataUpdateEvent.const_716,this.onObjectUpdate);
         param1.addEventListener(RoomWidgetTeaserDataUpdateEvent.const_609,this.onObjectUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetTeaserDataUpdateEvent.const_566,this.onObjectUpdate);
      }
      ...
      private function onObjectUpdate(param1:RoomWidgetTeaserDataUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetTeaserDataUpdateEvent.const_566:
               _loc2_ = this.const_1688;
               this.var_1119 = null;
               break;
            case RoomWidgetTeaserDataUpdateEvent.const_609:
         ...
         if(this._window && (this.var_1367 != _loc2_ || _loc3_ != this.var_172))
         {
            this._window.dispose();
            this._window = null;
         }
         this.var_172 = _loc3_;
         this.var_1367 = _loc2_;
         this.mainWindow;
         this.showInterface();
      }
         ...
         if(!this._window)
         {
            switch(this.var_1367)
            {
               case this.const_1688:
                  ...
                  _loc2_ = this.const_325;
                  this.sendConversionPoint("viral_val11","client.show.teaser");
                  break;
               case this.const_1686:
                  if(this.var_375 == this.const_1967)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_locked") as XmlAsset;
                     this.sendConversionPoint("viral_" + this.var_172,"client.show.locked");
                     _loc2_ = this.const_325;
                  }
                  else if(this.var_375 == this.const_1975)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_unlocked") as XmlAsset;
                     this.sendConversionPoint("viral_" + this.var_172,"client.show.unlocked");
                     _loc2_ = this.const_1969;
                  }
                  else if(this.var_375 == this.const_1974)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
                     this.sendConversionPoint("viral_" + this.var_172,"client.show.no_fb");
                  ...
                  else if(this.var_375 == this.const_1972)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
                     this.sendConversionPoint("viral_" + this.var_172,"client.show.not_enough_fb_friends");
                  ...
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
                     this.sendConversionPoint("viral_" + this.var_172,"client.show.campaign_closed");
            ...
            _loc5_ = this.const_1973.replace("%campaign%",this.var_172);
            this.setDecoImage(_loc5_,this.const_1689);
            _loc2_ = _loc2_.replace("%campaign%",this.var_172);
            this.setDecoImage(_loc2_,this.const_1684);
            if(_loc3_)
            {
      ...
      private function onTeaserOkButton(param1:WindowEvent) : void
      {
         ...
         {
            _loc2_ = new RoomWidgetViralFurniMessage(RoomWidgetViralFurniMessage.const_760);
      ...
      {
         this.sendConversionPoint("viral_" + this.var_172,"client.skip_post");
         this.hideInterface();
      }
      ...
      private function onPostButton(param1:WindowEvent) : void
      {
         ...
         this.sendConversionPoint("viral_" + this.var_172,"client.start_post",this.var_1119);
         var _loc4_:String = this.var_148.getKey("viral.furni.post_type","feed");
         HabboWebTools.facebookViralGiftPost(this.var_172,_loc2_,_loc3_,this.var_1119,_loc4_);
         this.hideInterface();
      }
      ...
      private function onOpenButton(param1:WindowEvent) : void
      {
         ...
         this.hideInterface();
         this.sendConversionPoint("viral_" + this.var_172,"client.open_gift");
      }
      ...
      private function sendConversionPoint(param1:String, param2:String, param3:String = "") : void
      {
         ...
         if(messageListener != null)
         {
            _loc4_ = new RoomWidgetConversionPointMessage(RoomWidgetConversionPointMessage.const_864,"ViralGift",param1,param2,param3);
      ...
      private function setDecoImage(param1:String, param2:String) : void
      {
         ...
         if(!_loc4_)
         {
            this.var_1366.push(new ImageDownloader(this,_assets,this.var_172,this._imageUrlPath,param1,param2));
            return;
         }
      ...
      {
         if(!this._window || this.var_172 != param1.campaignID)
         {
            return;
         }
