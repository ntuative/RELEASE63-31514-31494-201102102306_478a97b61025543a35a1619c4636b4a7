package com.sulake.habbo.ui
{
   ...
   public class RoomUI extends Component implements IRoomUI, IUpdateReceiver
   {
      ...
      private var var_1038:IRoomWidgetFactory;
      
      private var var_384:ISessionDataManager;
      
      private var _friendList:IHabboFriendList;
      
      private var var_521:IAvatarRenderManager;
      ...
      private var var_1919:IHabboAvatarEditor = null;
      ...
      private var var_1203:IHabboHelp;
      
      private var var_974:IHabboModeration;
      ...
      private var var_1204:IHabboUserDefinedRoomEvents;
      
      public function RoomUI(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         this.var_1464 = RoomDesktop.const_572;
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_1038.release(new IIDHabboRoomWidget());
            this.var_1038 = null;
         }
         ...
         {
            this.var_521.release(new IIDAvatarRenderManager());
            this.var_521 = null;
         }
         ...
         {
            this.var_1203.release(new IIDHabboHelp());
            this.var_1203 = null;
         }
         ...
         {
            this.var_974.release(new IIDHabboModeration());
            this.var_974 = null;
         }
         ...
         if(this.var_1204)
         {
            this.var_1204.release(new IIDHabboUserDefinedRoomEvents());
            this.var_1204 = null;
         }
         this.var_1919 = null;
      ...
      private function onRoomWidgetFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1038 = param2 as IRoomWidgetFactory;
      }
      ...
      private function onAvatarRenderManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_521 = param2 as IAvatarRenderManager;
      }
      ...
      private function onAvatarEditorReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1919 = param2 as IHabboAvatarEditor;
      }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         {
            this.var_309.events.addEventListener(AdEvent.const_479,this.adEventHandler);
            this.var_309.events.addEventListener(AdEvent.const_547,this.adEventHandler);
            this.var_309.events.addEventListener(AdEvent.const_417,this.adEventHandler);
         }
      }
      ...
      private function onHabboHelpReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1203 = param2 as IHabboHelp;
      }
      ...
      private function onHabboModerationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_974 = param2 as IHabboModeration;
         Logger.log("XXXX GOT HABBO MODERATION: " + this.var_974);
      }
      ...
      private function registerSessionEvents() : void
      {
         if(this.var_15)
         {
            this.var_15.events.addEventListener(RoomSessionEvent.const_240,this.roomSessionStateEventHandler);
            ...
            this.var_15.events.addEventListener(RoomSessionChatEvent.const_418,this.roomSessionEventHandler);
            this.var_15.events.addEventListener(RoomSessionUserBadgesEvent.const_63,this.roomSessionEventHandler);
            this.var_15.events.addEventListener(RoomSessionUserGivableBadgesEvent.const_63,this.roomSessionEventHandler);
            ...
            this.var_15.events.addEventListener(RoomSessionPresentEvent.const_279,this.roomSessionEventHandler);
            ...
            this.var_15.events.addEventListener(RoomSessionErrorMessageEvent.const_777,this.roomSessionDialogEventHandler);
            this.var_15.events.addEventListener(RoomSessionErrorMessageEvent.const_1037,this.roomSessionDialogEventHandler);
            this.var_15.events.addEventListener(RoomSessionErrorMessageEvent.const_1097,this.roomSessionDialogEventHandler);
            ...
            this.var_15.events.addEventListener(RoomSessionErrorMessageEvent.const_826,this.roomSessionDialogEventHandler);
            this.var_15.events.addEventListener(RoomSessionErrorMessageEvent.const_184,this.roomSessionDialogEventHandler);
            this.var_15.events.addEventListener(RoomSessionErrorMessageEvent.const_741,this.roomSessionDialogEventHandler);
            this.var_15.events.addEventListener(RoomSessionErrorMessageEvent.const_675,this.roomSessionDialogEventHandler);
            this.var_15.events.addEventListener(RoomSessionQueueEvent.const_507,this.roomSessionEventHandler);
            ...
            this.var_15.events.addEventListener(RoomSessionPollEvent.const_122,this.roomSessionEventHandler);
            this.var_15.events.addEventListener(RoomSessionDimmerPresetsEvent.const_431,this.roomSessionEventHandler);
         ...
         switch(param1.type)
         {
            ...
            case RoomSessionEvent.const_94:
               if(param1.session != null)
               {
                  ...
                  this.var_178.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_155,HabboToolbarIconEnum.ZOOM));
                  this.var_178.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_155,HabboToolbarIconEnum.MEMENU));
                  this.var_178.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_155,HabboToolbarIconEnum.INVENTORY));
               }
         }
      }
      ...
      private function roomSessionDialogEventHandler(param1:RoomSessionEvent) : void
      {
         ...
         switch(event.type)
         {
            ...
            case RoomSessionErrorMessageEvent.const_745:
               ...
               break;
            case RoomSessionErrorMessageEvent.const_826:
      ...
      private function adEventHandler(param1:AdEvent) : void
      {
         ...
         var _loc3_:RoomDesktop = this.method_2(_loc2_) as RoomDesktop;
         if(_loc3_ == null)
         {
            return;
         }
      ...
      {
         this.var_1204 = param2 as IHabboUserDefinedRoomEvents;
      }
      ...
      private function initializeRoomEngineEvents() : void
      {
         if(this._roomEngine != null && this._roomEngine.events != null)
         {
            ...
            this._roomEngine.events.addEventListener(RoomEngineEvent.const_752,this.roomEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineEvent.const_531,this.roomEngineEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineEvent.const_569,this.roomEngineEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineDimmerStateEvent.const_60,this.roomEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineRoomColorEvent.const_607,this.roomEventHandler);
            ...
            this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_299,this.roomObjectEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_756,this.roomObjectEventHandler);
      ...
      private function roomEngineEventHandler(param1:RoomEngineEvent) : void
      {
         ...
         if(param1.type == RoomEngineEvent.const_624)
         {
            if(this.var_15 != null)
            {
               this.var_15.roomEngineReady = true;
         ...
         else if(param1.type == RoomEngineEvent.const_569 || param1.type == RoomEngineEvent.const_531)
         {
            _loc2_ = this.getRoomIdentifier(param1.roomId,param1.roomCategory);
            _loc3_ = this.method_2(_loc2_) as RoomDesktop;
            if(_loc3_ == null)
            {
               return;
            }
      ...
      private function roomEventHandler(param1:RoomEngineEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineEvent.const_618:
               ...
               _loc3_.createWidget(RoomWidgetEnum.const_890);
               ...
               if(this._config.getKey("purse.widget.enabled","0") == "1")
               {
                  ...
                  _loc3_.initializeWidget(RoomWidgetEnum.const_335);
               }
               if(!_loc5_)
               {
               ...
               if(this.var_1464 != RoomDesktop.const_572)
               {
                  _loc3_.initializeWidget(RoomWidgetEnum.const_292,this.var_1464);
               }
               if(this.var_309 != null)
               {
               ...
               break;
            case RoomEngineEvent.const_752:
               this.disposeDesktop(_loc2_);
               break;
            case RoomEngineRoomColorEvent.const_607:
      ...
      public function processWidgetMessage(param1:int, param2:int, param3:RoomWidgetMessage) : void
      {
         ...
         var _loc5_:RoomDesktop = this.method_2(_loc4_) as RoomDesktop;
         if(_loc5_ == null)
         {
            return;
         }
      ...
      public function createDesktop(param1:IRoomSession) : IRoomDesktop
      {
         ...
         _loc3_.roomWidgetFactory = this.var_1038;
         _loc3_.sessionDataManager = this.var_384;
         _loc3_.roomSessionManager = this.var_15;
         _loc3_.friendList = this._friendList;
         _loc3_.avatarRenderManager = this.var_521;
         _loc3_.inventory = this._inventory;
         _loc3_.toolbar = this.var_178;
         _loc3_.navigator = this._navigator;
         _loc3_.avatarEditor = this.var_1919;
         _loc3_.catalog = this._catalog;
         _loc3_.adManager = this.var_309;
         _loc3_.localization = this._localization;
         _loc3_.habboHelp = this.var_1203;
         _loc3_.moderation = this.var_974;
         _loc3_.config = this._config;
         _loc3_.soundManager = this.var_564;
         _loc3_.habboTracking = this._habboTracking;
         _loc3_.userDefinedRoomEvents = this.var_1204;
         ...
         _loc3_.createWidget(RoomWidgetEnum.const_860);
         _loc3_.init();
      ...
      public function method_2(param1:String) : IRoomDesktop
      {
