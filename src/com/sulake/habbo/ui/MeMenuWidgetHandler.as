   ...
   public class MeMenuWidgetHandler implements IRoomWidgetHandler, IHabboAvatarEditorDataSaver, IAvatarImageListener
   {
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            ...
            {
               this._inventory.events.removeEventListener(HabboInventoryEffectsEvent.const_857,this.onAvatarEffectsChanged);
               this._inventory.events.removeEventListener(HabboInventoryHabboClubEvent.const_848,this.onHabboClubSubscriptionChanged);
            }
            if(this.var_178 != null)
            {
               this.var_178.events.removeEventListener(HabboToolbarEvent.const_65,this.onHabboToolbarEvent);
            ...
            {
               this._container.habboHelp.events.removeEventListener(HabboHelpTutorialEvent.const_462,this.onHelpTutorialEvent);
               this._container.habboHelp.events.removeEventListener(HabboHelpTutorialEvent.const_108,this.onHelpTutorialEvent);
            }
         ...
         if(this._inventory != null)
         {
            this._inventory.events.addEventListener(HabboInventoryEffectsEvent.const_857,this.onAvatarEffectsChanged);
            this._inventory.events.addEventListener(HabboInventoryHabboClubEvent.const_848,this.onHabboClubSubscriptionChanged);
         }
         ...
         if(this._container.habboHelp != null)
         {
            this._container.habboHelp.events.addEventListener(HabboHelpTutorialEvent.const_462,this.onHelpTutorialEvent);
            this._container.habboHelp.events.addEventListener(HabboHelpTutorialEvent.const_108,this.onHelpTutorialEvent);
         }
      ...
      private function setMeMenuToolbarIcon() : void
      {
         ...
         if(this._container.avatarRenderManager != null)
         {
            ...
            if(_loc2_ != this.var_1413)
            {
               ...
               this.var_1413 = _loc2_;
               this.var_1827 = _loc1_;
            }
            else
            {
               _loc1_ = this.var_1827;
            }
         }
         if(this.var_178 != null)
         {
            _loc5_ = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_997,HabboToolbarIconEnum.MEMENU);
            if(_loc1_ != null)
            {
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetWaveMessage.const_755);
         _loc1_.push(RoomWidgetDanceMessage.const_703);
         _loc1_.push(RoomWidgetGetEffectsMessage.const_888);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_654);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_770);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_862);
         _loc1_.push(RoomWidgetOpenInventoryMessage.const_653);
         _loc1_.push(RoomWidgetOpenCatalogMessage.const_339);
         _loc1_.push(RoomWidgetStopEffectMessage.const_776);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1520);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1170);
         _loc1_.push(RoomWidgetToolbarMessage.const_872);
         _loc1_.push(RoomWidgetToolbarMessage.const_674);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_387);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_1605);
         _loc1_.push(RoomWidgetSelectOutfitMessage.const_1099);
         _loc1_.push(RoomWidgetShowOwnRoomsMessage.const_702);
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_769);
         _loc1_.push(RoomWidgetGetSettingsMessage.const_806);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_1633);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_851);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_879);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_869);
         _loc1_.push(RoomWidgetClothingChangeMessage.const_360);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRequestWidgetMessage.const_769:
               ...
               break;
            case RoomWidgetWaveMessage.const_755:
            ...
            case RoomWidgetDanceMessage.const_703:
               ...
               break;
            case RoomWidgetGetEffectsMessage.const_888:
               if(this._inventory != null)
               {
            ...
            case RoomWidgetSelectEffectMessage.const_654:
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_770:
               if(this._inventory != null)
               {
               ...
               break;
            case RoomWidgetOpenCatalogMessage.const_339:
               _loc2_ = param1 as RoomWidgetOpenCatalogMessage;
               if(this._catalog != null && _loc2_.pageKey == RoomWidgetOpenCatalogMessage.const_1044)
               {
                  this._catalog.openCatalogPage(CatalogPageName.const_192,true);
               }
               break;
            case RoomWidgetOpenInventoryMessage.const_653:
               ...
               if(this._inventory != null)
               {
                  ...
                  switch(_loc3_.inventoryType)
                  {
                     ...
                     case RoomWidgetOpenInventoryMessage.const_1132:
                        ...
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1474:
                        this._inventory.toggleInventoryPage(InventoryCategory.const_81);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1578:
                        break;
                     default:
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_862:
            case RoomWidgetStopEffectMessage.const_776:
            ...
            case RoomWidgetNavigateToRoomMessage.const_1170:
               ...
               break;
            case RoomWidgetShowOwnRoomsMessage.const_702:
               if(this._container != null)
               {
                  this._container.navigator.showOwnRooms();
               }
               break;
            case RoomWidgetToolbarMessage.const_872:
               ...
               if(this.var_178)
               {
                  this.var_178.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_51,HabboToolbarIconEnum.MEMENU,_loc5_.window));
                  if(this._inventory != null)
                  {
                     _loc12_ = false;
            ...
            case RoomWidgetToolbarMessage.const_674:
               ...
               {
                  this.var_178.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_471,HabboToolbarIconEnum.MEMENU,_loc6_.window));
               }
               break;
            case RoomWidgetAvatarEditorMessage.const_387:
               ...
               break;
            case RoomWidgetGetSettingsMessage.const_806:
            ...
            case RoomWidgetStoreSettingsMessage.const_851:
               ...
               this._container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_367,this._container.soundManager.volume));
               break;
            case RoomWidgetStoreSettingsMessage.const_879:
            ...
            case RoomWidgetAvatarEditorMessage.const_869:
               ...
               break;
            case RoomWidgetClothingChangeMessage.const_360:
      ...
      private function onAvatarEditorClosed(param1:Event = null) : void
      {
         ...
         this._container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_606));
      }
      ...
      private function onHelpTutorialEvent(param1:HabboHelpTutorialEvent) : void
      {
         ...
         switch(param1.type)
         {
            case HabboHelpTutorialEvent.const_108:
               this._container.events.dispatchEvent(new RoomWidgetTutorialEvent(RoomWidgetTutorialEvent.const_108));
               break;
            case HabboHelpTutorialEvent.const_462:
               this._container.events.dispatchEvent(new RoomWidgetTutorialEvent(RoomWidgetTutorialEvent.const_558));
         }
      }
