package com.sulake.habbo.ui
{
   ...
   public class InfoStandWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = this.var_555.length - 1;
            while(_loc1_ >= 0)
            {
               _loc2_ = this.var_555.getWithIndex(_loc1_);
               if(_loc2_)
               {
                  _loc2_.dispose();
               }
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetRoomObjectMessage.const_355);
         ...
         _loc1_.push(RoomWidgetRoomTagSearchMessage.const_665);
         _loc1_.push(RoomWidgetGetBadgeDetailsMessage.const_650);
         _loc1_.push(RoomWidgetGetBadgeImageMessage.const_836);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_1638);
         _loc1_.push(RoomWidgetPetCommandMessage.const_534);
         ...
         _loc1_.push(RoomWidgetChangeMottoMessage.const_727);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc4_.type == RoomWidgetUserActionMessage.const_464)
            {
               _loc3_ = this._container.roomSession.userDataManager.getUserDataByIndex(_loc2_);
            }
            else if(param1.type == RoomWidgetUserActionMessage.const_383 || param1.type == RoomWidgetUserActionMessage.const_522 || param1.type == RoomWidgetUserActionMessage.const_555)
            {
         ...
         switch(param1.type)
         {
            case RoomWidgetRoomObjectMessage.const_355:
            ...
            case RoomWidgetUserActionMessage.const_671:
               _loc8_ = new RoomWidgetChatInputContentUpdateEvent(RoomWidgetChatInputContentUpdateEvent.const_1060,_loc3_.name);
            ...
            case RoomWidgetUserActionMessage.const_383:
               ...
               break;
            case RoomWidgetRoomTagSearchMessage.const_665:
               ...
               break;
            case RoomWidgetGetBadgeDetailsMessage.const_650:
               ...
               break;
            case RoomWidgetGetBadgeImageMessage.const_836:
      ...
      private function handleGetObjectInfoMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_27:
               ...
               _loc6_ = new RoomWidgetFurniInfoUpdateEvent(RoomWidgetFurniInfoUpdateEvent.const_683);
               _loc6_.id = param1.id;
               ...
               {
                  _loc24_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_369);
               ...
               _loc9_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_976);
               _loc10_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_1201);
            ...
            case RoomObjectCategoryEnum.OBJECT_CATEGORY_USER:
               ...
               if(_loc11_.type == RoomObjectTypeEnum.const_372)
               {
                  _loc12_ = "null";
               ...
               {
                  if(_loc11_.type != RoomObjectTypeEnum.const_1070)
                  {
                     return null;
                  }
                  _loc12_ = "null";
               ...
               if(_loc17_ != null)
               {
                  _loc13_.carryItem = _loc17_.getModel().getNumber(RoomObjectVariableEnum.const_485);
               }
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.const_168)
               {
               ...
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.const_252)
               {
                  ...
                  if(_loc17_ != null)
                  {
                     _loc32_ = _loc17_.getModel().getString(RoomObjectVariableEnum.const_612);
                  ...
                  _loc13_.method_1 = this._container.sessionDataManager.method_1;
                  ...
                  if(!_loc28_)
                  {
                     _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_974;
                  }
                  if(!_loc29_)
                  {
                     _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_1058;
                  }
               ...
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.BOT)
               {
                  ...
                  _loc14_.push(RoomWidgetUserInfoUpdateEvent.const_1507);
               }
               else
               {
      ...
      private function onPetInfo(param1:RoomSessionPetInfoUpdateEvent) : void
      {
         ...
         var _loc7_:BitmapData = this.var_555.getValue(_loc4_) as BitmapData;
         if(_loc7_ == null)
         {
            _loc7_ = this.getPetImage(_loc4_);
            this.var_555.add(_loc4_,_loc7_);
         }
         if(this._container != null && this._container.events != null)
         {
            ...
            if(_loc13_ != null)
            {
               ...
               if(_loc14_ != null)
               {
                  _loc15_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_612);
