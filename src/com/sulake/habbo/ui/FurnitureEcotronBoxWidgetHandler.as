package com.sulake.habbo.ui
{
   ...
   public class FurnitureEcotronBoxWidgetHandler implements IRoomWidgetHandler, IGetImageListener
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_614,RoomWidgetEcotronBoxOpenMessage.const_764,RoomWidgetEcotronBoxOpenedMessage.const_1502];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_614:
               ...
               break;
            case RoomWidgetEcotronBoxOpenMessage.const_764:
