package com.sulake.habbo.catalog.recycler
{
   ...
   public class RecyclerLogic implements IRecycler
   {
      ...
      private static const const_930:int = 0;
      
      private static const const_411:int = 1;
      
      private static const const_929:int = 2;
      ...
      {
         return this.var_600 != const_930;
      }
      
      private function get systemActive() : Boolean
      {
         return this.var_1726 != RecyclerStatusMessageEvent.const_1102;
      }
      
      private function get ready() : Boolean
      {
         return this.active && this.var_600 == const_411;
      }
      ...
      {
         this.var_600 = const_929;
         this.var_109 = new Array(const_191);
         if(param1 == null)
         {
            return;
         }
      ...
      public function setSystemStatus(param1:int, param2:int) : void
      {
         ...
         {
            case RecyclerStatusMessageEvent.const_1472:
               this.var_600 = const_411;
               if(this._view == null)
               {
                  return;
               ...
               this.updateRecyclerButton();
               break;
            case RecyclerStatusMessageEvent.const_1102:
               if(this._view == null)
               {
                  return;
               }
               ...
               this._catalog.setupInventoryForRecycler(false);
               break;
            case RecyclerStatusMessageEvent.const_1424:
               if(this._view == null)
               {
                  return;
               }
      ...
      public function setFinished(param1:int, param2:int) : void
      {
         ...
         switch(status)
         {
            case RecyclerFinishedMessageEvent.const_1030:
               ...
               break;
            case RecyclerFinishedMessageEvent.const_1503:
      ...
      private function isPoolFull() : Boolean
      {
         ...
         if(this.var_109.length < const_191)
         {
            return false;
         }
         var _loc1_:int = 0;
