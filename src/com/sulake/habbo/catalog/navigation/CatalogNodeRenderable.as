package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNodeRenderable extends CatalogNode
   {
      ...
      private static const const_1272:Number = 4285716709;
      
      private static var _listSubItemWindowLayout:XML;
      
      private static var var_1321:XML;
      
      private static var var_1322:XML;
       
      
      private var var_1648:Number = 4.294967295E9;
      ...
      override public function activate() : void
      {
         ...
         if(_loc1_ != null)
         {
            if(this.var_1648 == 4294967295)
            {
               this.var_1648 = _loc1_.color;
            }
            _loc1_.color = const_1272;
         }
      }
      ...
      override public function open() : void
      {
         ...
         if(isBranch)
         {
            ...
            if(_loc1_ != null)
            {
               _loc1_.style = HabboIconType.const_1512;
            }
         }
      }
      ...
      {
         this.var_57 = navigator.catalog.windowManager.buildFromXML(var_1322) as IItemListWindow;
         if(this.var_57 == null)
         {
      ...
      private function createWindow() : void
      {
         if(depth == 1)
         {
            this._window = navigator.catalog.windowManager.buildFromXML(var_1321) as IWindowContainer;
         }
         else
         {
