package com.sulake.habbo.catalog.purchase
{
   ...
   public class PurchaseConfirmationDialog implements IGetImageListener
   {
      ...
      private const const_1985:int = 10;
      ...
      private const const_1694:uint = 4.294967295E9;
      
      private const const_1984:uint = 4.291613146E9;
      ...
      private function showGiftDialog() : void
      {
         ...
         if(_loc1_.isEnabled)
         {
            ...
            this.var_1500 = _loc1_.stuffTypes;
            this.var_759 = _loc1_.boxTypes;
            this.var_758 = _loc1_.ribbonTypes;
            this.var_1163 = this.var_1500[0];
            this.var_357 = this.var_759[0];
            this.var_359 = this.var_758[0];
            this.initColorGrid();
      ...
      private function updatePreview() : void
      {
         ...
         if(this.var_359 < 0)
         {
            this.var_359 = this.var_758.length - 1;
         }
         if(this.var_359 > this.var_758.length - 1)
         {
            this.var_359 = 0;
         }
         if(this.var_357 < 0)
         {
            this.var_357 = this.var_759.length - 1;
         }
         if(this.var_357 > this.var_759.length - 1)
         {
            this.var_357 = 0;
         }
         var _loc1_:int = this.var_759[this.var_357] * 1000 + this.var_758[this.var_359];
         if(this._window == null)
         {
            return;
         }
         var _loc2_:IRoomEngine = this.var_90.page.viewer.roomEngine;
         _loc3_ = _loc2_.getFurnitureImage(this.var_1163,new Vector3d(180),64,this,0,_loc1_.toString());
         if(_loc3_ == null)
         {
            return;
         }
      ...
      private function initColorGrid() : void
      {
         ...
         var _loc3_:Array = this.var_1500;
      ...
      private function giveGift() : void
      {
         ...
         var _loc7_:int = !!_loc6_ ? 0 : int(this.var_1163);
         var _loc8_:int = !!_loc6_ ? 0 : int(this.var_759[this.var_357]);
         var _loc9_:int = !!_loc6_ ? 0 : int(this.var_758[this.var_359]);
         this._catalog.purchaseProductAsGift(this._pageId,this.var_90,this.var_1423,_loc2_,_loc4_,_loc7_,_loc8_,_loc9_);
      }
      ...
      private function confirmationHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "gift_button":
               ...
               break;
            case "buy_button":
               this._catalog.purchaseProduct(this._pageId,this.var_90.offerId,this.var_1423);
               this.dispose();
               break;
            case "cancel_button":
      ...
      private function nameInputHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            case WindowEvent.const_100:
               ...
               if(this.var_2608 == _loc3_.text)
               {
                  return;
               }
               _loc4_ = _loc3_.text.toLowerCase();
               _loc5_ = [];
               for each(_loc7_ in this.var_204)
               {
                  if(_loc7_.toLowerCase().search(_loc4_) != -1)
                  {
                     _loc5_.push(_loc7_);
                  }
                  if(_loc5_.length >= this.const_1985)
                  {
                     break;
                  }
               }
               this.updateSuggestions(_loc5_);
               this.var_2608 = _loc3_.text;
               break;
            case WindowMouseEvent.const_41:
               ...
               break;
            case WindowKeyboardEvent.const_354:
      ...
      {
         if(this.var_253 == null || !this.var_253.visible)
         {
            return;
         }
         var _loc1_:IItemListWindow = this.var_253.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc1_ == null)
         {
            return;
         }
      ...
      private function updateSuggestions(param1:Array) : void
      {
         ...
         if(this.var_253 == null)
         {
            this.var_253 = this._window.findChildByName("suggestion_container") as IWindowContainer;
         }
         if(this.var_620 == null)
         {
            this.var_620 = this.createWindow("suggestion_list_item") as IWindowContainer;
            this.var_620.procedure = this.suggestionsEventHandler;
         }
         if(this.var_253 == null || this.var_620 == null)
         {
            return;
         }
         var _loc2_:IItemListWindow = this.var_253.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc2_ == null)
         {
            return;
         }
         ...
         {
            _loc5_ = this.var_620.clone() as IWindowContainer;
            if(_loc5_ != null)
            {
      ...
      private function highlightSuggestion(param1:int) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.color = this.const_1984;
         }
      }
      
      private function getColor(param1:int) : uint
      {
         return param1 % 2 == 0 ? uint(this.const_1695) : uint(this.const_1694);
      }
      ...
      private function suggestionsEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER:
               _loc5_ = this.var_253.findChildByName("suggestion_list") as IItemListWindow;
               if(_loc5_ == null)
               {
                  return;
               }
      ...
      private function updateColorGrid() : void
      {
         ...
         while(_loc4_ < _loc1_.numGridItems)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc3_.visible = _loc2_.id == this.var_1163;
               }
            }
            _loc4_++;
         }
