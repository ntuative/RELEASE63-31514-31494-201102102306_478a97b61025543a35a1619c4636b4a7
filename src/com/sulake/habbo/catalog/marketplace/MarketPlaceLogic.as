package com.sulake.habbo.catalog.marketplace
{
   ...
   public class MarketPlaceLogic implements IMarketPlace
   {
      ...
      private var var_206:MarketplaceConfirmationDialog;
      ...
      private var var_2004:MarketplaceItemStats;
      ...
      private function showConfirmation(param1:int, param2:MarketPlaceOfferData) : void
      {
         if(!this.var_206)
         {
            this.var_206 = new MarketplaceConfirmationDialog(this,this._catalog,this._roomEngine);
         }
         this.var_206.showConfirmation(param1,param2);
      }
      ...
      {
         this.requestOffers(this.var_2000,this.var_1998,this.var_1999,this.var_2001);
      }
      ...
      public function buyOffer(param1:int) : void
      {
         ...
         this.showConfirmation(this.const_1805,_loc2_);
      }
      ...
      public function onOwnOffers(param1:IMessageEvent) : void
      {
         ...
         this.var_2003 = _loc3_.creditsWaiting;
      ...
      {
         if(param1.furniCategoryId != this.var_2002 || param1.furniTypeId != this.var_1997)
         {
            return;
         }
