package com.sulake.habbo.catalog
{
   ...
   public class HabboCatalog extends Component implements IHabboCatalog, IProductDataListener
   {
      ...
      private var var_277:CatalogViewer;
      
      private var var_327:ICatalogNavigator;
      ...
      private var var_206:PurchaseConfirmationDialog;
      ...
      private var var_2158:GiftWrappingConfiguration;
      
      private var var_1049:ClubGiftController;
      ...
      {
         var _loc4_:* = null;
         if(param1.priceInCredits > 0 && param1.priceInCredits > this.var_95.credits)
         {
            this.showNotEnoughCreditsAlert();
            return;
         }
         if(param1.priceInActivityPoints > 0 && param1.priceInActivityPoints > this.var_95.getActivityPointsForType(param1.activityPointType))
         {
         ...
         if(param1 is Offer)
         {
            if(this.var_206 == null)
            {
               this.var_206 = new PurchaseConfirmationDialog(this._localization);
            }
            _loc4_ = [];
            ...
            this.var_206.showOffer(this,param1,param2,param3,_loc4_);
      ...
      public function openCatalogPageById(param1:int, param2:int) : void
      {
         ...
         {
            this.toggleCatalog(true);
            this.var_327.openPageById(param1,param2);
         }
         else
         {
            this.toggleCatalog();
      ...
      public function openCreditsHabblet() : void
      {
         ...
         var _loc1_:* = this.var_176.getKey("client.credits.embed.enabled","false") == "HabboFriendListCom_opened_to_web_popup_xml";
         if(false && _loc1_)
         {
      ...
      {
         return this.var_384.getProductData(param1);
      }
      ...
      public function getFurnitureData(param1:int, param2:String) : IFurnitureData
      {
         ...
         {
            _loc3_ = this.var_384.getFloorItemData(param1);
         }
         if(param2 == ProductTypeEnum.const_82)
         {
            _loc3_ = this.var_384.getWallItemData(param1);
         }
         return _loc3_;
      }
      ...
      {
         var _loc2_:Array = this.var_677.getValue(param1);
         if(_loc2_ != null)
         {
            return _loc2_.slice();
         }
      ...
      private function updatePurse() : void
      {
         ...
         this._localization.registerParameter("catalog.purse.pixelbalance","balance",String(this.var_95.getActivityPointsForType(Purse.const_188)));
         var _loc1_:int = 0;
      ...
      {
         this.var_178.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_118,HabboToolbarIconEnum.CATALOGUE));
      }
      ...
      private function toggleCatalog(param1:Boolean = false) : void
      {
         ...
         if(!this.var_735)
         {
            if(!this.var_384.loadProductData(this))
            {
               return;
            }
            this.init();
         ...
         {
            this.var_178.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_51,HabboToolbarIconEnum.CATALOGUE,this._mainContainer));
         }
         if(this._mainContainer.visible)
         {
            events.dispatchEvent(new Event(HabboCatalogTrackingEvent.HABBO_CATALOG_TRACKING_EVENT_OPEN));
            if(this.var_88 != null && this.getCurrentLayoutCode() == "recycler")
            {
               this.var_88.activate();
            }
         }
         else
         {
         ...
         this.setupInventoryForRecycler(this.var_88.active && this._mainContainer.visible);
      }
      ...
      private function getCurrentLayoutCode() : String
      {
         ...
         return this.var_277.getCurrentLayoutCode();
      }
      ...
      private function createCatalogNavigator() : void
      {
         ...
         this.var_327 = new CatalogNavigator(this,_loc1_) as ICatalogNavigator;
      ...
      private function createCatalogViewer() : void
      {
         ...
         this.var_277 = new CatalogViewer(this,_loc1_,this._roomEngine);
         this.var_277.habboCatalog = this;
      }
      ...
      private function createMainWindow() : void
      {
         ...
         _loc3_.setParamFlag(WindowParam.const_251,false);
      ...
      private function onRoomSessionEvent(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            case RoomSessionEvent.const_86:
               this.var_1576 = param1.session.isPrivateRoom;
               if(this.var_88 != null)
               {
                  this.var_88.setRoomSessionActive(true);
               }
               break;
            case RoomSessionEvent.const_94:
               ...
               if(this.var_88 != null)
               {
                  this.var_88.setRoomSessionActive(false);
               }
         }
      }
      ...
      {
         this.var_88 = new RecyclerLogic(this,this._windowManager);
      ...
      private function createClubGiftController() : void
      {
         ...
         {
            this.var_1049 = new ClubGiftController(this);
         }
      }
      ...
      private function onCatalogIndex(param1:IMessageEvent) : void
      {
         ...
         this.var_327.buildCatalogIndex(_loc2_);
         if(this.var_678 && this.var_678 != "")
         {
            this.var_327.openPage(this.var_678);
            this.var_678 = "";
            this.var_832 = -1;
         }
         else if(this.var_832 > -1)
         {
            this.var_327.openPageById(this.var_832,this.var_1577);
            this.var_832 = -1;
            this.var_1577 = -1;
            this.var_678 = "";
         }
      ...
      private function onCatalogPage(param1:IMessageEvent) : void
      {
         ...
         this.var_277.showCatalogPage(_loc4_,_loc5_,_loc8_,_loc3_.offers,_loc9_);
      }
      ...
      {
         if(param1 == null || this.var_277 == null)
         {
            return;
         }
         var _loc2_:ApproveNameMessageParser = param1.getParser();
         this.var_277.dispatchWidgetEvent(new CatalogWidgetApproveNameResultEvent(_loc2_.result));
      }
      ...
      private function onCreditBalance(param1:IMessageEvent) : void
      {
         ...
         this.updatePurse();
         if(!this.var_2159 && this.var_564 != null)
         {
            this.var_564.playSound(HabboSoundTypesEnum.const_994);
         }
         this.var_2159 = false;
         if(this.var_278 != null)
         {
         ...
         events.dispatchEvent(new PurseEvent(PurseEvent.const_72,this.var_95.credits));
      }
      ...
      private function onActivityPointNotification(param1:IMessageEvent) : void
      {
         ...
         this.var_95.activityPoints[_loc2_.type] = _loc2_.amount;
         this.updatePurse();
         if(!this.var_2160 && this.var_564 != null)
         {
            this.var_564.playSound(HabboSoundTypesEnum.const_1087);
         }
         this.var_2160 = false;
         if(this.var_278 != null)
         {
      ...
      private function onActivityPoints(param1:IMessageEvent) : void
      {
         ...
         this.var_95.activityPoints = _loc2_.points;
         this.updatePurse();
      ...
      private function onClubGiftInfo(param1:ClubGiftInfoEvent) : void
      {
         ...
         this.var_1049.setInfo(_loc2_.daysUntilNextGift,_loc2_.giftsAvailable,_loc2_.offers,_loc2_.giftData);
      }
      ...
      private function onRecyclerStatus(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_ == null || this.var_88 == null)
         {
            return;
         }
         this.var_88.setSystemStatus(_loc2_.recyclerStatus,_loc2_.recyclerTimeoutSeconds);
      }
      ...
      private function onRecyclerFinished(param1:IMessageEvent) : void
      {
         ...
         this.var_88.setFinished(_loc2_.recyclerFinishedStatus,_loc2_.prizeId);
      }
      ...
      private function onRecyclerPrizes(param1:IMessageEvent) : void
      {
         ...
         this.var_88.storePrizeTable(_loc2_.prizeLevels);
      }
      ...
      private function onRentableBotDefinitions(param1:IMessageEvent) : void
      {
         ...
         this.var_277.dispatchWidgetEvent(new RentableBotDefinitionWidgetEvent(_loc2_.rentableBots));
      }
      ...
      private function onGiftWrappingConfiguration(param1:GiftWrappingConfigurationEvent) : void
      {
         ...
         this.var_2158 = new GiftWrappingConfiguration(param1);
      }
      ...
      private function onIsOfferGiftable(param1:IsOfferGiftableMessageEvent) : void
      {
         ...
         if(this.var_206 != null)
         {
            this.var_206.onIsOfferGiftable(param1.getParser());
         }
      }
      ...
      private function onSellableBreeds(param1:SellablePetBreedsMessageEvent) : void
      {
         ...
         this.var_677.remove(_loc2_.petType);
         var _loc3_:Array = _loc2_.sellableBreeds;
         if(_loc3_ != null)
         {
            this.var_677.add(_loc2_.petType,_loc3_.slice());
            this.var_277.dispatchWidgetEvent(new CatalogWidgetSellablePetBreedsEvent(_loc2_.petType,_loc3_.slice()));
         }
      }
      ...
      private function noCreditsConfirmDialogEventProcessor(param1:IConfirmDialog, param2:Event) : void
      {
         ...
         {
            if(false && "HabboFriendListCom_opened_to_web_popup_xml" == this.var_176.getKey("client.credits.embed.enabled"))
            {
               ExternalInterface.call("FlashExternalInterface.openHabblet","credits");
            }
            else
