package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class NewPetsCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private static const const_1321:int = 18;
      ...
      private var var_224:Array = null;
      ...
      override public function init() : Boolean
      {
         ...
         this.var_426 = this.getPetTypeIndexFromProduct(_loc2_.localizationId);
         if(this.var_426 < 8)
         {
            return false;
         }
         this.updateAvailableBreeds(this.var_426);
         if(this.var_224 != null && this.var_224.length > 0)
         {
            this.var_362 = this.var_224[0];
         }
         else
         {
            this.var_362 = -1;
         }
         this._offers.add(this.var_426,_loc2_);
      ...
      private function initializeBreedSelection() : void
      {
         ...
         if(this.var_224 != null)
         {
            _loc1_ = [];
            _loc2_ = 0;
            while(_loc2_ < const_1321 && _loc2_ < this.var_224.length)
            {
               _loc3_ = (page.viewer.catalog as HabboCatalog).roomEngine.getPetColor(this.var_426,this.var_224[_loc2_]);
               if(_loc3_ != null)
               {
      ...
      private function selectedBreed(param1:int) : void
      {
         if(this.var_224 != null && this.var_224.length > 0)
         {
            ...
            this.var_362 = this.var_224[param1];
            this.updateImage();
         }
      }
      ...
      private function getPetLocalization() : String
      {
         ...
         if(page != null && false)
         {
            ...
            {
               return _loc1_.localization.getKey(this.getRaceLocalizationKey(this.var_426,this.var_362),this.getRaceLocalizationKey(this.var_426,this.var_362));
            }
         }
         return this.getRaceLocalizationKey(this.var_426,this.var_362);
      }
      ...
      {
         if(param1.petType == this.var_426)
         {
            this.var_224 = param1.sellableBreeds;
            this.initializeBreedSelection();
      ...
      private function getPurchaseParameters() : String
      {
         ...
         var p:String = this._name + String.fromCharCode(10) + String(this.var_362) + String.fromCharCode(10) + this.addZeroPadding(color.toString(16).toUpperCase(),6);
         return p;
      }
      ...
      private function updateAvailableBreeds(param1:int) : void
      {
         if(this.var_224 == null)
         {
            this.var_224 = (page.viewer.catalog as HabboCatalog).getSellablePetBreeds(param1);
         }
      }
