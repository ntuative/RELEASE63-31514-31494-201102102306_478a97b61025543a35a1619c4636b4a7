package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1796:Point;
      
      private var var_500:IItemGridWindow;
      
      private var var_1397:IScrollbarWindow;
      ...
      override public function init() : Boolean
      {
         ...
         this.var_924 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         this.var_1143 = _window.findChildByName("ctlg_description") as ITextWindow;
         this.var_83 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         this.var_1796 = new Point(this.var_83.x,this.var_83.y);
         this.var_500 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         this.var_1397 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
         ...
         this.var_1795 = _loc2_.content as BitmapData;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         this.var_924.text = _loc4_;
         this.var_1143.text = _loc5_;
         this.var_924.height = this.var_924.textHeight + 5;
         this.var_1143.y = this.var_924.y + this.var_924.height;
         this.var_1143.height = Math.max(130,this.var_1143.textHeight + 5);
         ...
         else
         {
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_474:
                  _loc6_ = this.var_1795.clone();
                  if(this.var_500 != null)
                  {
                     this.var_500.visible = true;
                     _loc10_ = _loc2_.productContainer as BundleProductContainer;
                     _loc10_.populateItemGrid(this.var_500,this.var_1397,this.var_1896);
                     ...
                     case ProductTypeEnum.const_261:
                        ...
                        if(_loc15_.avatarRenderManager != null)
                        {
                           ...
                           if(_loc16_ != null)
                           {
                              ...
                              _loc16_.appendAction(AvatarAction.const_309,AvatarAction.const_565);
      ...
      {
         var _loc1_:* = null;
         for each(_loc1_ in this.var_2565)
         {
      ...
      private function setPreviewImage(param1:BitmapData, param2:Boolean, param3:Point = null) : void
      {
         ...
         if(this.var_83 != null && true)
         {
            ...
            this.var_83.x = this.var_1796.x;
            this.var_83.y = this.var_1796.y;
            if(param3 != null)
            {
