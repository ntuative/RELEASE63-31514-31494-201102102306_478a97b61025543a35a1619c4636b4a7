package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class MarketPlaceCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener, IMarketPlaceVisualization
   {
      ...
      private const const_1947:int = 40;
      
      private const const_1946:int = 10;
      
      private var var_676:Array;
      
      private var var_1290:MarketPlaceOfferData;
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_463)
         {
            this.var_463.removeEventListener(TimerEvent.TIMER,this.onPopulationTimer);
            this.var_463 = null;
         }
      }
      ...
      private function updateList() : void
      {
         ...
         if(!this.var_561)
         {
            ...
            this.var_561 = _loc4_.buildFromXML(_loc3_) as IWindowContainer;
         }
         if(!this.var_561)
         {
            return;
         ...
         this.updateStatusDisplay(this.const_1668,_loc2_.length);
         if(!this.var_463)
         {
            this.var_463 = new Timer(25);
            this.var_463.addEventListener(TimerEvent.TIMER,this.onPopulationTimer);
         }
         this.var_1047 = 0;
         this.populateList();
         this.var_463.start();
      ...
      private function populateList() : Boolean
      {
         ...
         while(_loc1_ < 5)
         {
            if(this.var_1047 >= this._offers.length)
            {
               return true;
            }
            this.addListItem(this._offers.getWithIndex(this.var_1047));
            ++this.var_1047;
            _loc1_++;
         }
         return false;
      ...
      private function addListItem(param1:MarketPlaceOfferData) : void
      {
         ...
         var _loc10_:* = null;
         var _loc11_:* = null;
         if(!param1 || !this._itemList || !this.var_561 || !this.marketPlace.localization)
         {
            return;
         }
         var _loc2_:IWindowContainer = this.var_561.clone() as IWindowContainer;
      ...
      {
         var _loc5_:* = null;
         this.updateStatusDisplay(this.const_1667);
         var _loc1_:int = -1;
         var _loc2_:int = -1;
         var _loc3_:String = "";
         var _loc4_:int = 1;
         ...
         else if(param1.type == WindowEvent.const_100)
         {
            ...
            switch(_loc7_.name)
            {
               ...
               case "max_price_input":
                  _loc8_ = this.const_1946;
                  break;
               case "search_input":
                  _loc8_ = this.const_1947;
                  break;
               default:
                  return;
            }
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "back_button":
                  ...
                  break;
               case "buy_button":
                  this.marketPlace.buyOffer(this.var_1290.offerId);
            }
            return;
         }
         if(param1.type == WindowEvent.const_59)
