package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RedeemItemCodeCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private var var_886:ITextFieldWindow;
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_887.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onRedeem);
            this.var_887 = null;
         }
         if(this.var_886 != null)
         {
            this.var_886.removeEventListener(WindowKeyboardEvent.const_177,this.windowKeyEventProcessor);
            this.var_886 = null;
         }
      }
      ...
      override public function init() : Boolean
      {
         ...
         this.var_887 = _window.findChildByName("redeem") as IButtonWindow;
         if(this.var_887 != null)
         {
            this.var_887.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onRedeem);
         }
         this.var_886 = _window.findChildByName("voucher_code") as ITextFieldWindow;
         if(this.var_886 != null)
         {
            this.var_886.addEventListener(WindowKeyboardEvent.const_177,this.windowKeyEventProcessor);
         }
         return true;
      }
