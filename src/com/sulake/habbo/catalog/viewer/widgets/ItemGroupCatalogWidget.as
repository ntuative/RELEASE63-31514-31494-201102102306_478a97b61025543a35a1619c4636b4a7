package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ItemGroupCatalogWidget extends ItemGridCatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      {
         var _loc2_:Offer = this.var_566[this.var_1050][this.var_1581];
      ...
      override public function select(param1:IGridItem) : void
      {
         ...
         super.select(param1);
         this.var_1050 = var_985.getGridItemIndex(param1.view);
         var _loc2_:String = this._groupNames[this.var_1050];
         var _loc3_:Array = this.var_566[this.var_1050] as Array;
      ...
      override protected function populateItemGrid() : void
      {
         ...
         {
            if(this.var_1581 < _loc1_.length)
            {
               _loc2_ = _loc1_[this.var_1581] as Offer;
      ...
      private function createOfferGroups() : void
      {
         ...
         {
            if(_loc1_.pricingModel == Offer.const_511 || _loc1_.pricingModel == Offer.const_513)
            {
                  ...
                  if(_loc3_.productType == ProductTypeEnum.const_82 || _loc3_.productType == ProductTypeEnum.const_90)
                  {
                     if(_loc3_.furnitureData != null)
                     {
                        ...
                        if(this._groupNames.indexOf(_loc5_) == -1)
                        {
                           ...
                           this.var_566.push(new Array());
                        }
                        _loc6_ = this._groupNames.indexOf(_loc5_);
                        (this.var_566[_loc6_] as Array).push(_loc1_);
                     }
                  }
               }
            }
