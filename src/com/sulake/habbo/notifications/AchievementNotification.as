package com.sulake.habbo.notifications
{
   ...
   public class AchievementNotification
   {
      ...
      private const const_1945:String = "achievement_bg_001_png";
      ...
      public function AchievementNotification(param1:String, param2:int, param3:int, param4:int, param5:int, param6:int, param7:int, param8:IAssetLibrary, param9:IHabboWindowManager, param10:IHabboLocalizationManager, param11:IHabboConfigurationManager, param12:IHabboCommunicationManager, param13:ISessionDataManager)
      {
         ...
         this.var_1284 = param7;
         this.var_1992 = param5;
         this.var_1558 = param6;
         this._localizations = param10;
         this._assets = param8;
         this.var_384 = param13;
         ...
         this._window.center();
         this.var_2135 = this._localizations.getBadgeName(this.var_274);
         this.var_2131 = this._localizations.getBadgeDesc(this.var_274);
         this.var_2134 = this._localizations.getAchievementNameForFacebook(this.var_274,this.var_384.userName,this.var_384.realName,this.var_1285);
         this.var_2133 = this._localizations.getAchievementDescForFacebook(this.var_274,this.var_384.userName,this.var_384.realName,this.var_1285);
         this._desc = this.registerTextParameters("notifications.text.achievement");
         this.var_2132 = this.registerTextParameters("notifications.text.achievement_facebook");
         this._feedTitleFb = this.registerTextParameters("notifications.text.achievement_facebook_title");
         this._localizations.registerParameter("notifications.text.achievement.achievement_points","achievement_points",this.var_1601.toString());
         this._localizations.registerParameter("notifications.achievement.bonus.value","bonus_points",this.var_1284.toString());
         this._localizations.registerParameter("notifications.achievement.no_facebook","bonus_points",this.var_1284.toString());
         var _loc15_:IWindow = this._window.findChildByName("level_reward_points");
         var _loc16_:String = "notifications.text.achievement.reward." + this.var_1558;
         var _loc17_:String = this.var_1558 == 0 ? "pixels" : "activitypoints";
         this._localizations.registerParameter(_loc16_,_loc17_,"" + this.var_1992);
         _loc15_.caption = this._localizations.getKey(_loc16_);
         this.setBadge(param13.getBadgeImage(param1),this.const_1664);
         var _loc18_:BitmapData = (param8.getAssetByName(this.const_1945) as BitmapDataAsset).content as BitmapData;
      ...
      {
         this._localizations.registerParameter(param1,"badge_name",this.var_2135);
         this._localizations.registerParameter(param1,"badge_desc",this.var_2131);
         this._localizations.registerParameter(param1,"badge_name_fb",this.var_2134);
         this._localizations.registerParameter(param1,"badge_desc_fb",this.var_2133);
         this._localizations.registerParameter(param1,"level",this.var_1285.toString());
         this._localizations.registerParameter(param1,"name",this.var_384.userName);
         return this._localizations.registerParameter(param1,"realname",this.var_384.realName);
      }
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_384.events.removeEventListener(BadgeImageReadyEvent.const_146,this.onBadgeImageReady);
            this.var_384 = null;
         }
         if(this._window != null)
         {
      ...
      {
         HabboWebTools.facebookAchievementPost(this.var_274,this._feedTitleFb,this.var_2132,param1);
      }
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "post_to_facebook":
               _loc3_.send(new GetAchievementShareIdComposer(this.var_2130));
