package com.sulake.habbo.help.help
{
   ...
   public class HelpUI
   {
      ...
      {
         this.var_330 = this._defaultViewId;
         ...
         this._windowManager.registerLocalizationParameter("info.client.version","version",new String(201102102301));
         this.var_178 = param5;
         this.var_104 = new Map();
         this.var_104.add(HabboHelpViewEnum.const_1635,IHelpViewController(new PlaceholderView(this,this._windowManager,this._assetLibrary)));
         this.var_104.add(HabboHelpViewEnum.const_185,IHelpViewController(new HelpMainView(this,this._windowManager,this._assetLibrary)));
         this.var_104.add(HabboHelpViewEnum.const_450,IHelpViewController(new FaqBrowseTopView(this,this._windowManager,this._assetLibrary)));
         this.var_104.add(HabboHelpViewEnum.const_286,IHelpViewController(new FaqBrowseCategoryView(this,this._windowManager,this._assetLibrary)));
         this.var_104.add(HabboHelpViewEnum.const_215,IHelpViewController(new FaqBrowseEntry(this,this._windowManager,this._assetLibrary)));
         this.var_104.add(HabboHelpViewEnum.const_390,IHelpViewController(new CallForHelpTopicSelection(this,this._windowManager,this._assetLibrary)));
         this.var_104.add(HabboHelpViewEnum.const_772,IHelpViewController(new CallForHelpTextInput(this,this._windowManager,this._assetLibrary)));
         this.var_104.add(HabboHelpViewEnum.const_230,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_thanks")));
         this.var_104.add(HabboHelpViewEnum.const_985,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_abusive")));
         this.var_104.add(HabboHelpViewEnum.const_1187,IHelpViewController(new CallForHelpPendingItemView(this,this._windowManager,this._assetLibrary)));
         this.var_104.add(HabboHelpViewEnum.const_839,IHelpViewController(new CallForHelpReportUserSelection(this,this._windowManager,this._assetLibrary)));
      }
      ...
      public function showUI(param1:String = null, param2:Boolean = true) : void
      {
         ...
         {
            if(this.var_467.length == 0 || param1 != this.var_330)
            {
               this.var_467.push(this.var_330);
            }
         }
         this.var_330 = param1;
         ...
         if(_loc4_ == null)
         {
            Logger.log("* No view controller found for " + this.var_330);
            return;
         }
         ...
         if(_loc3_)
         {
            ...
            {
               this.var_178.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_51,HabboToolbarIconEnum.HELP,this._window));
            }
         }
      ...
      public function showCallForHelpResult(param1:String) : void
      {
         switch(param1)
         {
            case CallForHelpResultEnum.const_230:
               ...
               break;
            case CallForHelpResultEnum.const_1050:
               this.showUI(HabboHelpViewEnum.const_1187);
               break;
            case CallForHelpResultEnum.const_1048:
               this.showUI(HabboHelpViewEnum.const_985);
         }
      }
      ...
      public function updateCallForGuideBotUI(param1:Boolean) : void
      {
         ...
         var _loc2_:IHelpViewController = this.var_104.getValue(HabboHelpViewEnum.const_185) as IHelpViewController;
      ...
      public function handleCallGuideBot() : void
      {
         ...
         this.hideUI();
         this._component.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_486));
      }
      ...
      {
         return this.var_104.getValue(this.var_330);
      }
      ...
      private function createWindow() : void
      {
         ...
         this.var_2191 = this._window.width - _loc4_.width;
      ...
      public function updateWindowDimensions() : void
      {
         ...
         this._window.height = _loc1_.height + this.var_2192;
         this._window.width = _loc1_.width + this.var_2191;
      }
      ...
      {
         var _loc3_:* = null;
         if(this.var_330 == HabboHelpViewEnum.const_185)
         {
            return;
         }
         ...
         var _loc2_:IBitmapWrapperWindow = this.var_331.findChildByName("back_image") as IBitmapWrapperWindow;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function addBackButtonWindow() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         if(this.var_330 == HabboHelpViewEnum.const_185 || this.var_467.length == 0)
         {
            return;
         }
         if(this.var_331 == null)
         {
            ...
            this.var_331 = _loc2_.buildFromXML(XML(_loc3_.content)) as IWindowContainer;
            _loc4_ = this.var_331.findChildByName("back_image");
            if(_loc4_ != null)
            {
            ...
            _loc5_ = this.var_331.findChildByName("back_text");
            if(_loc5_ != null)
            {
         ...
         var _loc1_:IItemListWindow = this._window.findChildByName("content_list") as IItemListWindow;
         if(_loc1_ == null || this.var_331 == null)
         {
            return;
         }
         if(_loc1_.getListItemIndex(this.var_331 as IWindow) > -1)
         {
            return;
         }
         _loc1_.addListItem(this.var_331 as IWindow);
         this.setBackButtonActiveState(false);
      }
   }
}
