package com.sulake.habbo.help.help.data
{
   ...
   public class FaqIndex
   {
      ...
      public function FaqIndex()
      {
         ...
         this.var_692 = new FaqCategory(-9999,"${help.faq.title.normal}");
         this.var_694 = new FaqCategory(-99999,"${help.faq.title.searchresults}");
      ...
      public function storeAnswerText(param1:int, param2:String) : void
      {
         ...
         if(this.var_692.hasItem(param1))
         {
            this.var_692.getItem(param1).answerText = param2;
         }
      ...
      private function findItem(param1:int) : FaqItem
      {
         ...
         if(this.var_692.hasItem(param1))
         {
            return this.var_692.getItem(param1);
         }
         if(this.var_694.hasItem(param1))
         {
