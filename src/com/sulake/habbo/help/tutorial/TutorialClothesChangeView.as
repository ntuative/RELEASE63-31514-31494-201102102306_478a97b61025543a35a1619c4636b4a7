package com.sulake.habbo.help.tutorial
{
   ...
   public class TutorialClothesChangeView implements ITutorialUIView
   {
      ...
      public function TutorialClothesChangeView(param1:IItemListWindow, param2:TutorialUI)
      {
         ...
         this.var_33.help.toolbar.events.addEventListener(HabboToolbarShowMenuEvent.const_51,this.onShowMenuEvent);
      ...
      {
         return TutorialUI.const_384;
      }
      
      public function dispose() : void
      {
         this.setToolbarIconHighlight(false);
         this.var_33.help.toolbar.events.removeEventListener(HabboToolbarShowMenuEvent.const_51,this.onShowMenuEvent);
      }
      ...
      private function onShowMenuEvent(param1:HabboToolbarShowMenuEvent) : void
      {
         if(param1.menuId == HabboToolbarIconEnum.MEMENU && param1.type == HabboToolbarShowMenuEvent.const_51)
         {
            ...
            this.var_33.help.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_462));
         }
      }
      ...
      private function showToolbarIconHighlightArrow() : void
      {
         ...
         this.var_723 = this.var_33.buildXmlWindow("tutorial_arrow") as IWindowContainer;
         var _loc1_:IBitmapWrapperWindow = this.var_723.findChildByName("arrow") as IBitmapWrapperWindow;
         if(_loc1_ != null)
         {
         ...
         this.var_33.help.toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_51,HabboToolbarIconEnum.MEMENU_ARROW,this.var_723));
      }
