package com.sulake.habbo.sound
{
   ...
   public class PlayListController implements IDisposable
   {
      ...
      public function PlayListController(param1:HabboSoundManagerFlash10, param2:IEventDispatcher, param3:IEventDispatcher, param4:IConnection)
      {
         ...
         this._events.addEventListener(SoundCompleteEvent.const_630,this.onSongFinishedPlayingEvent);
         this.var_87.addEventListener(RoomObjectSoundMachineStateUpdateEvent.const_885,this.onSoundMachinePlayEvent);
         this.var_87.addEventListener(RoomObjectSoundMachineStateUpdateEvent.const_798,this.onSoundMachineStopEvent);
         this.var_87.addEventListener(RoomObjectSoundMachineStateUpdateEvent.const_688,this.onJukeboxInitEvent);
         this.var_87.addEventListener(RoomObjectSoundMachineStateUpdateEvent.const_526,this.onDisposeEvent);
      }
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this._events)
            {
               this._events.removeEventListener(SoundCompleteEvent.const_630,this.onSongFinishedPlayingEvent);
               this._events = null;
            }
            if(this.var_87)
            {
               this.var_87.removeEventListener(RoomObjectSoundMachineStateUpdateEvent.const_885,this.onSoundMachinePlayEvent);
               this.var_87.removeEventListener(RoomObjectSoundMachineStateUpdateEvent.const_798,this.onSoundMachineStopEvent);
               this.var_87.removeEventListener(RoomObjectSoundMachineStateUpdateEvent.const_688,this.onJukeboxInitEvent);
               this.var_87.removeEventListener(RoomObjectSoundMachineStateUpdateEvent.const_526,this.onDisposeEvent);
               this.var_87 = null;
            }
            if(this.var_412)
            {
      ...
      {
         var _loc1_:IHabboSound = this.var_412[this.var_286] as IHabboSound;
         if(_loc1_ != null)
         {
            _loc1_.stop();
         }
      ...
      {
         var _loc2_:IHabboSound = this.var_412.getValue(this.var_286) as IHabboSound;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function playSong(param1:int) : void
      {
         var _loc6_:* = null;
         this.var_286 = param1;
         var _loc2_:IHabboSound = this.var_412.getValue(param1) as IHabboSound;
         if(_loc2_ == null)
         {
         ...
         {
            _loc6_ = this.var_412[_loc5_.id] as IHabboSound;
            if(_loc6_ == null)
            {
      ...
      {
         if(this.var_1750 == this.const_1691)
         {
            this.var_77.shift();
         }
         var _loc2_:PlayListEntry = this.getNextEntry();
      ...
      private function onSongInfoMessage(param1:IMessageEvent) : void
      {
         ...
         if(_loc4_)
         {
            _loc7_ = this.var_412[_loc3_.id] as IHabboSound;
            if(_loc7_ == null)
            {
               _loc7_ = this.var_564.loadTraxSong(_loc3_.id,_loc3_.data);
               this.var_412.add(_loc3_.id,_loc7_);
            }
