package com.sulake.habbo.session
{
   ...
   public class RoomSession implements IRoomSession
   {
      ...
      private const const_1943:int = 2500;
      ...
      private var var_1016:UserDataManager;
      ...
      public function RoomSession(param1:int, param2:int, param3:IHabboTracking, param4:String = "", param5:String = "")
      {
         ...
         this.var_1016 = new UserDataManager();
      }
      ...
      public function set connection(param1:IConnection) : void
      {
         ...
         {
            this.var_1016.connection = param1;
         }
      }
      ...
      {
         this._connection.send(new ChatMessageComposer(param1,this.var_1256));
         this.var_1255.add(this.var_1256,getTimer());
         ++this.var_1256;
      }
      ...
      {
         var _loc3_:int = 0;
         var _loc2_:Object = this.var_1255.remove(param1);
         if(_loc2_ != null)
         {
            _loc3_ = getTimer();
            if(_loc3_ - int(_loc2_) > this.const_1943)
            {
      ...
      {
         return this.var_1016 as IUserDataManager;
      }
