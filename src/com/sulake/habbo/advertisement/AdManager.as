package com.sulake.habbo.advertisement
{
   ...
   public class AdManager extends Component implements IAdManager
   {
      ...
      private var var_1162:BitmapData = null;
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_2606 = this._config.getKey("interstitial.enabled","false") == "HabboFriendListCom_opened_to_web_popup_xml";
         this.var_2607 = int(this._config.getKey("interstitial.interval","30000"));
         this.var_2604 = int(this._config.getKey("interstitial.show.time","5000"));
         this.var_1844 = int(this._config.getKey("interstitial.max.displays.flash","-1"));
      ...
      public function showInterstitial() : Boolean
      {
         ...
         if(this.var_1844 > 0 && this.var_1842 >= this.var_1844)
         {
            return false;
         }
         var _loc1_:int = getTimer() - this.var_1161;
         if(_loc1_ > this.var_2607)
         {
            ++this.var_1842;
      ...
      private function onInterstitial(param1:InterstitialMessageEvent) : void
      {
         ...
         this.var_1419 = _loc2_.imageUrl;
         this.var_2605 = _loc2_.clickUrl;
         this.var_1161 = getTimer();
         if(this.var_1419 != "")
         {
            _loc3_ = this.var_1419;
            ...
            {
               this.var_222 = new Timer(this.var_2604,1);
            ...
            this.var_222.start();
            _loc4_ = new URLRequest(this.var_1419);
      ...
      private function startInterstitial(param1:Bitmap) : void
      {
         ...
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_547,0,0,param1.bitmapData,this.var_2605));
            this.var_1161 = getTimer();
         }
         else
         {
      ...
      private function stopInterstitial() : void
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_479));
         }
      }
      ...
      private function onRoomAd(param1:RoomAdMessageEvent) : void
      {
         ...
         this.var_1420 = _loc2_.imageUrl;
         this.var_1843 = _loc2_.clickUrl;
         if(this.var_1420 != "" && this.var_1843 != "")
         {
            _loc3_ = this.var_1420;
            if(assets.hasAsset(_loc3_))
            {
               assets.removeAsset(assets.getAssetByName(_loc3_));
            }
            _loc4_ = new URLRequest(this.var_1420);
            _loc5_ = assets.loadAssetFromFile(_loc3_,_loc4_,"image/jpeg");
      ...
      private function roomAdImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(this.isValidAdImage(_loc3_))
         {
            ...
            events.dispatchEvent(new AdEvent(AdEvent.const_417,0,0,_loc4_,this.var_1843,this.var_1162,this.var_1160));
         }
      }
      ...
      private function adWarningLeftReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            this.var_1162 = this.emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
