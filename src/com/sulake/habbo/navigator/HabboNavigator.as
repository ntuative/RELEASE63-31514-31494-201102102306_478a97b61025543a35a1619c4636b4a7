package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_279:MainViewCtrl;
      
      private var var_579:RoomInfoViewCtrl;
      
      private var var_1073:RoomCreateViewCtrl;
      ...
      private var var_2796:Dictionary;
      ...
      private var var_2276:RoomThumbnailRenderer;
      
      private var var_820:GuestRoomPasswordInput;
      
      private var var_344:GuestRoomDoorbell;
      ...
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_279 = new MainViewCtrl(this);
         this.var_579 = new RoomInfoViewCtrl(this);
         this.var_1073 = new RoomCreateViewCtrl(this);
         this.var_2276 = new RoomThumbnailRenderer(this);
         this.var_820 = new GuestRoomPasswordInput(this);
         this.var_344 = new GuestRoomDoorbell(this);
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = IBitmapWrapperWindow(this._windowManager.createWindow(param1,"",HabboWindowType.const_297,HabboWindowStyle.const_40,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6));
      ...
      private function setHabboToolbarIcon() : void
      {
         ...
         {
            this.var_178.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_118,HabboToolbarIconEnum.NAVIGATOR));
            if(this._data != null && this._data.homeRoomId > 0)
            {
               this.var_178.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_118,HabboToolbarIconEnum.EXITROOM));
            }
         }
      }
      ...
      public function animateWindowOpen(param1:IWindowContainer) : void
      {
         ...
         {
            this.var_178.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_51,HabboToolbarIconEnum.NAVIGATOR,param1));
         }
      }
      ...
      {
         var _loc1_:Boolean = this.var_279.onNavigatorToolBarIconClick();
         if(_loc1_)
         {
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         this.var_279.startSearch(Tabs.const_224,Tabs.const_374,param1);
         this.var_279.mainWindow.activate();
      }
      ...
      public function showOwnRooms() : void
      {
         ...
         this.var_279.startSearch(Tabs.const_298,Tabs.const_227);
         this.var_383.getTab(Tabs.const_298).tabPageDecorator.tabSelected();
      }
