package com.sulake.habbo.navigator.inroom
{
   ...
   public class RoomEventViewCtrl
   {
      ...
      private var var_2496:IButtonWindow;
      
      private var var_1369:IButtonWindow;
      
      private var var_901:IDropMenuWindow;
      ...
      private function editEvent(param1:RoomEventData) : void
      {
         ...
         this.var_1733.visible = true;
         this.var_2497.text = this._navigator.getText("roomevent_type_" + param1.eventType);
         this._eventNameInput.setText(param1.eventName);
         this.var_727.setText(param1.eventDescription);
         this.var_819.setText(this.getTagFromEvent(param1,1));
         this.var_818.setText(this.getTagFromEvent(param1,2));
         this.var_1370.visible = false;
         this.var_1368.visible = true;
         this.var_1369.visible = true;
         this.var_1732.visible = false;
         this.var_1734.visible = true;
      }
      
      private function createEvent() : void
      {
         this.var_901.visible = true;
         this.var_1733.visible = false;
         this.var_1370.visible = true;
         this.var_1368.visible = false;
         this.var_1369.visible = false;
         this.var_727.goBackToInitialState();
         this._eventNameInput.goBackToInitialState();
         this.var_819.goBackToInitialState();
         this.var_818.goBackToInitialState();
         this.var_901.selection = 0;
         this.var_1732.visible = true;
         this.var_1734.visible = false;
      }
      ...
      {
         var _loc1_:int = this.var_901.selection;
         return _loc1_ + 1;
      }
      ...
      private function onCreateButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc5_:String = this.var_727.getText();
         var _loc6_:Array = new Array();
         this.addTag(_loc6_,this.var_819.getText());
      ...
      private function isMandatoryFieldsFilled() : Boolean
      {
         ...
         if(!this.var_727.checkMandatory(this._navigator.getText("navigator.eventsettings.descerr")))
         {
            return false;
         }
         return true;
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         if(this._window == null)
         {
            ...
            this.var_1733 = IWindowContainer(this.find("event_type_disabled_cont"));
            this.var_2497 = ITextWindow(this.find("event_type_disabled_text"));
            this.var_1732 = ITextWindow(this.find("create_caption"));
            this.var_1734 = ITextWindow(this.find("edit_caption"));
            this.var_1370 = IButtonWindow(this.find("create_button"));
            this.var_1368 = IButtonWindow(this.find("edit_button"));
            this.var_2496 = IButtonWindow(this.find("cancel_button"));
            this.var_1369 = IButtonWindow(this.find("end_button"));
            this.var_901 = IDropMenuWindow(this.find("event_type"));
            ...
            Util.setProcDirectly(this.var_1369,this.onEndButtonClick);
            Util.setProcDirectly(this.var_2496,this.onCancelButtonClick);
            this._eventNameInput = new TextFieldManager(this._navigator,this.getInput("event_name"),25);
            this.var_727 = new TextFieldManager(this._navigator,this.getInput("event_desc"),100);
            this.var_819 = new TextFieldManager(this._navigator,this.getInput("event_tag_1"),25);
            this.var_818 = new TextFieldManager(this._navigator,this.getInput("event_tag_2"),25);
