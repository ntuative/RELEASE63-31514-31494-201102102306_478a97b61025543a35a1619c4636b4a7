package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomCreateViewCtrl
   {
      ...
      private var var_1202:RoomLayout;
      ...
      public function RoomCreateViewCtrl(param1:HabboNavigator)
      {
         ...
         this.var_639 = new Timer(100);
         this.var_639.addEventListener(TimerEvent.TIMER,this.updateArrowPos);
      ...
      public function dispose() : void
      {
         if(this.var_639)
         {
            this.var_639.removeEventListener(TimerEvent.TIMER,this.updateArrowPos);
            this.var_639.reset();
            this.var_639 = null;
         }
      }
      ...
      {
         var _loc3_:IBitmapWrapperWindow = IBitmapWrapperWindow(this.var_1202.view.findChildByName("select_arrow"));
         var _loc6_:int = Math.abs(_loc3_.y - 0) < 2 || Math.abs(_loc3_.y - 15) < 2 ? 1 : 2;
         _loc3_.y += !!this.var_1907 ? _loc6_ : -_loc6_;
         if(_loc3_.y < 0)
         {
            this.var_1907 = true;
            _loc3_.y = 1;
      ...
      private function prepare() : void
      {
         ...
         this.var_57 = IItemListWindow(this.var_180.findChildByName("item_list"));
         ...
         this.var_1201 = new TextFieldManager(this._navigator,ITextFieldWindow(this.var_180.findChildByName("room_name_input")),25,null,this._navigator.getText("navigator.createroom.roomnameinfo"));
      ...
      {
         this.var_1201.goBackToInitialState();
         this.var_1201.input.textBackgroundColor = 4294967295;
         this.var_1202 = this.var_42[0];
         this.refreshRoomThumbnails();
      ...
      private function addThumbnail(param1:IWindowContainer, param2:RoomLayout, param3:Boolean) : void
      {
         ...
         this.addMouseClickListener(_loc6_,this.method_10);
      ...
      {
         return Boolean(this.var_1201.checkMandatory(this._navigator.getText("navigator.createroom.nameerr")));
      }
      ...
      {
         var _loc2_:String = this.var_1201.getText();
         var _loc3_:String = "model_" + this.var_1202.name;
