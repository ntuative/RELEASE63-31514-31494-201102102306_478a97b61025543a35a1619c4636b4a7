package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomSettingsCtrl
   {
      ...
      private var var_551:ICheckBoxWindow;
      ...
      private var var_2086:ITextWindow;
      ...
      {
         this.var_321 = param1;
         this._navigator.send(new GetRoomSettingsMessageComposer(this.var_321));
      ...
      {
         if(param1 != this.var_321 || this.var_1031 < 1)
         {
            return;
         }
         this.close();
      ...
      public function onRoomSettingsSaveError(param1:int, param2:int, param3:String) : void
      {
         ...
         this.var_1031 = 0;
         if(param2 == RoomSettingsSaveErrorMessageParser.const_1423)
         {
            this.var_662.displayError("${navigator.roomsettings.roomnameismandatory}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1510)
         {
            this.var_662.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1410)
         {
            this.var_1023.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1585)
         {
            this.setTagError(this.var_819,param3,"${navigator.roomsettings.unacceptablewords}");
         ...
         {
            this.setTagError(this.var_819,param3,"${navigator.roomsettings.nonuserchoosabletag}");
            this.setTagError(this.var_818,param3,"${navigator.roomsettings.nonuserchoosabletag}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1617)
         {
            this.var_820.displayError("${navigator.roomsettings.passwordismandatory}");
         }
         else
         {
            this.var_662.displayError("Update failed: error " + param2);
         }
      }
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         _loc2_.addEventListener(WindowEvent.const_626,this.onDoorModePasswordUnselect);
         ...
         this.var_662 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("room_name")),60);
         this.var_1023 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("description")),255);
         this.var_819 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("tag1")),30);
         this.var_818 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("tag2")),30);
         this.var_820 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("password")),30);
         this.var_1025 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("password_confirm")),30);
         this.var_1029 = ICheckBoxWindow(this._window.findChildByName("allow_pets_checkbox"));
         this.var_1024 = ICheckBoxWindow(this._window.findChildByName("allow_foodconsume_checkbox"));
         this.var_1030 = ICheckBoxWindow(this._window.findChildByName("allow_walk_through_checkbox"));
         this.var_551 = ICheckBoxWindow(this._window.findChildByName("hide_walls_checkbox"));
         this.var_1530 = IWindowContainer(this._window.findChildByName("header_container"));
         this.var_1267 = IWindowContainer(this._window.findChildByName("thumbnail_container"));
         this.var_1028 = IWindowContainer(this._window.findChildByName("basic_settings_container"));
         this.var_1027 = IWindowContainer(this._window.findChildByName("advanced_settings_container"));
         this.var_1529 = IWindowContainer(this._window.findChildByName("switch_view_container"));
         this.var_1266 = IWindowContainer(this._window.findChildByName("footer_container"));
         this.var_235 = IWindowContainer(this._window.findChildByName("flat_controllers_container"));
         this.var_1026 = IWindowContainer(this._window.findChildByName("password_container"));
         this.var_2085 = ITextWindow(this._window.findChildByName("basic_caption"));
         this.var_2086 = ITextWindow(this._window.findChildByName("advanced_caption"));
         this.var_1531 = ITextWindow(this._window.findChildByName("switch_view_text"));
         this.var_1531.procedure = this.onSwitchView;
         this.var_1026.visible = false;
         if(!this._inRoom)
         {
      ...
      public function refresh(param1:IWindowContainer) : void
      {
         ...
         this.var_1530.visible = this._inRoom;
         this.var_1529.visible = this._inRoom;
         this.var_2086.visible = this.var_450;
         this.var_2085.visible = !this.var_450;
         if(this.var_450)
         {
         ...
         else
         {
            ...
            this.var_1267.visible = this._inRoom;
            this._navigator.thumbRenderer.refreshThumbnail(IWindowContainer(this.var_1267.findChildByName("picframe")),this._navigator.data.enteredGuestRoom.thumbnail,false);
            this.var_1028.height = Util.getLowestPoint(this.var_1028) + 4;
         }
         this.var_1531.text = !!this.var_450 ? "${navigator.roomsettings.tobasicsettings}" : "${navigator.roomsettings.toadvancedsettings}";
         Util.moveChildrenToColumn(this._window,[this.var_1530.name,this.var_1267.name,this.var_1028.name,this.var_1027.name,this.var_1266.name,this.var_1529.name],0,0);
      ...
      private function populateForm() : void
      {
         ...
         this.var_662.setText(_loc1_.name);
         this.var_1023.setText(_loc1_.description);
         this.var_820.setText("");
         this.var_1025.setText("");
         ...
         this.setTag(this.var_819,_loc1_.tags[0]);
         this.setTag(this.var_818,_loc1_.tags[1]);
         if(this.var_1029)
         {
            if(_loc1_.allowPets)
            {
         ...
         if(this.var_1030)
         {
            ...
            {
               this.var_1030.select();
            }
            else
            {
               this.var_1030.unselect();
            }
         }
         if(this.var_551)
         {
      ...
      private function onSaveButtonClick(param1:WindowMouseEvent) : void
      {
         ...
         _loc2_.name = this.var_662.getText();
         _loc2_.description = this.var_1023.getText();
         ...
         switch(_loc4_.name)
         {
            ...
            case "doormode_password":
               ...
               break;
            default:
               _loc2_.doorMode = RoomSettingsFlatInfo.const_496;
         }
         if(_loc2_.doorMode == RoomSettingsFlatInfo.const_114)
         {
            _loc8_ = this.var_820.getText();
            _loc9_ = this.var_1025.getText();
            if(_loc8_ != _loc9_)
            {
               this.var_820.clearErrors();
               this.var_1025.displayError("${navigator.roomsettings.invalidconfirm}");
               return;
            }
            if(_loc8_ != "")
            {
         ...
         _loc2_.allowFoodConsume = this.var_1024.isSelected;
         _loc2_.allowWalkThrough = this.var_1030.isSelected;
         _loc2_.hideWalls = this.var_551.isSelected;
         _loc2_.tags = new Array();
         this.addTag(this.var_819,_loc2_.tags);
      ...
      {
         Logger.log("[RoomSettingsCtrl.onDeleteButtonClick] " + this.var_321);
         this._navigator.registerParameter("navigator.roomsettings.deleteroom.confirm.message","room_name",this.var_74.name);
         var _loc2_:ConfirmDialogView = new ConfirmDialogView(IFrameWindow(this._navigator.getXmlWindow("ros_room_delete_confirm")),this,this.onConfirmRoomDelete,[this.var_321]);
         _loc2_.show();
      }
      ...
      private function onRemoveAllFlatCtrlsClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this._navigator.send(new RemoveAllRightsMessageComposer(this.var_321));
      }
