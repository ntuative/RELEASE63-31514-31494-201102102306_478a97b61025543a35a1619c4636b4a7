package com.sulake.habbo.navigator.mainview
{
   ...
   public class MainViewCtrl implements IUpdateReceiver, IDisposable
   {
      ...
      private static const const_585:int = 2;
      
      private static const const_911:int = 3;
      
      private static const const_1253:int = 4;
      ...
      private var var_1053:OfficialRoomListCtrl;
      ...
      private var var_1294:IWindow;
      
      private var var_1051:IRegionWindow;
      ...
      public function MainViewCtrl(param1:HabboNavigator)
      {
         ...
         this.var_1053 = new OfficialRoomListCtrl(this._navigator);
         this.var_452 = new Timer(300,1);
         this.var_452.addEventListener(TimerEvent.TIMER,this.onResizeTimer);
      }
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this.var_452)
            {
               this.var_452.removeEventListener(TimerEvent.TIMER,this.onResizeTimer);
               this.var_452.reset();
               this.var_452 = null;
            }
            if(this.var_839)
      ...
      private function prepare() : void
      {
         ...
         this.var_207 = IWindowContainer(this.var_17.findChildByName("custom_content"));
         this.var_189 = IWindowContainer(this.var_17.findChildByName("list_content"));
         this.var_236 = IWindowContainer(this.var_17.findChildByName("custom_footer"));
         this.var_1294 = this.var_17.findChildByName("loading_text");
         var _loc1_:IWindow = this.var_17.findChildByTag("close");
         _loc1_.procedure = this.onWindowClose;
         this.var_1051 = IRegionWindow(this.var_17.findChildByName("to_hotel_view"));
         if(!this.var_1051)
         {
            ErrorReportStorage.addDebugData("MainViewCtrl","prepare: _toHotelView is null!");
         }
         this.var_1051.procedure = this.onHotelView;
         this.refreshToHotelViewButton(false);
         this.var_17.procedure = this.onWindow;
         for each(_loc2_ in this._navigator.tabs.tabs)
         {
            _loc3_ = this.var_248.method_11(_loc2_.id);
            if(!_loc3_)
            {
         ...
         this.var_17.scaler.setParamFlag(HabboWindowParam.const_708,false);
         this.var_17.scaler.setParamFlag(HabboWindowParam.const_1375,true);
      }
      ...
      public function refresh() : void
      {
         ...
         var _loc1_:int = this.var_189.y;
         Util.moveChildrenToColumn(this.var_180,["custom_content","list_content"],this.var_207.y,8);
         this.var_189.height = this.var_189.height + _loc1_ - this.var_189.y - this.var_236.height + this.var_2164;
         Util.moveChildrenToColumn(this.var_180,["list_content","custom_footer"],this.var_189.y,0);
         this.var_2164 = this.var_236.height;
      ...
      private function refreshFooter() : void
      {
         ...
         var _loc1_:Tab = this._navigator.tabs.getSelected();
         _loc1_.tabPageDecorator.refreshFooter(this.var_236);
      ...
      {
         this.refreshList(param1,param2,this.var_1053,"official_rooms");
      }
      ...
      private function refreshList(param1:Boolean, param2:Boolean, param3:IViewCtrl, param4:String) : void
      {
         ...
         {
            _loc5_ = this.var_189.getChildByName(param4);
      ...
      public function update(param1:uint) : void
      {
         ...
         if(this.var_567 == const_910)
         {
            _loc3_ = Math.min(1,Math.max(0,this.var_189.blend - _loc2_));
            this.var_189.blend = _loc3_;
            this.var_207.blend = !!this.var_1052 ? Number(_loc3_) : Number(1);
            this.var_236.blend = !!this.var_1052 ? Number(_loc3_) : Number(1);
            if(_loc3_ == 0)
            {
               this.var_567 = const_585;
            }
         }
         else if(this.var_567 == const_585)
         {
            if(this.var_1295 % 10 == 1)
            {
               this.var_1294.visible = !this.var_1294.visible;
            }
            ++this.var_1295;
            if(!this._navigator.data.isLoading())
            {
               this.var_567 = const_911;
            }
         }
         else if(this.var_567 == const_911)
         {
            this.refresh();
            this.var_567 = const_1253;
         }
         else
         {
      ...
      {
         this._navigator.refreshButton(this.var_1051,"icon_hotelview",!param1,null,0);
         this._navigator.refreshButton(this.var_1051,"icon_hotelview_reactive",param1,null,0);
      }
