package com.sulake.habbo.navigator
{
   ...
   public class PopupCtrl
   {
      ...
      public function dispose() : void
      {
         ...
         if(this.var_425)
         {
            this.var_425.removeEventListener(TimerEvent.TIMER,this.onDisplayTimer);
            this.var_425.reset();
            this.var_425 = null;
         }
         if(this.var_360)
      ...
      public function showPopup(param1:IWindow) : void
      {
         if(this.var_53 == null)
         {
            this.var_53 = IWindowContainer(this._navigator.getXmlWindow(this.var_989));
            this.var_53.visible = false;
            this.var_53.setParamFlag(HabboWindowParam.const_36,true);
         ...
         this.var_53.x = _loc2_.x + this.var_2087 + param1.width;
