package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailCtrl
   {
      ...
      private var var_1889:IButtonWindow;
      
      private var var_1888:IButtonWindow;
      
      private var var_1887:IButtonWindow;
      
      private var var_2672:IWindowContainer;
      
      private var var_2671:IWindowContainer;
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         this.var_1889 = IButtonWindow(this.find("bg_tab"));
         this.var_1888 = IButtonWindow(this.find("top_tab"));
         this.var_1887 = IButtonWindow(this.find("obj_tab"));
         this.var_2672 = IWindowContainer(this.find("tile_grid"));
         this.var_2671 = IWindowContainer(this.find("now_editing_container"));
         Util.setProcDirectly(this.find("save"),this.onSaveButton);
         Util.setProcDirectly(this.find("cancel"),this.onCancelButton);
         Util.setProcDirectly(this.var_1889,this.onBgTabButton);
         Util.setProcDirectly(this.var_1888,this.onTopTabButton);
      ...
      {
         this.setEnabled(this.var_1889,this.var_65.mode != ThumbnailEditorModel.const_35);
         this.setEnabled(this.var_1888,this.var_65.mode != ThumbnailEditorModel.const_58);
         this.setEnabled(this.var_1887,this.var_65.mode != ThumbnailEditorModel.const_33);
      }
      
      private function refreshEditArea() : void
      {
         var _loc1_:IWindowContainer = this.var_2671;
      ...
      private function refreshPositionGrid() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc1_:IWindowContainer = this.var_2672;
         _loc1_.visible = true;
      ...
      private function populateImgList(param1:IItemListWindow, param2:int) : void
      {
         ...
         while(_loc8_ < _loc6_.length)
         {
            ...
            _loc11_ = IBitmapWrapperWindow(this._navigator.windowManager.createWindow("img_" + _loc8_,"",HabboWindowType.const_297,HabboWindowStyle.const_40,0 | 0,new Rectangle(_loc9_ * 66,0,66,66),this.onImgSel,_loc10_.id));
