package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class ThumbnailEditorModel
   {
      ...
      private var var_188:RoomThumbnailObjectData;
      ...
      private function removeSelected() : void
      {
         ...
         var _loc2_:int = Util.remove(_loc1_,this.var_188);
         this.var_188 = null;
         if(_loc1_.length > 0)
         {
            this.var_188 = _loc1_[Math.min(_loc2_,_loc1_.length - 1)];
         }
      }
      ...
      {
         this.var_188 = this.findByPos(param1);
         if(this.var_188 == null)
         {
      ...
      public function setImg(param1:int) : void
      {
         ...
         if(this.var_559 == const_33)
         {
            if(this.var_188 == null)
            {
               return;
            }
            this.var_188.imgId = param1;
         }
      }
      ...
      public function getImgId() : int
      {
         ...
         return this.var_188 == null ? -1 : int(this.var_188.imgId);
      }
      ...
      {
         this._data = param1;
         this.var_559 = const_35;
         if(this._data.objects.length > 0)
         {
            this.var_188 = this._data.objects[0];
         }
         else
         {
            this.var_188 = null;
