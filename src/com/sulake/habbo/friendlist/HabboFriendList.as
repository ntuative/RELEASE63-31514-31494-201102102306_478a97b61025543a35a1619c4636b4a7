package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList, IAvatarImageListener
   {
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_594.stop();
            this.var_594.removeEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_594 = null;
         }
         ...
         if(this.var_1107)
         {
            this.var_1107.release(new IIDAvatarRenderManager());
            this.var_1107 = null;
         }
         if(this.var_950)
         {
            this.var_950.release(new IIDHabboNotifications());
            this.var_950 = null;
         }
         if(this.var_178)
         {
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         {
            this.var_1707 = new OpenedToWebPopup(this);
         }
         this.var_1707.show(x,y);
      }
      ...
      public function refreshToolBarIcon() : void
      {
         ...
         _loc1_.iconState = String(this.var_347.getCountOfOpenRequests() > 0 ? "2" : "0");
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = this._windowManager.createWindow(param1,"",HabboWindowType.const_297,HabboWindowStyle.const_40,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6) as IBitmapWrapperWindow;
      ...
      {
         var _loc2_:IAvatarImage = this.var_1107.createAvatarImage(param1,AvatarScaleType.const_87,null,this);
         if(!_loc2_)
         {
            return null;
         }
      ...
      public function isEmbeddedMinimailEnabled() : Boolean
      {
         ...
         return _loc1_ == "HabboFriendListCom_opened_to_web_popup_xml";
      }
      ...
      private function onAvatarRenderedReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1107 = param2 as IAvatarRenderManager;
      ...
      {
         this.var_950 = param2 as IHabboNotifications;
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         this.var_347 = new FriendRequests(new FriendRequestsDeps(this),_loc2_.method_12,_loc2_.extendedFriendLimit,_loc2_.evenMoreExtendedFriendLimit);
         for each(_loc3_ in _loc2_.categories)
         {
            this.var_94.addCategory(new FriendCategory(_loc3_.id,_loc3_.name));
         }
         this.var_94.addCategory(new FriendCategory(FriendCategory.const_967,this.getText("friendlist.friends")));
         this.var_94.addCategory(new FriendCategory(FriendCategory.const_341,this.getText("friendlist.friends.offlinecaption")));
         ...
         if(!this.var_594)
         {
            this.var_594 = new Timer(120000);
            this.var_594.addEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_594.start();
         }
         this.getBuddyRequests();
         this.registerListeners();
         this.var_178.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_118,HabboToolbarIconEnum.FRIENDLIST));
         ...
         {
            _loc5_ = this.var_94.findCategory(FriendCategory.const_341);
            if(_loc5_)
            {
               _loc5_.setOpen(true);
            }
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         this.var_347.clearAndUpdateView(false);
         for each(_loc3_ in _loc2_.reqs)
         {
            this.var_347.addRequest(new FriendRequest(_loc3_));
         }
         if(_loc2_.reqs.length > 0)
         {
            this.var_383.findTab(FriendListTab.const_97).setNewMessageArrived(true);
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         this.var_347.addRequestAndUpdateView(_loc3_);
         var _loc4_:FriendListTab = this.var_383.findTab(FriendListTab.const_97);
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         this.var_1706.searchReceived(_loc2_.friends,_loc2_.others);
      ...
      {
         var _loc2_:FriendListTab = this.var_383.findTab(FriendListTab.const_97);
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         if(!this.var_725 || !this.var_347)
         {
            return;
         }
         var _loc2_:int = 0;
         if(this.var_725.hasUserRight("fuse_super_extended_buddylist"))
         {
            _loc2_ = this.var_347.vipLimit;
         }
         else if(this.var_725.hasUserRight("fuse_extended_buddylist"))
         {
            _loc2_ = this.var_347.clubLimit;
         }
         if(_loc2_ > this.var_347.limit)
         {
            this.var_347.limit = _loc2_;
         }
      }
