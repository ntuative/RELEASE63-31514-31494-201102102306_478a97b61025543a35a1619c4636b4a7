package com.sulake.habbo.friendlist
{
   ...
   public class FriendListView
   {
      ...
      private static const const_1703:String = "noconvinfo";
      ...
      private var var_1462:FriendListTabsView;
      ...
      public function FriendListView(param1:HabboFriendList)
      {
         ...
         this.var_1462 = new FriendListTabsView(this._friendList);
      }
      ...
      private function prepare() : void
      {
         ...
         this.var_236 = IWindowContainer(this.var_17.content.findChildByName("footer"));
         this.var_1462.prepare(this.var_923);
         this.var_17.procedure = this.onWindow;
         this.var_17.content.setParamFlag(HabboWindowParam.const_1043,false);
         this.var_17.content.setParamFlag(HabboWindowParam.const_1007,true);
         this.var_17.header.setParamFlag(HabboWindowParam.const_651,false);
         this.var_17.header.setParamFlag(HabboWindowParam.const_627,true);
         this.var_17.content.setParamFlag(HabboWindowParam.const_651,false);
         this.var_17.content.setParamFlag(HabboWindowParam.const_627,true);
         this.var_17.findChildByName("open_edit_ctgs_but").procedure = this.onEditCategoriesButtonClick;
         this.var_1463 = ITextWindow(this.var_17.findChildByName("info_text"));
         this.var_1463.text = "";
      ...
      private function onWindow(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:int = this.var_1910 == -1 ? 0 : int(this.var_17.height - this.var_1910);
         var _loc4_:int = this.var_1909 == -1 ? 0 : int(this.var_17.width - this.var_1909);
      ...
      private function refreshWindowSize() : void
      {
         ...
         this.var_236.y = Util.getLowestPoint(this.var_17.content);
         this.var_236.width = this._friendList.tabs.windowWidth;
         ...
         this.var_17.scaler.setParamFlag(HabboWindowParam.const_1155,this._friendList.tabs.findSelectedTab() != null);
         this.var_17.scaler.setParamFlag(HabboWindowParam.const_651,false);
         this.var_17.scaler.setParamFlag(HabboWindowParam.const_1043,false);
         ...
         this.var_1910 = this.var_17.height;
         this.var_1909 = this.var_17.width;
