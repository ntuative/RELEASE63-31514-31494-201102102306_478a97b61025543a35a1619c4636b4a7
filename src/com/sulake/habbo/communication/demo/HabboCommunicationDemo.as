package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_2233:PseudoRandom;
      ...
      public function setSSOTicket(param1:String) : void
      {
         ...
         {
            this.var_572 = param1;
            this.var_48.initConnection(HabboConnectionType.const_250);
         }
      }
      ...
      {
         if(this.var_48 && this.var_148 && this.var_15 && this._windowManager)
         {
      ...
      private function componentsAreRunning() : void
      {
         ...
         var _loc1_:String = this.var_148.getKey("client.hotel_view.image");
         var _loc2_:String = this.var_148.getKey("image.library.url");
         if(_loc1_ != null && _loc2_ != null)
         {
            this.var_208.loadHotelViewImage(_loc2_ + _loc1_);
         }
         var _loc3_:* = this.var_148.getKey("use.sso.ticket") == "1";
         this.var_572 = this.var_148.getKey("sso.ticket",null);
         this.var_1603 = this.var_148.getKey("flash.client.url","");
         this.var_2234 = this.var_148.getKey("external.variables.txt","");
         if(this.var_208 == null)
         {
            this.var_208 = new HabboHotelView(this._windowManager,assets,Component(context).events);
         }
         ...
         else if(this._windowManager != null)
         {
            ...
            if(_loc4_)
            {
               ...
               this._view.addEventListener(HabboLoginDemoView.const_508,this.onInitConnection);
            }
         }
      }
      ...
      private function onInitConnection(param1:Event = null) : void
      {
         ...
         else
         {
            ...
            {
               this.var_48.mode = HabboConnectionType.const_979;
            }
         }
         this.var_48.initConnection(HabboConnectionType.const_250);
      }
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         this.var_2233 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(this.var_48.mode)
         {
            case HabboConnectionType.const_112:
               ...
               this.var_1302 = _loc4_;
               this.var_208.loadBannerImage(_loc7_ + "?token=" + this.var_1302,this.onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_979:
               this.sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1392:
               this.var_848 = this.generateRandomHexString(30);
               this.var_469 = new DiffieHellman(new BigInteger(this.var_148.getKey("connection.development.prime"),16),new BigInteger(this.var_148.getKey("connection.development.generator"),16));
               this.var_469.init(this.var_848);
               _loc8_ = this.var_469.getPublicKey(10);
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         this.var_469.generateSharedKey(_loc4_,10);
         var _loc5_:String = this.var_469.getSharedKey(16).toUpperCase();
         var _loc6_:RC4_R27 = new RC4_R27(null,null);
         var _loc7_:IEncryption = new RC4_R27(_loc6_,this.var_2233);
      ...
      private function sendConnectionParameters(param1:IConnection) : void
      {
         ...
         connection.send(new VersionCheckMessageComposer(401,this.var_1603,this.var_2234));
         var machineId:String = "";
         try
         {
            so = SharedObject.getLocal(this.const_1659,"/");
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(this.var_1303)
         {
            this.dispatchLoginStepEvent(HabboCommunicationEvent.const_195);
         }
         if(param1.type == Event.CLOSE && !this.var_2235)
         {
      ...
      private function onHotelViewBannerLoaded(param1:BitmapData) : void
      {
         ...
         var _loc4_:String = xor(_loc3_,this.var_1302);
         ...
         this.var_469 = new DiffieHellman(_loc10_,_loc11_);
         var _loc13_:int = 10;
         var _loc14_:* = null;
         while(_loc13_ > 0)
         {
            _loc14_ = this.generateRandomHexString(30);
            this.var_469.init(_loc14_);
            _loc15_ = this.var_469.getPublicKey(10);
            if(_loc15_.length >= 64)
            {
               _loc12_ = _loc15_;
               this.var_848 = _loc14_;
            }
