package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      protected var var_648:BitmapData;
      
      protected var var_2701:int;
      
      protected var var_1481:Boolean;
      
      protected var var_1979:Boolean;
      
      protected var var_2730:BitmapData;
      
      private const const_1942:int = 8947848;
      
      private const const_1941:int = 13421772;
      
      private const const_1677:Number = 1;
      
      private const const_1678:Number = 0.2;
      ...
      public function initImage() : void
      {
         ...
         {
            _loc1_ = this._roomEngine.getFurnitureIcon(this._type,this,String(this.var_1336));
         }
         else
         {
            _loc1_ = this._roomEngine.getWallItemIcon(this._type,this,this.var_1980);
         }
         if(_loc1_.id > 0)
         {
            this.setLoadingImage(_loc1_.data);
            this.var_797 = _loc1_.id;
         }
         else
         {
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_)
         {
            ...
            if(_loc2_ <= 0)
            {
               this._window.blend = this.const_1678;
               _loc1_.blend = this.const_1678;
            }
            else
            {
               this._window.blend = this.const_1677;
               _loc1_.blend = this.const_1677;
            }
         }
         if(this.isSelected)
         {
