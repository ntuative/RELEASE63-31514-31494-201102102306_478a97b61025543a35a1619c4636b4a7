package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingView implements IInventoryView, IGetImageListener
   {
      ...
      private static const const_904:uint = 4284532064;
      
      private static const const_905:uint = 2577770;
      ...
      private var var_385:ItemPopupCtrl;
      ...
      public function TradingView(param1:TradingModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IRoomEngine, param5:IHabboLocalizationManager)
      {
         ...
         this.var_385 = new ItemPopupCtrl(_loc8_,this._assetLibrary);
      }
      ...
      public function getWindowContainer() : IWindowContainer
      {
         ...
         {
            this.var_1560 = this.createMinimizedWindow();
         }
         if(!this.var_2149)
         {
            return this.var_67;
      ...
      public function updateUserInterface() : void
      {
         ...
         if(this.var_67)
         {
            ...
            if(_loc1_)
            {
               _loc1_.color = !!this.var_22.ownUserAccepts ? uint(const_904) : uint(const_905);
            }
            ...
            if(_loc1_)
            {
               _loc1_.color = !!this.var_22.otherUserAccepts ? uint(const_904) : uint(const_905);
            }
      ...
      private function ownThumbEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            if(_loc4_.category == FurniCategory.const_1115)
            {
            ...
            this.var_385.updateContent(param2 as IWindowContainer,_loc6_,_loc5_,ItemPopupCtrl.const_550);
            this.var_385.show();
         }
         else if(param1.type == WindowMouseEvent.const_25)
         {
            this.var_385.hideDelayed();
         }
      }
