package com.sulake.habbo.inventory
{
   ...
   public class IncomingMessages
   {
      ...
      public function IncomingMessages(param1:HabboInventory)
      {
         ...
         this.var_27.addHabboConnectionMessageEvent(new PetInventoryUpdatedEvent(this.method_9));
      ...
      public function onAvatarEffects(param1:IMessageEvent) : void
      {
         ...
         this._inventory.setInventoryCategoryInit(InventoryCategory.const_621);
         _loc2_.refreshViews();
      ...
      private function method_9(param1:PetInventoryUpdatedEvent) : void
      {
      ...
      {
         var _loc2_:* = null;
         if(this._inventory.isInventoryCategoryInit(InventoryCategory.const_346))
         {
