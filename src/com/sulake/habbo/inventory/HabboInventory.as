package com.sulake.habbo.inventory
{
   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      private var var_1074:IRoomSession;
      ...
      private const const_1952:int = 500;
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_15 != null)
         {
            ...
            this.var_15.events.removeEventListener(RoomSessionPropertyUpdateEvent.const_452,this.roomSessionEventHandler);
      ...
      {
         return EffectsModel(this.var_49.getValue(InventoryCategory.const_621));
      }
      
      public function get badgesModel() : BadgesModel
      {
         return BadgesModel(this.var_49.getValue(InventoryCategory.const_304));
      }
      
      public function get achievementsModel() : AchievementsModel
      {
         return AchievementsModel(this.var_49.getValue(InventoryCategory.const_340));
      }
      ...
      {
         return this.var_49.getValue(InventoryCategory.const_346) as MarketplaceModel;
      }
      ...
      {
         this.var_384 = ISessionDataManager(param2);
         this.initInventory();
      }
      ...
      private function onRoomSessionManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_15.events.addEventListener(RoomSessionPropertyUpdateEvent.const_452,this.roomSessionEventHandler);
         this.initInventory();
      }
      ...
      private function roomSessionEventHandler(param1:RoomSessionEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomSessionEvent.const_94:
               this.var_1074 = null;
               break;
            case RoomSessionPropertyUpdateEvent.const_452:
               this.petsModel.updatePetsAllowed();
         }
      }
      ...
      {
         if(!this._communication || !this._windowManager || !this._localization || !this._roomEngine || !this.var_384 || !this._config || !this._catalog || !this._avatarRenderer || !this.var_15 || !this.var_178)
         {
            return;
         }
         ...
         this.var_49.add(InventoryCategory.const_346,_loc1_);
         ...
         var _loc3_:BadgesModel = new BadgesModel(this,this._windowManager,this._communication,this._assetLibrary,this.var_384);
         this.var_49.add(InventoryCategory.const_304,_loc3_);
         ...
         this.var_49.add(InventoryCategory.const_621,_loc4_);
         var _loc5_:AchievementsModel = new AchievementsModel(this,this._windowManager,this._communication,this._assetLibrary,this._localization,this.var_384);
         this.var_49.add(InventoryCategory.const_340,_loc5_);
      ...
      public function requestInventoryCategoryInit(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.requestInitialization(this.const_1952);
         }
      }
