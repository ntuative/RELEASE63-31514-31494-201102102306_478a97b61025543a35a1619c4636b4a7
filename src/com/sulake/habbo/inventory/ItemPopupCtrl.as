package com.sulake.habbo.inventory
{
   ...
   public class ItemPopupCtrl
   {
      ...
      private static const const_932:int = 5;
      
      private static const const_1298:int = 250;
      
      private static const const_1295:int = 100;
      
      private static const const_1297:int = 180;
      
      private static const const_1296:int = 200;
      ...
      {
         this.var_351 = new Timer(const_1298,1);
         this.var_350 = new Timer(const_1295,1);
         super();
         if(param1 == null)
         {
            return;
      ...
      public function updateContent(param1:IWindowContainer, param2:String, param3:BitmapData, param4:int = 2) : void
      {
         ...
         if(_loc6_)
         {
            _loc7_ = new BitmapData(Math.min(const_1297,param3.width),Math.min(const_1296,param3.height),true,16777215);
      ...
      public function show() : void
      {
         ...
         {
            case const_1067:
               this.var_78.x = -1 * this.var_78.width - const_932;
               break;
            case const_550:
               this.var_78.x = this._parent.width + const_932;
         }
      ...
      private function refreshArrow(param1:int = 2) : void
      {
         ...
         switch(param1)
         {
            case const_1067:
               ...
               _loc2_.y = (this.var_78.height - this.var_910.height) / 2;
            ...
            case const_550:
               ...
               _loc2_.y = (this.var_78.height - this.var_734.height) / 2;
