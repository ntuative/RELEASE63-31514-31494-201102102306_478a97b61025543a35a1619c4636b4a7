package com.sulake.habbo.room.utils
{
   public class TileHeightMap
   {
      ...
      public function getTileBlocking(param1:int, param2:int) : Boolean
      {
         ...
         if(param1 >= 0 && param1 < this.var_146 && param2 >= 0 && param2 < this.var_147)
         {
            _loc3_ = this.var_842[param2] as Array;
      ...
      public function setTileBlocking(param1:int, param2:int, param3:Boolean) : void
      {
         ...
         if(param1 >= 0 && param1 < this.var_146 && param2 >= 0 && param2 < this.var_147)
         {
            _loc4_ = this.var_842[param2] as Array;
            _loc4_[param1] = param3;
         }
      }
      ...
      public function method_4(param1:int, param2:int, param3:int, param4:int, param5:int, param6:int, param7:int, param8:int) : Boolean
      {
         ...
         {
            _loc11_ = this.var_842[_loc10_] as Array;
            _loc9_ = param1;
