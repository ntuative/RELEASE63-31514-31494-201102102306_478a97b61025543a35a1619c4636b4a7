package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurnitureLogic extends MovingObjectLogic
   {
      ...
      private var var_543:Number = 0.0;
      
      private var var_1456:Number = 0.0;
      
      private var var_2638:Number = 0.0;
      
      private var var_2639:Number = 0.0;
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         this.var_2638 = this.var_447 / 2;
         this.var_2639 = this.var_543 / 2;
         ...
         object.getModelController().setNumber(RoomObjectVariableEnum.const_275,this.var_447,true);
         object.getModelController().setNumber(RoomObjectVariableEnum.const_330,this.var_543,true);
         object.getModelController().setNumber(RoomObjectVariableEnum.const_827,this.var_1456,true);
         object.getModelController().setNumber(RoomObjectVariableEnum.const_1389,this.var_2638,true);
         object.getModelController().setNumber(RoomObjectVariableEnum.const_1356,this.var_2639,true);
         object.getModelController().setNumber(RoomObjectVariableEnum.const_1133,this.var_1903,true);
         object.getModelController().setNumberArray(RoomObjectVariableEnum.const_814,this.var_244,true);
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         var _loc9_:String = _loc3_.getString(RoomObjectVariableEnum.const_393);
         switch(param1.type)
         {
            ...
            case MouseEvent.DOUBLE_CLICK:
               ...
               if(eventDispatcher != null && _loc9_ != null && _loc9_.indexOf("http") == 0)
               {
                  eventDispatcher.dispatchEvent(new RoomObjectRoomAdEvent(RoomObjectRoomAdEvent.const_529,_loc6_,_loc7_));
               }
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(_loc4_ != null)
         {
            if(_loc2_ != null)
            {
               _loc2_.setString(RoomObjectVariableEnum.const_1006,_loc4_.itemData);
            }
            return;
         }
         this.var_1196 = false;
