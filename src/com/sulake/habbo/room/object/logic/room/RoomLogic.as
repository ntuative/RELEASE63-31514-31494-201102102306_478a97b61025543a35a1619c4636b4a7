package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_1660:int = 255;
      
      private var var_1084:uint = 16777215;
      
      private var var_1661:int = 255;
      
      private var var_1083:int = 0;
      
      private var var_1659:int = 1500;
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.setString(RoomObjectVariableEnum.const_1028,param1.toString(),true);
            _loc2_.setNumber(RoomObjectVariableEnum.const_759,16777215);
            _loc2_.setNumber(RoomObjectVariableEnum.const_672,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_748,1);
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(this.var_1083)
         {
            _loc2_ = param1;
            _loc3_ = this._color;
            _loc4_ = this.var_1658;
            if(_loc2_ - this.var_1083 >= this.var_1659)
            {
               _loc3_ = this.var_1084;
               _loc4_ = this.var_1661;
               this.var_1083 = 0;
            }
            else
            {
               _loc7_ = this.var_1330 >> 16 & 255;
               _loc8_ = this.var_1330 >> 8 & 255;
               _loc9_ = this.var_1330 & 255;
               _loc10_ = this.var_1084 >> 16 & 255;
               _loc11_ = this.var_1084 >> 8 & 255;
               _loc12_ = this.var_1084 & 255;
               _loc13_ = (_loc2_ - this.var_1083) / this.var_1659;
               _loc7_ += (_loc10_ - _loc7_) * _loc13_;
               _loc8_ += (_loc11_ - _loc8_) * _loc13_;
               _loc9_ += (_loc12_ - _loc9_) * _loc13_;
               _loc3_ = (_loc7_ << 16) + (_loc8_ << 8) + _loc9_;
               _loc4_ = this.var_1660 + (this.var_1661 - this.var_1660) * _loc13_;
               this._color = _loc3_;
               this.var_1658 = _loc4_;
            }
      ...
      private function updatePlaneProperties(param1:RoomObjectRoomUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomUpdateMessage.const_616:
               param2.setString(RoomObjectVariableEnum.const_668,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_820:
               param2.setString(RoomObjectVariableEnum.const_773,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_784:
               param2.setString(RoomObjectVariableEnum.const_865,param1.value);
         }
      }
      ...
      private function updatePlaneMasks(param1:RoomObjectRoomMaskUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomMaskUpdateMessage.const_504:
               ...
               _loc4_ = true;
               break;
            case RoomObjectRoomMaskUpdateMessage.const_832:
         ...
         if(_loc4_)
         {
            ...
            param2.setString(RoomObjectVariableEnum.const_1130,_loc7_);
         }
      }
      ...
      private function updatePlaneVisibilities(param1:RoomObjectRoomPlaneVisibilityUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_984:
               param2.setNumber(RoomObjectVariableEnum.const_672,_loc3_);
               break;
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_977:
               param2.setNumber(RoomObjectVariableEnum.const_748,_loc3_);
      ...
      private function updateColors(param1:RoomObjectRoomColorUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         this.var_1330 = this._color;
         this.var_1660 = this.var_1658;
         this.var_1084 = _loc3_;
         this.var_1661 = _loc4_;
         this.var_1083 = getTimer();
         this.var_1659 = 1500;
      }
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         if(_loc5_ < 1 || _loc5_ > this._planeParser.planeCount)
         {
            ...
            {
               _loc4_.setNumber(RoomObjectVariableEnum.const_573,0);
            }
            return;
         }
         _loc5_--;
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1553,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1453,_loc21_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1408,_loc22_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_573,_loc5_ + 1);
            var _loc23_:String = "";
            var _loc24_:int = 0;
            var _loc25_:* = null;
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  if(eventDispatcher != null)
                  {
                     ...
                     else if(_loc13_ == RoomPlaneData.const_158 || _loc13_ == RoomPlaneData.const_320)
                     {
                        _loc27_ = 90;
                        if(_loc11_ != null)
                        {
