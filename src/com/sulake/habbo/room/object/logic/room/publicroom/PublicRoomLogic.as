package com.sulake.habbo.room.object.logic.room.publicroom
{
   ...
   public class PublicRoomLogic extends RoomLogic
   {
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         _loc2_.setString(RoomObjectVariableEnum.const_796,"");
         ...
         if(_loc3_ != null)
         {
            switch(_loc3_.type)
            {
               case RoomObjectRoomAdUpdateMessage.const_1024:
                  ...
                  _loc2_.setString(RoomObjectVariableEnum.const_796,_loc3_.clickUrl);
                  _loc2_.setNumber(RoomObjectVariableEnum.const_493,Number(true));
                  this.var_1424 = getTimer() + _loc2_.getNumber(RoomVariableEnum.const_1173);
            }
         }
      }
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         switch(_loc3_.type)
         {
            case MouseEvent.CLICK:
               if(_loc3_.spriteTag == RoomObjectVariableEnum.const_543)
               {
                  _loc7_ = _loc4_.getString(RoomObjectVariableEnum.const_796);
