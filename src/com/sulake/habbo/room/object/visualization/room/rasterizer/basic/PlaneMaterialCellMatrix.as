package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class PlaneMaterialCellMatrix
   {
      ...
      public static const const_1383:int = const_349;
      ...
      public static const const_291:int = const_110;
      ...
      public function clearCache() : void
      {
         ...
         if(this.var_668 != null)
         {
            this.var_668.assign(new Vector3d());
         }
         this.var_557 = 0;
         var _loc1_:int = 0;
      ...
      public function render(param1:BitmapData, param2:int, param3:int, param4:IVector3d, param5:Boolean, param6:int, param7:Boolean) : BitmapData
      {
         ...
         if(this.isStatic)
         {
            if(this.var_30 != null)
            {
               if(this.var_30.width == param2 && this.var_30.height == param3 && Vector3d.isEqual(this.var_668,param4))
               {
                  if(param1 != null)
                  {
                     this.copyCachedBitmapOnCanvas(param1,this.var_557,param6,param7);
                     return param1;
                  }
                  return this.var_30;
               }
      ...
      private function copyCachedBitmapOnCanvas(param1:BitmapData, param2:int, param3:int, param4:Boolean) : void
      {
         ...
         var _loc5_:* = null;
         if(this.var_1542 == const_110)
         {
            _loc5_ = new Rectangle(0,0,this.var_30.width,this.var_557);
         }
         else
         {
            _loc5_ = new Rectangle(0,this.var_30.height - this.var_557,this.var_30.width,this.var_557);
         }
