package com.sulake.habbo.room.object.visualization.room.publicroom.rasterizer
{
   ...
   public class LayoutRasterizer
   {
      ...
      private var var_1509:XMLList;
      
      private var _offsetX:int;
      
      private var var_1059:int;
      
      private var var_2458:Vector3d;
      ...
      private var var_1360:LayoutRasterizerData = null;
      ...
      {
         if(param1 != this.var_890)
         {
            this.var_890 = param1;
            this._adBgIndex = -1;
            this._adImgIndex = -1;
            this.var_1360 = this.var_42.getValue(this.var_890);
         }
      }
      ...
      public function initialize(param1:XML) : void
      {
         ...
         this.var_2458 = new Vector3d(-0.5,0.5,0);
         this.var_891 = false;
      }
      ...
      public function initializeGeometry(param1:IRoomGeometry) : void
      {
         ...
         var _loc3_:Point = param1.getScreenPoint(this.var_2458);
         _loc3_.x -= _loc2_.x;
         _loc3_.y -= _loc2_.y;
      ...
      public function initializeAds(param1:int, param2:IRoomObjectSpriteVisualization) : void
      {
         ...
         var _loc3_:LayoutRasterizerData = this.var_42.getValue(this.var_890);
         if(_loc3_ == null)
         {
            return;
         }
                  ...
                  if(_loc9_ != null)
                  {
                     if(_loc7_.@id.toString().length > 0)
                     {
                        ...
                        if(_loc10_ == "billboard_bg")
                        {
                           ...
                           {
                              this.var_1716 = RoomObjectVariableEnum.const_1146;
                           }
                           if(_loc11_.indexOf("right") > -1)
                           {
                              this.var_1716 = RoomObjectVariableEnum.const_991;
                           }
                           if(param2 != null)
                           {
                              _loc5_ = param2.getSprite(this.var_1110 + this._adBgIndex);
                              if(_loc5_ != null)
                              {
                        ...
                        if(_loc10_ == "billboard_img")
                        {
                           ...
                           if(param2 != null)
                           {
                              _loc5_ = param2.getSprite(this.var_1110 + this._adImgIndex);
                              if(_loc5_ != null)
                              {
                                 _loc5_.visible = false;
                                 _loc5_.alpha = 0;
      ...
      {
         var _loc1_:LayoutRasterizerData = this.var_42.getValue(this.var_890);
         if(_loc1_ == null)
         {
            return 0;
         }
      ...
      {
         if(param2 == this.var_2457 && param3 == this.var_2459)
         {
            return;
         }
         ...
         if(param1 != null)
         {
            _loc4_ = param1.getSprite(this.var_1110 + this._adBgIndex);
            _loc5_ = param1.getSprite(this.var_1110 + this._adImgIndex);
         }
         ...
         {
            this.exchangeElementGraphics("billboard_img",this.var_1716);
         }
         ...
         if(param3)
         {
            ...
            _loc5_.tag = RoomObjectVariableEnum.const_543;
         }
         if(param2 != "")
         {
            _loc4_.visible = true;
      ...
      public function setElementToSprite(param1:int, param2:IRoomObjectSprite, param3:String = "", param4:Boolean = false) : void
      {
         ...
         var _loc5_:XMLList = this.var_1360.elementList;
         if(_loc5_ == null)
         {
            return;
         }
         ...
         if(_loc6_.@id.toString().length > 0)
         {
            ...
            if(this.var_407.indexOf(_loc10_) >= 0 && this.var_891)
            {
               param1 = this.var_407.indexOf(_loc10_);
               if(this.var_597[param1] != "")
               {
                  _loc9_ = this.var_721.getAsset(this.var_597[param1]);
                  if(_loc9_ != null && _loc9_.asset != null)
                  {
                     param2.asset = _loc9_.asset.content as BitmapData;
                  }
