package com.sulake.habbo.room.object.visualization.room.mask
{
   ...
   public class PlaneMask
   {
      ...
      private var var_1117:PlaneMaskVisualization = null;
      ...
      protected function getMaskVisualization(param1:int) : PlaneMaskVisualization
      {
         ...
         {
            this.var_1117 = this.var_485.getValue(String(this._sizes[_loc2_])) as PlaneMaskVisualization;
         }
         else
         {
            this.var_1117 = null;
      ...
      public function method_15(param1:Number, param2:IVector3d) : IGraphicAsset
      {
