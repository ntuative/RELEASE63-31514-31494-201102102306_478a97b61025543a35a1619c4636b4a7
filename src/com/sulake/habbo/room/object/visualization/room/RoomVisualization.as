package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualization extends RoomObjectSpriteVisualization
   {
      ...
      public static const const_1579:int = 13421772;
      
      private static const const_953:int = 16777215;
      
      private static const const_952:int = 13421772;
      
      private static const const_954:int = 10066329;
      
      private static const const_955:int = 10066329;
      
      public static const const_1402:int = 16777215;
      
      public static const const_1467:int = 13421772;
      
      public static const const_1604:int = 10066329;
      ...
      private var var_773:Rectangle = null;
      
      private var var_516:RoomPlaneBitmapMaskParser = null;
      
      private var var_1563:String = null;
      ...
      private var var_1180:uint = 16777215;
      
      private var var_2658:int = 255;
      
      private var var_2657:int = 255;
      
      private var var_2660:int = 255;
      ...
      private const const_1986:int = 250;
      
      private var var_1633:int = -1;
      
      private var var_1315:Number = 0.0;
      ...
      public function RoomVisualization()
      {
         ...
         this.var_304["null"] = false;
         this.var_304["null"] = true;
         this.var_304["null"] = true;
         this.var_304["null"] = true;
      }
      ...
      override public function get boundingRectangle() : Rectangle
      {
         ...
         {
            this.var_773 = super.boundingRectangle;
         }
         return new Rectangle(this.var_773.x,this.var_773.y,this.var_773.width,this.var_773.height);
      }
      ...
      protected function initializeRoomPlanes() : void
      {
         ...
         var _loc2_:String = _loc1_.getModel().getString(RoomObjectVariableEnum.const_1028);
         ...
         while(_loc7_ < this._planeParser.planeCount)
         {
            ...
            else if(_loc12_ == RoomPlaneData.const_1647)
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_116,true,_loc11_,_loc6_);
               if(_loc9_.length < 1 || _loc10_.length < 1)
               {
      ...
      override public function update(param1:IRoomGeometry, param2:int, param3:Boolean) : void
      {
         ...
         if(_loc8_ < this._lastUpdateTime + this.const_1986 && !_loc5_ && !_loc7_)
         {
            return;
         }
            ...
            while(_loc9_ < this.var_364.length)
            {
               ...
               if(_loc11_ != null && _loc12_ != null && _loc12_.type != RoomPlane.const_92)
               {
                  if(this.var_1881)
                  {
                     ...
                     _loc14_ = uint((_loc13_ & 255) * this.var_2660 / 255);
                     _loc15_ = uint((_loc13_ >> 8 & 255) * this.var_2657 / 255);
                     _loc16_ = uint((_loc13_ >> 16 & 255) * this.var_2658 / 255);
      ...
      private function updateGeometry(param1:IRoomGeometry) : Boolean
      {
         ...
         if(param1.updateId != this.var_1633)
         {
            this.var_1633 = param1.updateId;
            this.var_773 = null;
            _loc3_ = param1.direction;
            if(_loc3_ != null && (_loc3_.x != this.var_1315 || _loc3_.y != this.var_2293 || _loc3_.z != this.var_2291 || param1.scale != this.var_2295))
            {
               this.var_1315 = _loc3_.x;
               this.var_2293 = _loc3_.y;
               this.var_2291 = _loc3_.z;
               this.var_2295 = param1.scale;
               _loc2_ = true;
            }
         }
         return _loc2_;
      ...
      private function updateMasksAndColors(param1:IRoomObjectModel) : Boolean
      {
         ...
         {
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_1130);
            if(_loc3_ != this.var_2659)
            {
            ...
            if(_loc4_ != this.var_1180)
            {
               this.var_1180 = _loc4_;
               this.var_2660 = this.var_1180 & 255;
               this.var_2657 = this.var_1180 >> 8 & 255;
               this.var_2658 = this.var_1180 >> 16 & 255;
               _loc2_ = true;
            }
      ...
      private function updatePlaneTexturesAndVisibilities(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_161 != param1.getUpdateID())
         {
            _loc2_ = param1.getString(RoomObjectVariableEnum.const_773);
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_668);
            _loc4_ = param1.getString(RoomObjectVariableEnum.const_865);
            this.updatePlaneTextureTypes(_loc3_,_loc2_,_loc4_);
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_672));
            _loc6_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_748));
      ...
      {
         if(param1 != this.var_304["null"] || param2 != this.var_304["null"] || param3 != this.var_304["null"])
         {
            this.var_304["null"] = param1;
            this.var_304["null"] = param2;
            this.var_304["null"] = param3;
            this.var_364 = [];
            this.var_632 = [];
         }
      }
         ...
         while(_loc9_ < _loc6_.length)
         {
            ...
            if(_loc11_ != null)
            {
               ...
               if(_loc12_ != null)
               {
                  ...
                  if(_loc11_.visible != (_loc12_.visible && this.var_304[_loc12_.type]))
                  {
      ...
      private function updateSprite(param1:IRoomObjectSprite, param2:RoomPlane, param3:String, param4:Number) : void
      {
         ...
         param1.assetName = param3 + "_" + this.var_1673;
      }
         ...
         while(_loc8_ < this.var_516.maskCount)
         {
            ...
            if(_loc11_ != null)
            {
               ...
               while(_loc13_ < this.var_124.length)
               {
                  ...
                  if(_loc3_.type == RoomPlane.const_116 || _loc3_.type == RoomPlane.const_92)
                  {
                     if(_loc3_ != null && _loc3_.location != null && _loc3_.normal != null)
                     {
                        ...
                        if(_loc15_ < 0.01)
                        {
                           if(_loc3_.leftSide != null && _loc3_.rightSide != null)
                           {
                              ...
                              if(_loc3_.type == RoomPlane.const_116 || _loc3_.type == RoomPlane.const_92 && _loc12_ == RoomPlaneBitmapMaskData.const_247)
                              {
