package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePlanetSystemVisualization extends AnimatedFurnitureVisualization
   {
      ...
      override protected function updateAnimation(param1:Number) : Array
      {
         var _loc2_:* = null;
         var _loc3_:int = 0;
         if(this.var_260 == null && spriteCount > 0)
         {
         ...
         if(this.var_260 != null)
         {
            ...
            while(_loc3_ < this.var_260.length)
            {
               ...
               _loc2_.update(this._offsetArray,this.var_2654,param1);
               _loc3_++;
            }
      ...
      override protected function method_6(param1:int, param2:int, param3:int) : Number
      {
         if(param3 < this._offsetArray.length)
         {
            return this._offsetArray[param3].z;
         }
         return super.method_6(param1,param2,param3);
      }
      ...
      private function readDefinition() : Boolean
      {
         ...
         var _loc3_:String = _loc2_.getString(RoomObjectVariableEnum.const_1128);
