package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class ShoreMaskCreatorUtility
   {
      ...
      private static const const_1284:int = 3;
      ...
      {
         return param1 + param2 * const_1284;
      }
            ...
            if(param2.getAsset(_loc4_) == null)
            {
               if(param3 != null)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     ...
                     _loc7_ = [const_133,const_75,const_70,const_133,const_75,const_70];
                     _loc8_ = [const_75,const_75,const_75,const_70,const_70,const_70];
                     _loc9_ = null;
                     _loc10_ = 0;
                     if(_loc6_ != null)
                     {
