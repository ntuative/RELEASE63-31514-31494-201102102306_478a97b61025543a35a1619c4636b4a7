package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureWaterAreaVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_1215:String = "shore";
       
      
      private var var_1512:Boolean = true;
      ...
      override public function dispose() : void
      {
         ...
         {
            for each(_loc1_ in this.var_1018)
            {
      ...
      {
         if(this.var_2045 == param1 && this.var_2046 == _direction)
         {
         ...
         while(_loc2_ >= 0)
         {
            if(getSpriteTag(param1,_direction,_loc2_) == const_1215)
            {
               this.var_1511 = _loc2_;
               this.var_2045 = param1;
               this.var_2046 = _direction;
               return this.var_1511;
            }
            _loc2_--;
         }
      ...
      private function getInstanceMask(param1:int) : IGraphicAsset
      {
         ...
         if(_loc3_ != null)
         {
            if(this.var_1018.indexOf(_loc2_) < 0)
            {
      ...
      private function updateBorderData() : void
      {
         ...
         this.var_1512 = false;
         _loc5_ = 0;
         while(_loc5_ < this.var_379.length)
         {
            if(this.var_379[_loc5_] == true)
            {
               this.var_1512 = true;
            }
            _loc5_++;
      ...
      private function updateTopBorder(param1:Array, param2:int) : int
      {
         ...
         while(_loc8_ < _loc3_ - 1)
         {
            if(_loc4_[_loc8_] == false)
            {
               ...
               this.var_542[param2] = ShoreMaskCreatorUtility.getBorderType(_loc6_,_loc7_);
            }
            param2++;
            _loc8_++;
         }
      ...
      private function updateRightBorder(param1:Array, param2:int) : int
      {
         ...
         while(_loc10_ < _loc4_ - 1)
         {
            ...
            if(_loc7_[_loc3_ - 1] == false)
            {
               ...
               this.var_542[param2] = ShoreMaskCreatorUtility.getBorderType(_loc5_,_loc6_);
            }
            param2++;
            _loc10_++;
         }
      ...
      {
         var _loc2_:* = null;
         if(this.var_447 == 0 || this.var_543 == 0)
         {
            ...
            this.var_447 = _loc2_.getNumber(RoomObjectVariableEnum.const_275);
            this.var_543 = _loc2_.getNumber(RoomObjectVariableEnum.const_330);
         }
         this.var_379 = [];
         this.var_542 = [];
         var _loc1_:int = 0;
         while(_loc1_ < this.var_447 * 2 + this.var_543 * 2)
         {
            this.var_379.push(false);
            this.var_542.push(ShoreMaskCreatorUtility.const_75);
            _loc1_++;
         }
      }
      ...
      private function createShoreMask(param1:int, param2:int, param3:Number) : BitmapData
      {
         ...
         return ShoreMaskCreatorUtility.createShoreMask2x2(this.var_68,getSize(param3),this.var_379,this.var_542,assetCollection);
      }
