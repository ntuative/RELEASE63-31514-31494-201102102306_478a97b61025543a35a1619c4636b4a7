package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePlane
   {
      ...
      public function FurniturePlane(param1:IVector3d, param2:IVector3d, param3:IVector3d)
      {
         ...
         this.var_696.assign(param2);
         this.var_697 = new Vector3d();
         this.var_697.assign(param3);
      ...
      public function setRotation(param1:Boolean) : void
      {
         if(param1 != this.var_2292)
         {
            if(!param1)
            {
               this.var_281.assign(this.var_696);
               this.var_282.assign(this.var_697);
            }
            else
            {
               this.var_281.assign(this.var_696);
               this.var_281.mul(this.var_697.length / this.var_696.length);
               this.var_282.assign(this.var_697);
               this.var_282.mul(this.var_696.length / this.var_697.length);
            }
            this.var_1633 = -1;
            this.var_1315 = this.var_1315 - 1;
      ...
      private function getTexture(param1:IRoomGeometry, param2:int) : BitmapData
      {
         ...
         if(this.needsNewTexture(param1))
         {
            ...
            _loc6_ = Number(this.var_282.length * param1.scale);
            if(_loc5_ < 1)
            {
               _loc5_ = 1;
            }
      ...
      public function update(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         var _loc9_:* = null;
         if(param1 == null || this.var_76 == null && this.var_1077 != null || this.var_281 == null || this.var_282 == null || this.var_582 == null)
         {
            return false;
         }
         ...
         if(param1.updateId != this.var_1633)
         {
            ...
            if(_loc4_ != null && (_loc4_.x != this.var_1315 || _loc4_.y != this.var_2293 || _loc4_.z != this.var_2291 || param1.scale != this.var_2295))
            {
               this.var_1315 = _loc4_.x;
               this.var_2293 = _loc4_.y;
               this.var_2291 = _loc4_.z;
               ...
               _loc6_ = param1.getScreenPosition(this.var_1077);
               _loc7_ = _loc6_.z;
               _loc8_ = Math.max(this.var_151.z - _loc7_,this.var_106.z - _loc7_,this.var_82.z - _loc7_,this.var_107.z - _loc7_);
               this.var_2294 = _loc8_;
