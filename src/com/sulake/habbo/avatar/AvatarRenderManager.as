package com.sulake.habbo.avatar
{
   ...
   public class AvatarRenderManager extends Component implements IAvatarRenderManager
   {
      ...
      private const const_1981:String = "hd-99999-99999";
      ...
      private var var_737:PaletteManager;
      ...
      private var var_1766:AvatarFigureContainer;
      ...
      public function AvatarRenderManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_559 = RenderMode.const_1612;
         ...
         this.var_99.add(AvatarType.const_121,_loc4_);
         ...
         this.var_99.add(AvatarType.const_71,_loc4_);
         ...
         this.var_737 = new PaletteManager(param1.assets as AssetLibraryCollection);
      ...
      private function onAllModulesReadyAndRunning(param1:Event) : void
      {
         ...
         this.var_296.init();
         this.var_737.init();
         _loc2_ = this.var_99.getValue(AvatarType.const_121) as AvatarStructure;
         if(_loc2_)
         {
         ...
         _loc2_ = this.var_99.getValue(AvatarType.const_71) as AvatarStructure;
         if(_loc2_)
         {
            _loc2_.resetPartOffsets(context.assets);
         }
      ...
      private function onHabboConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(param2 != null)
         {
            ...
            _loc3_ = this.var_99.getValue(AvatarType.const_121) as AvatarStructure;
            if(_loc3_ != null)
            {
      ...
      private function checkIfReady() : void
      {
         if(!this.var_905)
         {
            if(this.var_2538 && this.var_2537 && this.var_2539)
            {
      ...
      {
         var _loc5_:AvatarStructure = this.var_99.getValue(AvatarType.const_121) as AvatarStructure;
         if(_loc5_ == null)
         {
            return null;
         }
         ...
         if(!this.var_1766)
         {
            this.var_1766 = new AvatarFigureContainer(this.const_1981);
         }
         this.var_218.loadFigureSetData(_loc6_,param4);
         return new PlaceholderAvatarImage(_loc5_,this._aliasCollection,this.var_1766,param2);
      }
      ...
      public function createPetImage(param1:int, param2:int, param3:uint, param4:String, param5:IPetImageListener = null) : IAvatarImage
      {
         var _loc9_:* = null;
         var _loc6_:* = false;
         if(this.mode != RenderMode.const_1642)
         {
            _loc6_ = !this.var_296.assetsReady(param1,param4);
         }
         var _loc7_:String = this.var_296.createPetFigureString(param1,param2,param3);
         var _loc8_:AvatarStructure = this.var_99.getValue(AvatarType.const_71) as AvatarStructure;
         if(_loc8_ == null)
         {
            return null;
         }
      ...
      public function resetPetData() : void
      {
         ...
         var _loc2_:AvatarStructure = this.var_99.getValue(AvatarType.const_71);
      ...
      {
         var _loc3_:AvatarStructure = this.var_99.getValue(AvatarType.const_121) as AvatarStructure;
      ...
      public function injectFigureData(param1:String, param2:XML) : void
      {
         ...
         switch(param1)
         {
            ...
            case AvatarType.const_71:
               _loc3_ = this.var_99.getValue(AvatarType.const_71) as AvatarStructure;
               break;
            default:
         ...
         if(_loc6_)
         {
            ...
            for each(_loc8_ in _loc6_)
            {
               if(!param1.hasPartType(_loc8_))
               {
                  ...
                  if(_loc9_)
                  {
                     param1.method_3(_loc8_,_loc9_.id,[0]);
                     _loc4_ = true;
                  }
               }
               else
               {
                  ...
                  if(!_loc11_)
                  {
                     ...
                     if(_loc12_)
                     {
                        param1.method_3(_loc8_,_loc12_.id,[0]);
                        _loc4_ = true;
                     }
                  }
               }
