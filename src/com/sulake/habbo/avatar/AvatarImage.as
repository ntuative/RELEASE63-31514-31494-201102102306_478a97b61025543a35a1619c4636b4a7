package com.sulake.habbo.avatar
{
   ...
   public class AvatarImage implements IAvatarImage, IDisposable
   {
      ...
      private static const const_1220:String = "Default";
      
      private static const const_1219:int = 2;
      
      private static const const_1218:String = AvatarSetType.const_34;
      ...
      protected var var_683:Array;
      
      protected var _assets:AssetAliasCollection;
      
      protected var var_252:AvatarImageCache;
      
      protected var var_550:AvatarFigureContainer;
      
      protected var var_525:IAvatarDataContainer;
      ...
      protected var var_1219:Boolean = false;
      ...
      private var var_2058:String = null;
      ...
      public function AvatarImage(param1:AvatarStructure, param2:AssetAliasCollection, param3:AvatarFigureContainer, param4:String)
      {
         ...
         this.setDirection(const_1218,const_1219);
         this.var_311 = new Array();
         this.var_824 = new ActiveActionData(AvatarAction.const_343);
         this.var_824.definition = this._structure.getActionDefinition(const_1220);
         this.resetActions();
      ...
      {
         return this._structure.getPartColor(this.var_550,param1);
      }
      
      public function setDirection(param1:String, param2:int) : void
      {
         param2 += this.var_1515;
         if(param2 < AvatarDirectionAngle.const_1202)
         {
      ...
      {
         return this._structure.getBodyPartData(param1.animation.id,this.var_545,param1.id);
      }
      ...
      private function getFullImageCacheKey() : String
      {
         ...
         if(this.var_233.length == 1 && this.var_85 == this.var_1963)
         {
            return this.var_85 + this.var_449 + this.var_545 % 4;
         }
         if(this.var_233.length == 2)
         {
            for each(_loc1_ in this.var_233)
            {
               ...
               {
                  return this.var_85 + this.var_449 + 0;
               }
               if(_loc1_.actionType == "fx" && (_loc1_.actionParameter == "38" || _loc1_.actionParameter == "39"))
               {
                  _loc2_ = this.var_545 % 11;
                  return this.var_85 + "_" + this.var_1963 + this.var_449 + _loc2_;
               }
            }
         }
         return null;
      ...
      {
         if(param3 != this.var_2060 || param2 != this.var_2058 || param1 != this.var_2059)
         {
            this.var_2060 = param3;
            this.var_2058 = param2;
            this.var_2059 = param1;
            this.var_1516 = this._structure.getBodyParts(param1,param2,param3);
         }
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         if(this.var_1219 || this.var_43 == null || (this.var_43.width != _loc5_.width || this.var_43.height != _loc5_.height))
         {
            if(this.var_43 != null && !this.var_1219)
            {
               this.var_43.dispose();
            }
         ...
         while(_loc12_ >= 0)
         {
            ...
            _loc9_ = _loc4_.getImageContainer(_loc8_,this.var_545);
         ...
         {
            if(this.var_525.paletteIsGrayscale)
            {
               ...
               this.var_43 = _loc13_;
               this.var_43.paletteMap(this.var_43,this.var_43.rect,new Point(0,0),this.var_525.reds,[],[]);
            }
            else
            {
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         while(_loc12_ >= 0)
         {
            ...
            _loc8_ = _loc2_.getImageContainer(_loc7_,this.var_545);
            if(_loc8_ != null)
            {
               _loc9_ = _loc8_.image;
               if(_loc9_ == null)
      ...
      protected function addActionData(param1:String, param2:String = "") : void
      {
         ...
         this.var_311.push(new ActiveActionData(param1,param2,this.var_545));
      }
      ...
      private function resetActions() : Boolean
      {
         ...
         this.var_267 = this.var_824;
         this.var_267.definition = this.var_824.definition;
         this.resetBodyPartCache(this.var_824);
         return true;
      }
      ...
      private function isHeadTurnPreventedByAction() : Boolean
      {
         ...
         for each(_loc3_ in this.var_233)
         {
      ...
      private function sortActions() : Boolean
      {
         ...
         var _loc1_:Boolean = false;
         this.var_449 = "";
         this.var_233 = this._structure.sortActions(this.var_311);
         if(this.var_233 == null)
         {
            this.var_683 = new Array(0,0,0);
            if(this.var_1261 != "")
            {
               _loc1_ = true;
               this.var_1261 = "";
         ...
         {
            this.var_683 = this._structure.getCanvasOffsets(this.var_233,this._scale,this.var_85);
            for each(_loc4_ in this.var_233)
            {
               this.var_449 += _loc4_.actionType + _loc4_.actionParameter;
               if(_loc4_.actionType == AvatarAction.const_274)
               {
                  _loc5_ = parseInt(_loc4_.actionParameter);
                  if(this.var_1259 != _loc5_)
                  {
                     _loc2_ = true;
                  }
                  this.var_1259 = _loc5_;
                  _loc3_ = true;
               }
            }
            if(!_loc3_)
            ...
            if(this.var_1261 != this.var_449)
            {
               _loc1_ = true;
               this.var_1261 = this.var_449;
            }
         }
         this.var_1260 = true;
         return _loc1_;
      ...
      private function setActionsToParts() : void
      {
         ...
         for each(_loc1_ in this.var_233)
         {
            if(!(!_loc1_ || !_loc1_.definition))
            {
               ...
               {
                  this.var_816 = _loc1_.definition.isAnimated(_loc1_.actionParameter);
                  _loc2_ = this._structure.getAnimation(_loc1_.definition.state + "." + _loc1_.actionParameter);
                  if(_loc2_ != null)
                  {
                     ...
                     {
                        this.var_1515 = _loc2_.directionData.offset;
                     }
                     if(_loc2_.hasAvatarData())
                     {
                        this.var_525 = _loc2_.avatarData;
                     }
                  }
               }
               if(_loc1_.actionType == AvatarAction.const_303 || _loc1_.actionType == AvatarAction.const_266 || _loc1_.actionType == AvatarAction.const_357)
               {
                  this.var_816 = true;
               }
            }
