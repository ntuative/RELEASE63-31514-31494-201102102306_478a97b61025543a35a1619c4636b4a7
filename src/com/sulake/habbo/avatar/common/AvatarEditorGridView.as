package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridView
   {
      ...
      public function initFromList() : void
      {
         ...
         var _loc5_:* = null;
         var _loc6_:* = null;
         var _loc1_:CategoryData = this.var_65.getCategoryData(this.var_1257);
         if(!_loc1_)
         {
            return;
         }
      ...
      public function method_3(param1:int, param2:IWindowContainer) : void
      {
      ...
      private function partEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.const_41)
         {
            ...
            this.var_65.selectPart(this.var_1257,_loc3_);
         }
      }
         ...
         if(param1.type == WindowMouseEvent.const_41)
         {
            ...
            while(_loc7_ < this.const_1341)
            {
               if(this.var_448.length > _loc7_)
               {
                  ...
                  if(_loc5_ > -1)
                  {
                     this.var_65.selectColor(this.var_1257,_loc5_,_loc7_);
                     return;
                  }
               }
               _loc7_++;
