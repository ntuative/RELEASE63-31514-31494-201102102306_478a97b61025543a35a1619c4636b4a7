package com.sulake.habbo.avatar.common
{
   ...
   public class CategoryData
   {
      ...
      private const const_1990:int = 2;
      
      private var _parts:Array;
      
      private var var_259:Array;
      
      private var var_948:int = -1;
      ...
      public function selectPartIndex(param1:int) : AvatarEditorGridPartItem
      {
         ...
         if(this.var_948 >= 0 && this._parts.length > this.var_948)
         {
            _loc2_ = this._parts[this.var_948];
            if(_loc2_)
            {
               _loc2_.isSelected = false;
            }
      ...
      {
         return this._parts[this.var_948] as AvatarEditorGridPartItem;
      }
