package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridPartItem implements IAvatarImageListener
   {
      ...
      private var var_690:IFigurePartSet;
      ...
      private var var_580:Rectangle;
      
      private var var_1625:int = 0;
      
      private var var_396:IAvatarRenderManager;
      
      private var var_730:Boolean;
      
      private var var_1624:BitmapData;
      
      private const const_1942:int = 13421772;
      ...
      public function AvatarEditorGridPartItem(param1:IWindowContainer, param2:IAvatarEditorCategoryModel, param3:IFigurePartSet, param4:Array, param5:Boolean = true)
      {
         ...
         if(param3 == null)
         {
            this.var_648 = new BitmapData(1,1,true,16777215);
         }
         if(param3 != null)
         {
            _loc7_ = param3.parts;
            ...
            {
               this.var_1625 = Math.max(this.var_1625,_loc6_.colorLayerIndex);
            }
         }
         this.var_396 = this.var_65.controller.avatarRenderManager;
      ...
      private function updateThumbVisualization() : void
      {
         ...
         if(_loc1_)
         {
            if(this.var_648 != null && !this.var_1626)
            {
               _loc3_ = this.var_648;
            }
            else
            ...
            if(this.var_690)
            {
               switch(this.var_690.clubLevel)
               {
                  ...
                  case HabboClubLevelEnum.const_55:
                     _loc2_.style = HabboIconType.const_744;
               }
            }
            else
            {
         ...
         if(this.isSelected)
         {
            this._window.color = this.const_1942;
         }
         else
         {
      ...
      private function analyzePartLayers() : Boolean
      {
         ...
         var _loc1_:IAvatarFigureContainer = this.var_396.createFigureContainer(this.partSet.type + "-" + this.partSet.id);
         Logger.log("QUERYING SET:" + this.partSet.type + "-" + this.partSet.id);
         if(!this.var_396.isFigureReady(_loc1_))
         {
            this.var_396.downloadFigure(_loc1_,this);
            return false;
         }
         var _loc6_:int = 0;
         ...
         for each(_loc2_ in this.partSet.parts)
         {
            if(_loc7_)
            {
               _loc3_ = "undefined_undefined_" + _loc2_.type + "_" + _loc2_.id + "_" + this.const_324[_loc6_] + "_" + FigureData.const_136;
               _loc4_ = this.var_396.getAssetByName(_loc3_) as BitmapDataAsset;
            }
            else
            {
               _loc6_ = 0;
      ...
      private function renderThumb() : BitmapData
      {
         ...
         if(this.var_580 == null)
         {
            if(!this.analyzePartLayers())
            {
               if(!this.var_1624)
               {
                  ...
                  this.var_1624 = _loc9_.content as BitmapData;
               }
         ...
         _loc1_ = new BitmapData(this.var_580.width,this.var_580.height,true,16777215);
         var _loc6_:int = 0;
         var _loc7_:Boolean = false;
         ...
         for each(_loc2_ in _loc8_)
         {
            ...
            if(_loc4_)
            {
               ...
               _loc10_ = -1 * _loc4_.offset.x - this.var_580.x;
               _loc11_ = -1 * _loc4_.offset.y - this.var_580.y;
               if(this.var_1626 && _loc2_.colorLayerIndex > 0)
               {
