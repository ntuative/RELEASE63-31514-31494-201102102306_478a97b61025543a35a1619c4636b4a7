package com.sulake.habbo.avatar
{
   ...
   public class AvatarStructure extends EventDispatcher
   {
      ...
      private var var_396:AvatarRenderManager;
      ...
      private var var_824:ActionDefinition;
      
      private var var_481:String;
      
      private var var_1342:PartOffsetData;
      ...
      public function AvatarStructure(param1:AvatarRenderManager, param2:String, param3:PartOffsetData)
      {
         ...
         this.var_401 = new PartSetsData();
         this.var_280 = new AnimationData();
         this.var_705 = new AnimationManager();
         this.var_481 = param2;
      ...
      {
         this.var_1342.loadOffsets(param1);
      }
      ...
      public function initActions(param1:IAssetLibrary, param2:XML) : void
      {
         ...
         this.var_870 = new AvatarActionManager(param1,this.var_481,param2);
         this.var_824 = this.var_870.getDefaultAction();
      }
      ...
      public function initPartSets(param1:XML) : Boolean
      {
         ...
         if(this.var_401.parse(param1))
         {
            if(this.var_481 == AvatarType.const_121)
            {
               this.var_401.getPartDefinition("ri").appendToFigure = true;
               this.var_401.getPartDefinition("li").appendToFigure = true;
            }
            return true;
         }
         return false;
      ...
      public function registerAnimations(param1:AssetLibraryCollection, param2:String = "fx", param3:int = 200) : void
      {
         ...
         while(_loc5_ < param3)
         {
            if(param1.hasAsset(param2 + _loc5_))
            {
               ...
               this.var_705.registerAnimation(this,_loc4_);
            }
            _loc5_++;
         }
      }
      ...
      {
         return this.var_705.getLayerData(param1,param2,param3) as AnimationLayerData;
      }
      
      public function getAnimation(param1:String) : Animation
      {
         return this.var_705.getAnimation(param1) as Animation;
      }
      ...
      {
         if(!this.var_590[param1])
         {
            this.var_590[param1] = new Dictionary();
         }
         if(this.var_590[param1][param2])
         {
            return this.var_590[param1][param2];
         }
         this.var_590[param1][param2] = this.var_340.getMandatorySetTypeIds(param1,param2);
         return this.var_590[param1][param2];
      }
      ...
      public function getActiveBodyPartIds(param1:IActiveActionData) : Array
      {
         ...
         if(param1.definition.isAnimation)
         {
            ...
            _loc7_ = this.var_705.getAnimation(_loc6_) as Animation;
            if(_loc7_ != null)
            {
               ...
               if(_loc7_.hasAddData())
               {
                  ...
                  for each(_loc12_ in _loc7_.addData)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        _loc9_ = this.var_401.addPartDefinition(_loc11_);
         ...
         {
            _loc2_ = this.var_401.getActiveParts(param1.definition);
      ...
      public function getParts(param1:String, param2:IAvatarFigureContainer, param3:IActiveActionData, param4:String, param5:int, param6:Array, param7:Dictionary = null) : Array
      {
         ...
         var _loc8_:Array = this.var_401.getActiveParts(param3.definition);
         ...
         if(param3.definition.isAnimation)
         {
            ...
            _loc9_ = this.var_705.getAnimation(_loc23_) as Animation;
            if(_loc9_ != null)
            {
                  ...
                  if(_loc31_)
                  {
                     ...
                     for each(_loc32_ in _loc31_.parts)
                     {
                        if(_loc15_.indexOf(_loc32_.type) > -1)
                        {
                           ...
                           {
                              _loc33_ = this.var_824;
                           }
                           _loc12_ = this.var_401.getPartDefinition(_loc32_.type);
         ...
         for each(_loc11_ in _loc15_)
         {
            ...
            if(!_loc37_)
            {
               ...
               if(_loc8_.indexOf(_loc11_) > -1)
               {
                  ...
                  {
                     _loc12_ = this.var_401.getPartDefinition(_loc11_);
                     _loc42_ = false;
                     _loc43_ = 1;
      ...
      {
         return this.var_1342.getOffset(param1,param2,param3,param4,param5,param6);
      }
