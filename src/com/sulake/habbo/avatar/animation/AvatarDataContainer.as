package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      {
         super();
         this.var_1920 = parseInt(param1.@ink);
         var _loc2_:String = String(param1.@foreground);
         _loc2_ = _loc2_.replace("#","");
         var _loc3_:String = String(param1.@background);
         _loc3_ = _loc3_.replace("#","");
         this.var_2699 = parseInt(_loc2_,16);
         this.var_2700 = parseInt(_loc3_,16);
         ...
         this.var_1866 = new ColorTransform(this.var_1912,this.var_1913,this.var_1911,this._alphaMultiplier);
         this.var_1205 = this.generatePaletteMapForGrayscale(this.var_2700,this.var_2699);
      }
