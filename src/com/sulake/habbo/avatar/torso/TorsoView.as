   ...
   public class TorsoView extends CategoryBaseView implements IAvatarEditorCategoryView
   {
      ...
      override public function init() : void
      {
         ...
         if(!var_36)
         {
            ...
            var_36["null"] = new AvatarEditorGridView(var_65,FigureData.const_208,_windowManager,_assetLibrary);
            var_36["null"] = new AvatarEditorGridView(var_65,FigureData.const_193,_windowManager,_assetLibrary);
            var_36["null"] = new AvatarEditorGridView(var_65,FigureData.CHEST_ACCESSORIES,_windowManager,_assetLibrary);
            var_36["null"] = new AvatarEditorGridView(var_65,FigureData.const_234,_windowManager,_assetLibrary);
         }
         else
         {
         ...
         if(var_65 && var_137 == "")
         {
            var_65.switchCategory(FigureData.const_193);
         }
      }
