package com.sulake.habbo.avatar.pets
{
   ...
   public class PetDataManager implements IPetDataManager
   {
      ...
      {
         if(param1 == null || this.var_518 == null)
         {
            return;
         }
         var _loc2_:int = this.var_518.indexOf(param1);
         if(_loc2_ != -1)
         {
            this.var_518.splice(_loc2_,1);
         }
      }
      ...
      {
         var _loc1_:* = null;
         while(this.var_518.length > 0)
         {
            _loc1_ = this.var_518.pop() as IPetDataListener;
      ...
      public function assetsReady(param1:int, param2:String, param3:IPetDataListener = null) : Boolean
      {
         ...
         {
            if(this.var_1444.indexOf(_loc6_) == -1)
            {
               _loc7_ = false;
               if(this.var_634.getValue(_loc6_) == null)
               {
                  ...
                  if(param3 != null && this.var_518.indexOf(param3) == -1)
                  {
                     this.var_518.push(param3);
                  }
               }
            }
         }
