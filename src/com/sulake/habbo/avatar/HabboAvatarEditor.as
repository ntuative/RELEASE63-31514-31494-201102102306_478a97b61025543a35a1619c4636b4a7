package com.sulake.habbo.avatar
{
   ...
   public class HabboAvatarEditor extends Component implements IHabboAvatarEditor
   {
      ...
      private static const const_1340:String = "hr-100.hd-180-7.ch-215-66.lg-270-79.sh-305-62.ha-1002-70.wa-2007";
      
      private static const const_1339:String = "hr-515-33.hd-600-1.ch-635-70.lg-716-66-62.sh-735-68";
      ...
      private var var_1189:AvatarEditorHandler;
      ...
      private var var_957:IFigureData;
      ...
      private function init(param1:Array = null) : void
      {
         ...
         if(!this.var_184)
         {
            ...
            this.var_637["null"] = new FigureData(this);
            this.var_637["null"] = new FigureData(this);
            _loc2_ = this.var_637["null"];
            _loc3_ = this.var_637["null"];
            _loc2_.loadAvatarData(const_1340,FigureData.const_78);
            _loc3_.loadAvatarData(const_1339,FigureData.FEMALE);
            this.var_94 = new Map();
            this.var_522 = new Map();
            this.var_94.add(AvatarEditorFigureCategory.const_623,new BodyModel(this));
            this.var_94.add(AvatarEditorFigureCategory.const_45,new HeadModel(this));
            this.var_94.add(AvatarEditorFigureCategory.const_244,new TorsoModel(this));
            this.var_94.add(AvatarEditorFigureCategory.const_690,new LegsModel(this));
            ...
            this.var_522.add(AvatarEditorSideCategory.const_101,new WardrobeModel(this));
            this.var_522.add(AvatarEditorSideCategory.const_537,new ClubPromoModel(this));
            this.var_184 = true;
         }
      }
      ...
      public function loadAvatarInEditor(param1:String, param2:String, param3:int = 0) : void
      {
         ...
         var _loc4_:FigureData = this.var_637[param2];
         if(_loc4_ == null)
         {
            return;
         }
      ...
      public function getFigureSetType(param1:String) : ISetType
      {
         ...
         return this.var_957.getSetType(param1);
      }
      ...
      public function getPalette(param1:int) : IPalette
      {
         ...
         return this.var_957.getPalette(param1);
      }
      ...
      public function openEditor(param1:IWindowContainer = null, param2:IHabboAvatarEditorDataSaver = null, param3:Array = null, param4:Boolean = false, param5:Boolean = true) : Boolean
      {
         ...
         {
            this.toggleAvatarEditorPage(AvatarEditorFigureCategory.const_623);
         }
      ...
      private function onAvatarRenderManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         (this.var_521 as Component).events.addEventListener(AvatarRenderEvent.AVATAR_RENDER_READY,this.onAvatarRendererReady);
      }
      
      private function onAvatarRendererReady(param1:Event = null) : void
      {
         this.var_957 = this.var_521.getFigureData(AvatarType.const_121);
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1189 = new AvatarEditorHandler(this,this._communication);
      }
      ...
      {
         return this.var_637[this.var_812];
      }
      ...
      public function saveCurrentSelection() : void
      {
         ...
         if(this.var_1446 != null)
         {
            ...
            this.var_1446.saveFigure(_loc1_,_loc2_);
         }
      }
      ...
      public function generateDataContent(param1:IAvatarEditorCategoryModel, param2:String) : CategoryData
      {
         ...
         if(_loc8_ != null)
         {
            ...
            {
               _loc20_ = 2;
               _loc14_ = this.var_521.getMandatoryAvatarPartSetIds(this.gender,_loc20_);
            }
            else
            {
               _loc14_ = this.var_521.getMandatoryAvatarPartSetIds(this.gender,this.clubMemberLevel);
            }
            ...
            if(_loc15_)
            {
               ...
               if(_loc21_)
               {
                  ...
                  _loc7_ = new AvatarEditorGridPartItem(AvatarEditorView.var_1215.clone() as IWindowContainer,param1,null,null,false);
            ...
            {
               _loc23_ = false;
               if(_loc6_.gender == FigureData.const_1556)
               {
                  _loc23_ = true;
               }
               ...
               {
                  _loc7_ = new AvatarEditorGridPartItem(AvatarEditorView.var_1215.clone() as IWindowContainer,param1,_loc6_,_loc11_,_loc16_);
                  _loc3_.push(_loc7_);
               }
            }
         }
      ...
      public function get wardrobe() : WardrobeModel
      {
         ...
         return this.var_522.getValue(AvatarEditorSideCategory.const_101);
      }
