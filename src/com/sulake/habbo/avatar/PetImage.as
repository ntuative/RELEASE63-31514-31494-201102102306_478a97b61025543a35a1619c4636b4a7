package com.sulake.habbo.avatar
{
   ...
   public class PetImage implements IAvatarImage, IDisposable
   {
      ...
      private var var_550:AvatarFigureContainer;
      
      private var var_546:Boolean;
      
      private var var_194:Array;
      
      private var var_525:IAvatarDataContainer;
      ...
      public function PetImage(param1:AvatarStructure, param2:AssetAliasCollection, param3:String, param4:String)
      {
         ...
         this.var_550 = new AvatarFigureContainer(param3);
         var _loc5_:int = this.var_550.getPartSetId("pbd");
         this.solvePetAvatarTypeAndBreed(_loc5_);
         this.var_1277 = this.var_1276;
      ...
      public function setDirection(param1:String, param2:int) : void
      {
         ...
         if(param1 == AvatarSetType.const_45)
         {
            ...
            _loc3_ = this._structure.renderManager.petDataManager.getPetData(this.var_1277);
            if(_loc3_ != null)
            {
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         while(_loc7_ >= 0)
         {
            ...
            _loc9_ = _loc3_.getImageContainer(_loc8_,this.var_545);
            if(_loc9_ && _loc9_.image && _loc9_.regPoint)
            {
               ...
               _loc15_ = this._structure.getParts(_loc8_,this.var_550,_loc13_,"pet",_loc12_.getDirection(),[]);
               _loc16_ = this.var_1277 < 3;
               ...
               {
                  _loc18_ = _loc15_[0];
                  _loc19_ = _loc18_.getFrameIndex(this.var_545);
                  _loc20_ = this.var_85;
                  _loc21_ = 1;
                  switch(this.var_85)
                  {
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         while(_loc7_ >= 0)
         {
            ...
            _loc10_ = _loc2_.getImageContainer(_loc9_,this.var_545);
            if(_loc10_ != null)
            {
               ...
               _loc16_ = this._structure.getParts(_loc9_,this.var_550,_loc14_,"pet",_loc13_.getDirection(),[]);
               _loc17_ = 32;
               if(this._scale == AvatarScaleType.const_87)
               {
                  _loc17_ = 6;
               ...
               {
                  _loc19_ = _loc16_[0];
                  _loc20_ = _loc19_.getFrameIndex(this.var_545);
                  _loc21_ = this.var_85;
                  _loc22_ = 1;
                  switch(this.var_85)
                  {
      ...
      public function appendAction(param1:String, ... rest) : Boolean
      {
         ...
         this.var_449 = this.var_449 + param1 + _loc3_;
         switch(param1)
         {
            case AvatarAction.const_356:
               switch(_loc3_)
               {
                  ...
                  case AvatarAction.const_1614:
                  case AvatarAction.const_1550:
                  case AvatarAction.const_987:
                  case AvatarAction.const_1185:
                  case AvatarAction.const_1630:
                  case AvatarAction.const_1593:
      ...
      private function addActionData(param1:String, param2:String = "") : void
      {
         ...
         this.var_311.push(new ActiveActionData(param1,param2));
      }
      ...
      private function resetActions() : Boolean
      {
         ...
         this.setActionToParts(this.var_824);
         this.getCache().resetBodyPartCache(this.var_824);
         return true;
      }
      ...
      private function sortActions() : void
      {
         ...
         this.var_1275 = this._structure.sortActions(this.var_311);
         ...
         {
            this.var_683 = this._structure.getCanvasOffsets(this.var_1275,this._scale,this.var_85);
         }
      }
      ...
      private function setActionsToParts() : void
      {
         ...
         for each(_loc1_ in this.var_1275)
         {
            if(!(!_loc1_ || !_loc1_.definition))
            {
               ...
               if(_loc1_.actionType == AvatarAction.const_357)
               {
                  this.var_816 = true;
               }
         ...
         if(_loc2_ != null)
         {
            ...
            if(_loc3_ != null)
            {
               for each(_loc4_ in _loc3_.parts)
               {
                  if(_loc4_.type == "pbd")
                  {
                     this.var_1276 = _loc4_.id;
                     this.var_1544 = _loc4_.breed;
                     break;
                  }
               }
            }
