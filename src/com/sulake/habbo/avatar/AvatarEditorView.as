package com.sulake.habbo.avatar
{
   ...
   public class AvatarEditorView
   {
      ...
      public static var var_1960:int = 6710886;
      ...
      private var var_2559:Boolean = true;
      ...
      public function AvatarEditorView(param1:HabboAvatarEditor, param2:IHabboWindowManager, param3:IHabboCatalog, param4:Array, param5:Boolean)
      {
         ...
         var _loc8_:* = null;
         this.var_1140 = [];
         this.var_1317 = [AvatarEditorFigureCategory.const_623,AvatarEditorFigureCategory.const_45,AvatarEditorFigureCategory.const_244,AvatarEditorFigureCategory.const_690,AvatarEditorFigureCategory.HOTLOOKS,AvatarEditorFigureCategory.const_101];
         super();
         ...
         if(var_1215 == null)
         {
            ...
            var_1215 = this._controller.windowManager.buildFromXML(_loc7_.content as XML) as IWindowContainer;
         }
         if(var_1473 == null)
         {
         ...
         if(param4 == null)
         {
            param4 = this.var_1317;
         }
         for each(_loc6_ in param4)
         {
            this.var_1140.push(_loc6_);
         }
      ...
      public function validateAvailableCategories(param1:Array) : Boolean
      {
         ...
         if(param1 == null)
         {
            return this.validateAvailableCategories(this.var_1317);
         }
         if(param1.length != this.var_1140.length)
         {
            return false;
         }
         for each(_loc2_ in param1)
         {
            if(this.var_1140.indexOf(_loc2_) < 0)
            {
               return false;
            }
         }
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         {
            this.var_2559 = this.canChangeOutfit();
            this.var_419.stop();
            if(this._window)
            {
      ...
      private function createWindow(param1:Boolean) : void
      {
         ...
         while(_loc2_ >= 0)
         {
            ...
            if(_loc4_ != null && this.var_1140.indexOf(_loc4_.name) < 0)
            {
      ...
      private function attachImages() : void
      {
         ...
         var _loc1_:Array = this.var_1317;
      ...
      public function update() : void
      {
         ...
         if(this._controller.sessionData && this._controller.sessionData.hasUserRight("fuse_use_wardrobe") && (this.var_1791 == AvatarEditorSideCategory.const_101 || this.var_2557))
         {
         ...
         this.setViewToCategory(this.var_330);
      }
      ...
      {
         if(this.var_1791 == AvatarEditorSideCategory.const_101)
         {
            this.var_2557 = false;
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         this.var_330 = param1;
         this.var_496.setSelected(this.var_496.getSelectableByName(param1));
