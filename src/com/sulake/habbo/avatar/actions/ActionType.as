package com.sulake.habbo.avatar.actions
{
   public class ActionType
   {
      ...
      public function ActionType(param1:XML)
      {
         ...
         this._preventHeadTurn = String(param1.@preventheadturn) == "HabboFriendListCom_opened_to_web_popup_xml";
         ...
         {
            this.var_1575 = _loc3_ == "HabboFriendListCom_opened_to_web_popup_xml";
         }
      }
