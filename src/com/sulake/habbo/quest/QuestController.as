package com.sulake.habbo.quest
{
   ...
   public class QuestController implements IDisposable
   {
      ...
      private var var_299:QuestCampaign;
      ...
      public function activateQuest(param1:Quest) : void
      {
         if(param1)
         {
            this.var_139.communication.getHabboMainConnection(null).send(new ActivateQuestMessageComposer(param1.id));
         }
      }
      ...
      public function openCampaign(param1:String, param2:int, param3:Array) : void
      {
         ...
         this.var_299 = _loc4_;
         this.var_299.openCampaign(param3);
         this.prepareWindow();
         this.attachCampaign();
         if(this.var_559 == MODE_TABS)
         {
      ...
      private function attachCampaign() : void
      {
         ...
         this.var_1141.addChild(this.var_299.window);
         var _loc1_:String = "quest_" + this.var_299.code;
      ...
      private function prepareWindow() : void
      {
         ...
         this._window = IFrameWindow(this.var_139.getXmlWindow(_loc1_));
         this._window.findChildByTag("close").procedure = this.onWindowClose;
         this._window.center();
         this.var_1141 = this._window.findChildByName("content") as IWindowContainer;
      }
      ...
      private function refreshTabs() : void
      {
         ...
         for each(_loc4_ in this.var_158.getKeys())
         {
            ...
            if(!_loc2_)
            {
               _loc2_ = this.var_139.windowManager.createWindow("tab_" + _loc4_,_loc4_,WindowType.const_557) as ITabButtonWindow;
      ...
      private function onTabSelect(param1:WindowEvent, param2:IWindow = null) : void
      {
         ...
         this.var_139.getQuestCampaign(param2.caption);
      }
   }
}
