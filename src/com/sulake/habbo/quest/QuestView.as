package com.sulake.habbo.quest
{
   ...
   public class QuestView implements IGetImageListener, IDisposable
   {
      ...
      private var var_1745:IScrollableListWindow;
      ...
      private function createView() : void
      {
         switch(this.var_92.type)
         {
            ...
            case QuestTypeEnum.FIND_HIDDEN_STUFF:
               ...
               this.var_1745 = this.find("quest.content.itemlist") as IScrollableListWindow;
               break;
      ...
      private function localize() : void
      {
         ...
         {
            _loc33_ = this.var_63.controller.questEngine.sessionDataManager.getFloorItemDataByName(this.var_92.roomItemTypeName);
            if(_loc33_)
            {
               _loc34_ = this.var_63.controller.questEngine.roomEngine.getFurnitureImage(_loc33_.id,new Vector3d(90,0,0),64,this);
               this.var_1744 = _loc34_.id;
         ...
         switch(this.var_92.status)
         {
            ...
            case QuestStatusEnum.const_173:
               ...
               _loc19_ = 4290822336;
               break;
            case QuestStatusEnum.const_867:
