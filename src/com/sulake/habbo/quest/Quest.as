package com.sulake.habbo.quest
{
   ...
   public class Quest implements IDisposable
   {
      ...
      private var var_2165:uint = 2;
      
      private var var_2166:uint = 0;
      
      private var var_830:IWindow;
      ...
      public function update(param1:QuestMessageData) : void
      {
         ...
         this.var_1681 = param1.roomItemTypeName;
         this.var_1683 = param1.rewardCurrencyAmount;
         this.var_1583 = new Date();
         this.var_1583.setTime(param1.endDateTimeStamp);
      ...
      private function itemGridEventProc(param1:Event, param2:IWindow = null) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            if(!this.var_188)
            {
               this.var_830.style = this.var_2166;
            }
         }
         else if(param1.type == WindowMouseEvent.const_25)
         {
            if(!this.var_188)
            {
               this.var_830.style = this.var_2165;
            }
         }
      }
