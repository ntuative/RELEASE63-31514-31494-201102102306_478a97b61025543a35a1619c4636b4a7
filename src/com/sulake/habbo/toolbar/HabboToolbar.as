package com.sulake.habbo.toolbar
{
   ...
   public class HabboToolbar extends Component implements IHabboToolbar
   {
      ...
      private var var_1246:LogoutController;
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         if(this._config && this._config.getKey("client.logout.enabled","false") == "HabboFriendListCom_opened_to_web_popup_xml")
         {
            this.var_1246 = new LogoutController(this._windowManager,this._assetLibrary,events);
         }
         if(this._view == null)
         {
            return;
         ...
         events.addEventListener(HabboToolbarSetIconEvent.const_997,this.onSetToolbarIconBitmapEvent);
         ...
         events.addEventListener(HabboToolbarShowMenuEvent.const_471,this.onAnimateWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_1015,this.onDisplayWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_1054,this.onHideWindowEvent);
         this._state = true;
