package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarBarMenuAnimator
   {
      ...
      private static const const_1226:Number = 25;
      
      private static const const_1223:Number = 90;
      
      private static const const_900:int = 50;
      
      private static const const_1228:int = 50;
       
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_1272:ToolbarView;
      ...
      public function ToolbarBarMenuAnimator(param1:IHabboWindowManager, param2:ToolbarView)
      {
         ...
         this.var_553 = new Object();
         this.var_554 = new Array();
         this.var_552 = new Array();
         super();
         this._windowManager = param1;
         this.var_1272 = param2;
         this.var_665 = new Timer(const_1226);
         this.var_665.addEventListener(TimerEvent.TIMER,this.animationUpdate);
      }
      ...
      {
         return param1.x + param1.width < const_900 + this._toolbarSize || param1.y < 0 || param1.desktop.width - param1.x < const_900 || param1.desktop.height - param1.y < const_1228;
      }
      ...
      private function createItemObject(param1:String, param2:ToolbarIcon) : MenuAnimatorItem
      {
         ...
         if(_loc3_ == null)
         {
            ...
            _loc4_ = this.var_1272.getIconByMenuId(param1);
            if(_loc4_ == null)
            {
               return null;
            }
      ...
      {
         var _loc2_:Point = this.var_1272.getIconLoc(param1.iconId);
      ...
      {
         return this.var_554[this.var_552.indexOf(param1)];
      }
      
      private function getWindowMenuId(param1:String) : String
      {
         return this.var_552[this.var_554.indexOf(param1)];
      }
      ...
      private function registerWindow(param1:IWindowContainer, param2:String) : void
      {
         ...
         var _loc3_:int = this.var_552.indexOf(param2);
         if(_loc3_ > -1)
         {
            this.var_552.splice(_loc3_,1);
            this.var_554.splice(_loc3_,1);
         }
         this.var_554.push(param1.name);
         this.var_552.push(param2);
         param1.addEventListener(WindowEvent.const_377,this.windowEventListener);
         param1.addEventListener(WindowEvent.const_212,this.windowEventListener);
      }
      ...
      private function registerDependentMenu(param1:String, param2:Array) : void
      {
         ...
         while(_loc4_ < param2.length)
         {
            ...
            if(this.var_553[_loc3_] == null)
            {
               this.var_553[_loc3_] = new Array();
            }
            if(this.var_553[_loc3_].indexOf(param1) < 0)
            {
               this.var_553[_loc3_].push(param1);
            }
            _loc4_++;
         }
      }
      ...
      public function windowEventListener(param1:WindowEvent) : void
      {
         ...
         {
            if(this.var_554[_loc2_] == param1.window.name)
            {
               _loc3_ = this.var_552[_loc2_];
               if(this.var_553[_loc3_] != null)
               {
                  _loc4_ = 0;
                  while(_loc4_ < this.var_553[_loc3_].length)
                  {
                     this.repositionWindow(this.var_553[_loc3_][_loc4_],false);
                     _loc4_++;
                  }
               }
            }
