package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarView
   {
      ...
      private var var_489:String = "LEFT";
      
      private var var_156:Number = 50;
      
      private var var_1126:Boolean = true;
      
      private var var_1125:Number = 1;
      
      private var var_1378:Number = 0;
      
      private var var_1758:Number = 15;
      
      private var var_1757:Number = 5;
      ...
      public function ToolbarView(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IEventDispatcher)
      {
         ...
         this.var_217 = param1.createWindow("extrabar_container_window","",HabboWindowType.const_57,HabboWindowStyle.const_1038,0 | 0,new Rectangle(0,0,1,1),null,0,0) as IWindowContainer;
         ...
         this.var_1126 = String(_loc6_.relocate_by_drag.@state) == "HabboFriendListCom_opened_to_web_popup_xml";
         if(this.var_1126)
         {
         ...
         this.var_1125 = _loc6_.toolbar.@margin_top;
         this.var_1378 = _loc6_.toolbar.@margin_bottom;
         this.var_1758 = _loc6_.toolbar.@min_group_margin;
         this.var_1757 = _loc6_.toolbar.@margin_to_extrabar;
         ...
         this.createGroupsFromXmlList(_loc7_,this.var_249,param1,param2,this._window,this.var_305);
         this.createGroupsFromXmlList(_loc8_,this.var_605,param1,param2,this.var_217,this.var_305);
         this.alignWindows();
      }
      ...
      public function animateWindowIn(param1:String, param2:IWindowContainer, param3:Point = null) : void
      {
         ...
         if(_loc4_ != null)
         {
            _loc4_.animateWindowIn(param1,param2,this.var_156,this.var_489,param3);
         }
      }
      ...
      public function animateWindowOut(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.animateWindowOut(param1,param2,this.var_489);
         }
      }
      ...
      public function positionWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.positionWindow(param1,param2,this.var_156,this.var_489);
         }
      }
      ...
      public function hideWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.hideWindow(param1,param2,this.var_156,this.var_489);
         }
      }
      ...
      private function alignWindows() : void
      {
         ...
         if(this._window == null || this.var_217 == null)
         {
            return;
         }
         ...
         switch(this.orientation)
         {
            case "LEFT":
               ...
               this._window.x = 0;
               this._window.y = 0;
               this.var_217.x = this.var_156 + this.var_1757;
               this.var_217.y = 0;
            ...
            case "TOP":
               ...
               this._window.y = 0;
               this.var_217.x = 0;
               this.var_217.y = this.var_156 + this.var_1757;
         ...
         _loc4_ -= this.var_1378;
         _loc4_ -= this.var_1125;
         var _loc5_:* = 0;
         _loc2_ = 0;
         ...
         var _loc6_:* = 0;
         var _loc7_:Number = this.var_1125;
         var _loc8_:* = 1;
         if(_loc5_ > _loc4_)
         {
         ...
         else
         {
            ...
            if(this.var_249.length > 1)
            {
               ...
               {
                  _loc6_ = Number(Math.max(this.var_1758,(this._window.height - _loc5_ * _loc8_ - this.var_1125 - this.var_1378) / (this.var_249.length - 1)));
               }
               else
               {
                  _loc6_ = Number(Math.max(this.var_1758,(this._window.width - _loc5_ * _loc8_ - this.var_1125 - this.var_1378) / (this.var_249.length - 1)));
               }
            }
         }
         _loc2_ = 0;
         while(_loc2_ < this.var_249.length)
         {
            ...
            if(_loc3_ != null)
            {
               _loc3_.orientation = this.var_489;
