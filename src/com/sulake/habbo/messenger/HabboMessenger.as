package com.sulake.habbo.messenger
{
   ...
   public class HabboMessenger extends Component implements IHabboMessenger, IAvatarImageListener
   {
      ...
      private var var_641:Conversations;
      
      private var var_265:MessengerView;
      ...
      {
         var _loc2_:Conversation = this.var_641.addConversation(param1);
         if(_loc2_ == null)
         {
         ...
         else
         {
            ...
            this.var_641.setSelected(_loc2_);
            this.var_265.openMessenger();
            this.var_265.refresh();
         }
      }
      
      public function setFollowingAllowed(param1:int, param2:Boolean) : void
      {
         this.var_641.setFollowingAllowedAndUpdateView(param1,param2);
      }
      
      public function setOnlineStatus(param1:int, param2:Boolean) : void
      {
         this.var_641.setOnlineStatusAndUpdateView(param1,param2);
      }
      ...
      {
         this.var_641 = new Conversations(new ConversationsDeps(this));
         this.var_265 = new MessengerView(this);
      ...
      public function setHabboToolbarIcon(param1:Boolean, param2:Boolean) : void
      {
         if(!param1)
         {
            this.var_178.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_155,HabboToolbarIconEnum.MESSENGER));
            return;
         }
         this.var_178.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_118,HabboToolbarIconEnum.MESSENGER));
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         ...
         {
            if(this.var_265.isMessengerOpen())
            {
               this.var_265.close();
            }
            else
      ...
      private function onRoomInvite(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:Message = new Message(Message.const_1175,_loc2_.senderId,this.getText("messenger.invitation") + " " + _loc2_.messageText,Util.getFormattedNow());
         this.addMsg(_loc3_);
      }
      
      private function addMsg(param1:Message) : void
      {
         this.var_641.addMessageAndUpdateView(param1);
         if(!this.var_265.isMessengerOpen())
         {
      ...
      private function onInstantMessageError(param1:IMessageEvent) : void
      {
         ...
         this.var_641.addMessageAndUpdateView(_loc3_);
      }
