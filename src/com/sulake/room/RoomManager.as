package com.sulake.room
{
   ...
   public class RoomManager extends Component implements IRoomManager, IRoomInstanceContainer
   {
      ...
      private var var_2809:IRoomContentLoader;
      ...
      public function RoomManager(param1:IContext, param2:uint = 0)
      {
         ...
         this.var_636 = [];
         this.var_539 = [];
         events.addEventListener(RoomContentLoadedEvent.const_337,this.onContentLoaded);
         events.addEventListener(RoomContentLoadedEvent.const_553,this.onContentLoaded);
      ...
      {
         var _loc1_:* = null;
         if(this.var_635 == null || this.var_520 == null)
         {
            return;
         }
         this._state = const_1577;
         if(this.var_1187 != null)
         {
            _loc1_ = this.var_1187;
            this.var_1187 = null;
      ...
      {
         var _loc4_:* = null;
         var _loc2_:int = this.var_539.indexOf(param1);
         if(_loc2_ >= 0)
         {
            return;
         }
         this.var_539.push(param1);
      ...
      public function createRoom(param1:String, param2:XML) : IRoomInstance
      {
         ...
         var _loc4_:int = this.var_539.length - 1;
         while(_loc4_ >= 0)
         {
            _loc5_ = this.var_539[_loc4_];
      ...
      public function createRoomObject(param1:String, param2:int, param3:String, param4:int) : IRoomObject
      {
         ...
         var _loc17_:IRoomObjectGraphicVisualization = this.var_520.createRoomObjectVisualization(_loc10_);
         if(_loc17_ == null)
         {
            _loc5_.disposeObject(param2,param4);
            return null;
         ...
         var _loc18_:* = null;
         _loc18_ = this.var_520.getRoomObjectVisualizationData(_loc12_,_loc10_,_loc8_);
      ...
      private function updateObjectContent(param1:String) : void
      {
         ...
         if(this.var_50 == null || this.var_520 == null)
         {
            return;
         }
                  ...
                  while(_loc13_ >= 0)
                  {
                     ...
                     if(_loc14_ != null)
                     {
                        ...
                        if(_loc16_ == param1)
                        {
                           ...
                           _loc5_ = this.var_520.getRoomObjectVisualizationData(_loc15_,_loc17_,_loc2_);
                           _loc19_ = this.var_520.createRoomObjectVisualization(_loc17_);
                           if(_loc19_ != null)
                           {
                              ...
                              else
                              {
                                 ...
                                 _loc20_ = this.var_635.createRoomObjectLogic(_loc18_);
                                 ...
                                 if(this.var_159 != null)
                                 {
                                    this.var_159.objectInitialized(_loc8_,_loc14_.getId(),_loc11_);
                                 }
                              }
                           }
                           else
