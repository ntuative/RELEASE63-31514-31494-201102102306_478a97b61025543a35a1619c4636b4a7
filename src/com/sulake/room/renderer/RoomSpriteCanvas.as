package com.sulake.room.renderer
{
   ...
   public class RoomSpriteCanvas implements IRoomRenderingCanvas
   {
      ...
      private static const const_1657:int = 50;
      ...
      private var var_446:Point;
      
      private var var_230:BitmapDataCache;
      
      private var var_535:RoomObjectCache;
      
      private var var_445:Array;
      
      private var var_538:Array;
      
      private var var_1245:IRoomRenderingCanvasMouseListener = null;
      ...
      private var var_2021:Number = -1.0E7;
      
      private var var_2023:Number = -1.0E7;
      ...
      public function RoomSpriteCanvas(param1:IRoomSpriteCanvasContainer, param2:String, param3:int, param4:int, param5:int)
      {
         ...
         this._id = param2;
         this.var_231 = new Sprite();
         this.var_231.mouseEnabled = false;
         this.var_55 = new Sprite();
         this.var_55.name = "canvas";
         this.var_55.mouseEnabled = false;
         this.var_231.addChild(this.var_55);
         ...
         this.var_535 = new RoomObjectCache(_loc6_);
      ...
      {
         this.var_446.x -= param1 - this.var_536;
         this.var_536 = param1;
      }
      
      public function set screenOffsetY(param1:int) : void
      {
         this.var_446.y -= param1 - this.var_534;
         this.var_534 = param1;
      }
      ...
      public function set useMask(param1:Boolean) : void
      {
         ...
         {
            this.var_884 = true;
            if(this.var_119 != null && !this.var_231.contains(this.var_119))
            {
               this.var_231.addChild(this.var_119);
               this.var_55.mask = this.var_119;
            }
         }
         else if(!param1 && this.var_884)
         {
            this.var_884 = false;
            if(this.var_119 != null && this.var_231.contains(this.var_119))
            {
               this.var_231.removeChild(this.var_119);
      ...
      public function dispose() : void
      {
         ...
         {
            while(this.var_231.numChildren > 0)
            {
               this.var_231.removeChildAt(0);
            }
            this.var_231 = null;
         }
         this.var_55 = null;
      ...
      {
         this.var_535.removeObjectCache(param1);
      }
      ...
      public function render(param1:int) : void
      {
         ...
         if(this.var_654 != this.var_2024 || this._ht != this.var_2025)
         {
            _loc9_ = true;
         }
         if(this.var_55.x != this.var_536 || this.var_55.y != this.var_534)
         {
            this.var_55.x = this.var_536;
            this.var_55.y = this.var_534;
            _loc9_ = true;
         }
         _loc4_ = 0;
         while(_loc4_ < _loc3_)
         ...
         this.var_445.sortOn("z",0 | 0);
         if(_loc5_ < this.var_445.length)
         {
            this.var_445.splice(_loc5_);
         }
         var _loc10_:* = null;
         _loc4_ = 0;
         while(_loc4_ < _loc5_)
         {
            _loc10_ = this.var_445[_loc4_] as SortableSprite;
            if(_loc10_ != null)
            {
         ...
         this.var_2024 = this.var_654;
         this.var_2025 = this._ht;
      }
      ...
      private function renderObject(param1:IRoomObject, param2:String, param3:int, param4:Boolean, param5:int) : int
      {
         ...
         if(_loc6_ == null)
         {
            this.var_535.removeObjectCache(param2);
            return 0;
         }
         var _loc7_:RoomObjectCacheItem = this.var_535.getObjectCache(param2);
         ...
         while(_loc21_ < _loc12_)
         {
            ...
            if(_loc18_ != null && _loc18_.visible)
            {
               ...
               if(_loc22_ != null)
               {
                  _loc19_ = _loc13_ + _loc18_.offsetX + this.var_536;
                  _loc20_ = _loc14_ + _loc18_.offsetY + this.var_534;
                  if(_loc19_ < this.var_654 && _loc19_ + _loc22_.width >= 0 && (_loc20_ < this._ht && _loc20_ + _loc22_.height >= 0))
                  {
                     ...
                     if(_loc17_ == null)
                     {
                        ...
                        this.var_445.push(_loc17_);
                        _loc17_.name = param2;
                     }
                     _loc17_.sprite = _loc18_;
                     _loc17_.x = _loc19_ - this.var_536;
                     _loc17_.y = _loc20_ - this.var_534;
      ...
      private function cleanSprites(param1:int, param2:Boolean = false) : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:* = null;
         if(param1 < this.var_655 || this.var_655 == 0)
         {
      ...
      {
         if(param1 < 0 || param1 >= this.var_445.length)
         {
            return null;
         }
         return this.var_445[param1] as SortableSprite;
      }
      ...
      public function handleMouseEvent(param1:int, param2:int, param3:String, param4:Boolean, param5:Boolean, param6:Boolean, param7:Boolean) : Boolean
      {
         param1 -= this.var_536;
         param2 -= this.var_534;
         this.var_446.x = param1;
         this.var_446.y = param2;
         if(this.var_1006 > 0 && param3 == MouseEvent.MOUSE_MOVE)
         {
            return this.var_1498;
         }
         this.var_1498 = this.checkMouseHits(param1,param2,param3,param4,param5,param6,param7);
         ++this.var_1006;
         return this.var_1498;
      }
      ...
      private function createMouseEvent(param1:int, param2:int, param3:int, param4:int, param5:String, param6:String, param7:Boolean, param8:Boolean, param9:Boolean, param10:Boolean) : RoomSpriteMouseEvent
      {
         ...
         var _loc13_:* = null;
         return new RoomSpriteMouseEvent(param5,this._id + "_" + this.var_1497,this._id,param6,_loc11_,_loc12_,param3,param4,param8,param7,param9,param10);
      }
      ...
      private function checkMouseHits(param1:int, param2:int, param3:String, param4:Boolean = false, param5:Boolean = false, param6:Boolean = false, param7:Boolean = false) : Boolean
      {
         ...
         while(_loc14_ >= 0)
         {
            ...
            if(_loc10_ != null && _loc10_.hitTestPoint(param1 - _loc10_.x,param2 - _loc10_.y))
            {
               if(!_loc10_.clickHandling || param3 != MouseEvent.CLICK && param3 != MouseEvent.DOUBLE_CLICK)
               {
                  ...
                  {
                     _loc16_ = _loc10_.tag;
                     _loc13_ = this.var_537.getValue(_loc9_) as ObjectMouseData;
                     if(_loc13_ != null)
                     {
                     ...
                     if(_loc13_ == null)
                     {
                        ...
                        this.var_537.add(_loc9_,_loc13_);
                     }
                     _loc13_.spriteTag = _loc16_;
                     if(param3 != MouseEvent.MOUSE_MOVE || param1 != this.var_2021 || param2 != this.var_2023)
                     {
                        this.bufferMouseEvent(_loc11_,_loc9_);
                     }
                     _loc12_.push(_loc9_);
         ...
         var _loc15_:Array = this.var_537.getKeys();
         _loc14_ = 0;
         ...
         while(_loc14_ < _loc15_.length)
         {
            ...
            if(_loc9_ != null)
            {
               _loc13_ = this.var_537.remove(_loc9_) as ObjectMouseData;
               if(_loc13_ != null)
               {
                  _loc11_ = this.createMouseEvent(0,0,0,0,MouseEvent.ROLL_OUT,_loc13_.spriteTag,param4,param5,param6,param7);
                  this.bufferMouseEvent(_loc11_,_loc9_);
      ...
      {
         if(this.var_317 != null && param1 != null)
         {
            this.var_317.add(param2,param1);
         }
      }
      ...
      private function processMouseEvents() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         if(this._container == null || this.var_317 == null)
         {
            return;
         }
         var _loc1_:int = 0;
         ...
         {
            _loc2_ = this.var_317.getKey(_loc1_);
            _loc3_ = this.var_317.getWithIndex(_loc1_);
            if(_loc2_ != null && _loc3_ != null)
            {
               ...
               if(_loc4_ != null)
               {
                  ...
                  {
                     this.var_1245.processRoomCanvasMouseEvent(_loc3_,_loc4_,this.geometry);
                  }
                  else
                  {
      ...
      public function update() : void
      {
         if(this.var_1006 == 0)
         {
            this.checkMouseHits(this.var_446.x,this.var_446.y,MouseEvent.MOUSE_MOVE);
         }
         this.var_1006 = 0;
         ++this.var_1497;
      }
