package com.sulake.room.object
{
   ...
   public class RoomObject implements IRoomObjectController
   {
      ...
      private var var_571:IRoomObjectEventHandler;
      ...
      public function RoomObject(param1:int, param2:int)
      {
         ...
         this.var_570 = new Array(param2);
         var _loc3_:Number = param2 - 1;
         while(_loc3_ >= 0)
         {
            this.var_570[_loc3_] = 0;
            _loc3_--;
         }
      ...
      {
         this.var_1591.assign(this.var_76);
         return this.var_1591;
      }
      
      public function getDirection() : IVector3d
      {
         this.var_1592.assign(this.var_237);
      ...
      public function setDirection(param1:IVector3d) : void
      {
         ...
         if(this.var_237.x != param1.x || this.var_237.y != param1.y || this.var_237.z != param1.z)
         {
            this.var_237.x = (param1.x % 360 + 360) % 360;
            this.var_237.y = (param1.y % 360 + 360) % 360;
            this.var_237.z = (param1.z % 360 + 360) % 360;
            ++this._updateID;
         }
      }
      ...
      {
         if(param2 >= 0 && param2 < this.var_570.length)
         {
            if(this.var_570[param2] != param1)
            {
               this.var_570[param2] = param1;
               ++this._updateID;
            }
            return true;
         }
      ...
      public function setEventHandler(param1:IRoomObjectEventHandler) : void
      {
         ...
         var _loc2_:IRoomObjectEventHandler = this.var_571;
         if(_loc2_ != null)
         {
            this.var_571 = null;
            _loc2_.object = null;
